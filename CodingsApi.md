...
```typescript
import { createConfiguration, CodingsApi } from '';
import type { CodingsApiListCodingsRequest } from '';

const configuration = createConfiguration();
const apiInstance = new CodingsApi(configuration);

const request: CodingsApiListCodingsRequest = {
...
const data = await apiInstance.listCodings(request);
