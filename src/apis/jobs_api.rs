...
pub async fn get_job_status(configuration: &configuration::Configuration, study_key: &str, batch_id: &str) -> Result<models::Job, Error<GetJobStatusError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_study_key = study_key;
    let p_batch_id = batch_id;

    let uri_str = format!("{}/studies/{studyKey}/jobs/{batchId}", configuration.base_path, studyKey=crate::apis::urlencode(p_study_key), batchId=crate::apis::urlencode(p_batch_id));
