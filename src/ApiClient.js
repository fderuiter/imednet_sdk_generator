...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://edc.prod.imednetapi.com/api/v1/edc') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://edc.prod.imednetapi.com/api/v1/edc
         */
        ...
        this.authentications = {
            ...
            'securityKeyAuth': {type: 'apiKey', 'in': 'header', name: 'x-imn-security-key'}
        }
