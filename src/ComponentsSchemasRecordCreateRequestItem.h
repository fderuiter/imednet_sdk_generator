...
#ifndef _Components_schemas_RecordCreateRequest_item_H_
#define _Components_schemas_RecordCreateRequest_item_H_
...
class Components_schemas_RecordCreateRequest_item : public Object {
public:
	/*! \brief Constructor.
	 */
	Components_schemas_RecordCreateRequest_item();
	Components_schemas_RecordCreateRequest_item(char* str);
...
#endif /* _Components_schemas_RecordCreateRequest_item_H_ */
