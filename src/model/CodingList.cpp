...
#include "CppRestOpenAPIClient/model/CodingList.h"
...
void CodingList::validate()
{
    // TODO: implement validation
}

web::json::value CodingList::toJson() const
{
...
bool CodingList::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<Coding>> refVal_setData;
...
void CodingList::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CodingList::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<Metadata> CodingList::getMetadata() const
{
    return m_Metadata;
}


void CodingList::setMetadata(const std::shared_ptr<Metadata>& value)
{
    m_Metadata = value;
    m_MetadataIsSet = true;
}

bool CodingList::metadataIsSet() const
{
    return m_MetadataIsSet;
}

void CodingList::unsetMetadata()
{
    m_MetadataIsSet = false;
}
std::shared_ptr<Pagination> CodingList::getPagination() const
{
    return m_Pagination;
}


void CodingList::setPagination(const std::shared_ptr<Pagination>& value)
{
    m_Pagination = value;
    m_PaginationIsSet = true;
}

bool CodingList::paginationIsSet() const
{
    return m_PaginationIsSet;
}

void CodingList::unsetPagination()
{
    m_PaginationIsSet = false;
}
std::vector<std::shared_ptr<Coding>> CodingList::getData() const
{
    return m_Data;
}


void CodingList::setData(const std::vector<std::shared_ptr<Coding>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool CodingList::dataIsSet() const
{
    return m_DataIsSet;
}

void CodingList::unsetData()
{
    m_DataIsSet = false;
}
