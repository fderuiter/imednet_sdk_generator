...
void IntervalList::validate()
{
    // TODO: implement validation
}

web::json::value IntervalList::toJson() const
{
...
bool IntervalList::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<Interval>> refVal_setData;
...
void IntervalList::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool IntervalList::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<Metadata> IntervalList::getMetadata() const
{
    return m_Metadata;
}


void IntervalList::setMetadata(const std::shared_ptr<Metadata>& value)
{
    m_Metadata = value;
    m_MetadataIsSet = true;
}

bool IntervalList::metadataIsSet() const
{
    return m_MetadataIsSet;
}

void IntervalList::unsetMetadata()
{
    m_MetadataIsSet = false;
}
std::shared_ptr<Pagination> IntervalList::getPagination() const
{
    return m_Pagination;
}


void IntervalList::setPagination(const std::shared_ptr<Pagination>& value)
{
    m_Pagination = value;
    m_PaginationIsSet = true;
}

bool IntervalList::paginationIsSet() const
{
    return m_PaginationIsSet;
}

void IntervalList::unsetPagination()
{
    m_PaginationIsSet = false;
}
std::vector<std::shared_ptr<Interval>> IntervalList::getData() const
{
    return m_Data;
}


void IntervalList::setData(const std::vector<std::shared_ptr<Interval>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool IntervalList::dataIsSet() const
{
    return m_DataIsSet;
}

void IntervalList::unsetData()
{
    m_DataIsSet = false;
}
