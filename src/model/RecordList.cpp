...
bool RecordList::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<Record>> refVal_setData;
...
std::shared_ptr<Metadata> RecordList::getMetadata() const
{
    return m_Metadata;
}


void RecordList::setMetadata(const std::shared_ptr<Metadata>& value)
{
    m_Metadata = value;
    m_MetadataIsSet = true;
}

bool RecordList::metadataIsSet() const
{
    return m_MetadataIsSet;
}

void RecordList::unsetMetadata()
{
    m_MetadataIsSet = false;
}
std::shared_ptr<Pagination> RecordList::getPagination() const
{
    return m_Pagination;
}


void RecordList::setPagination(const std::shared_ptr<Pagination>& value)
{
    m_Pagination = value;
    m_PaginationIsSet = true;
}

bool RecordList::paginationIsSet() const
{
    return m_PaginationIsSet;
}

void RecordList::unsetPagination()
{
    m_PaginationIsSet = false;
}
std::vector<std::shared_ptr<Record>> RecordList::getData() const
{
    return m_Data;
}


void RecordList::setData(const std::vector<std::shared_ptr<Record>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool RecordList::dataIsSet() const
{
    return m_DataIsSet;
}

void RecordList::unsetData()
{
    m_DataIsSet = false;
}
