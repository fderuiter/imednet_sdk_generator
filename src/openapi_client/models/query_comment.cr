...
module OpenAPIClient
  class QueryComment
    ...
    @[JSON::Field(key: "annotationStatus", type: String?, nillable: true, emit_null: false)]
    property annotation_status : String?
    ...
    @[JSON::Field(key: "closed", type: Bool?, nillable: true, emit_null: false)]
    ...
    def initialize(@sequence : Int32?, @annotation_status : String?, @user : String?, @comment : String?, @closed : Bool?, @date : String?)
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
          ...
          annotation_status == other.annotation_status &&
          user == other.user &&
