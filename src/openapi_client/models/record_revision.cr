...
module OpenAPIClient
  class RecordRevision
    ...
    @[JSON::Field(key: "recordRevisionId", type: Int32?, nillable: true, emit_null: false)]
    property record_revision_id : Int32?
    ...
    @[JSON::Field(key: "recordRevision", type: Int32?, nillable: true, emit_null: false)]
    property record_revision : Int32?

    # Revision number of the data within the record
    @[JSON::Field(key: "dataRevision", type: Int32?, nillable: true, emit_null: false)]
    property data_revision : Int32?
    ...
    @[JSON::Field(key: "reasonForChange", type: String?, nillable: true, emit_null: false)]
    property reason_for_change : String?
    ...
    def initialize(@study_key : String?, @record_revision_id : Int32?, @record_id : Int32?, @record_oid : String?, @record_revision : Int32?, @data_revision : Int32?, @record_status : String?, @subject_id : Int32?, @subject_oid : String?, @subject_key : String?, @site_id : Int32?, @form_key : String?, @interval_id : Int32?, @role : String?, @user : String?, @reason_for_change : String?, @deleted : Bool?, @date_created : String?)
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
          ...
          record_revision_id == other.record_revision_id &&
          record_id == other.record_id &&
          record_oid == other.record_oid &&
          record_revision == other.record_revision &&
          data_revision == other.data_revision &&
          ...
          role == other.role &&
          user == other.user &&
          reason_for_change == other.reason_for_change &&
