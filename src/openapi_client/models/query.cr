...
module OpenAPIClient
  class Query
    ...
    @[JSON::Field(key: "annotationType", type: String?, nillable: true, emit_null: false)]
    property annotation_type : String?

    # Unique system identifier for the query
    @[JSON::Field(key: "annotationId", type: Int32?, nillable: true, emit_null: false)]
    property annotation_id : Int32?
    ...
    @[JSON::Field(key: "queryComments", type: Array(QueryComment)?, nillable: true, emit_null: false)]
    property query_comments : Array(QueryComment)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@study_key : String?, @subject_id : Int32?, @subject_oid : String?, @annotation_type : String?, @annotation_id : Int32?, @_type : String?, @description : String?, @record_id : Int32?, @variable : String?, @subject_key : String?, @date_created : String?, @date_modified : String?, @query_comments : Array(QueryComment)?)
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
          ...
          query_comments == other.query_comments
    end
    ...
    def hash
      [study_key, subject_id, subject_oid, annotation_type, annotation_id, _type, description, record_id, variable, subject_key, date_created, date_modified, query_comments].hash
    end
