...
class RecordRevision implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'RecordRevision';
    ...
    */
     ...
     * @return int|null
     */
    public function getRecordRevisionId(): ?int
    {
     ...
     * @return $this
     */
    public function setRecordRevisionId(?int $record_revision_id): static
    {
     ...
     * @return int|null
     */
    public function getRecordRevision(): ?int
    {
     ...
     * @return $this
     */
    public function setRecordRevision(?int $record_revision): static
    {
     ...
     * @return int|null
     */
    public function getDataRevision(): ?int
    {
     ...
     * @return $this
     */
    public function setDataRevision(?int $data_revision): static
    {
