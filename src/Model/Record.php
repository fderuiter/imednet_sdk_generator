...
class Record implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Record';
    ...
    */
     ...
     * @return $this
     */
    public function setRecordType(?string $record_type): static
    {
     ...
     * @return $this
     */
    public function setRecordStatus(?string $record_status): static
    {
     ...
     * @return int|null
     */
    public function getParentRecordId(): ?int
    {
     ...
     * @return $this
     */
    public function setParentRecordId(?int $parent_record_id): static
    {
     ...
     * @return $this
     */
    public function setRecordData(?array $record_data): static
    {
