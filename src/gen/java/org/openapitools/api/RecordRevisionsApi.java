 ...
 *
 */
@Path("/studies/{studyKey}/recordRevisions")
@Api(value = "/", description = "")
public interface RecordRevisionsApi  {
    ...
    @ApiOperation(value = "List record revisions (audit trail entries) in a study", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful response with list of record revisions", response = RecordRevisionList.class),
    ...
    public RecordRevisionList listRecordRevisions(@PathParam("studyKey") String studyKey, @QueryParam("page") @DefaultValue("0")Integer page, @QueryParam("size") @DefaultValue("25")Integer size, @QueryParam("sort") String sort, @QueryParam("filter") String filter);
}
