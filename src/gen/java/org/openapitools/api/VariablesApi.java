 ...
 *
 */
@Path("/studies/{studyKey}/variables")
...
public interface VariablesApi  {
    ...
    @ApiOperation(value = "List variables (fields) in a study", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful response with list of variables", response = VariableList.class),
    ...
    public VariableList listVariables(@PathParam("studyKey") String studyKey, @QueryParam("page") @DefaultValue("0")Integer page, @QueryParam("size") @DefaultValue("25")Integer size, @QueryParam("sort") String sort, @QueryParam("filter") String filter);
}
