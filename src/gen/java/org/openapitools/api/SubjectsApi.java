 ...
 *
 */
@Path("/studies/{studyKey}/subjects")
...
public interface SubjectsApi  {
    ...
    @ApiOperation(value = "List subjects in a study", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful response with list of subjects", response = SubjectList.class),
    ...
    public SubjectList listSubjects(@PathParam("studyKey") String studyKey, @QueryParam("page") @DefaultValue("0")Integer page, @QueryParam("size") @DefaultValue("25")Integer size, @QueryParam("sort") String sort, @QueryParam("filter") String filter);
}
