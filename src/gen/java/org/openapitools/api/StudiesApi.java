...
public interface StudiesApi  {
    ...
    @ApiOperation(value = "List studies accessible by API key", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful response with list of studies", response = StudyList.class),
    ...
    public StudyList listStudies(@QueryParam("page") @DefaultValue("0")Integer page, @QueryParam("size") @DefaultValue("25")Integer size, @QueryParam("sort") String sort, @QueryParam("filter") String filter);
}
