...
public interface SitesApi  {
    ...
    @ApiOperation(value = "List sites for a study", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful response with list of sites", response = SiteList.class),
    ...
    public SiteList listSites(@PathParam("studyKey") String studyKey, @QueryParam("page") @DefaultValue("0")Integer page, @QueryParam("size") @DefaultValue("25")Integer size, @QueryParam("sort") String sort, @QueryParam("filter") String filter);
}
