...
public interface VisitsApi  {
    ...
    @ApiOperation(value = "List visits (subject visit instances) in a study", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful response with list of visits", response = VisitList.class),
    ...
    public VisitList listVisits(@PathParam("studyKey") String studyKey, @QueryParam("page") @DefaultValue("0")Integer page, @QueryParam("size") @DefaultValue("25")Integer size, @QueryParam("sort") String sort, @QueryParam("filter") String filter);
}
