#ifndef _VisitsManager_H_
#define _VisitsManager_H_
...
public:
	VisitsManager();
	virtual ~VisitsManager();

/*! \brief List visits (subject visit instances) in a study. *Synchronous*
 *
 * 
 ...
 * \param userData The user data to be passed to the callback function.
 */
bool listVisitsAsync(char * accessToken,
	std::string studyKey, int page, int size, std::string sort, std::string filter, 
	void(* handler)(VisitList, Error, void* )
	, void* userData);
