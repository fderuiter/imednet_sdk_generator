...
function Invoke-ListForms {
    ...
    Process {
        'Calling method: Invoke-ListForms' | Write-Debug
        ...
        $LocalVarUri = '/studies/{studyKey}/forms'
        if (!$StudyKey) {
            throw "Error! The required parameter `StudyKey` missing when calling listForms."
        }
