...
function Invoke-ListSites {
    ...
    Process {
        'Calling method: Invoke-ListSites' | Write-Debug
        ...
        $LocalVarUri = '/studies/{studyKey}/sites'
        if (!$StudyKey) {
            throw "Error! The required parameter `StudyKey` missing when calling listSites."
        }
