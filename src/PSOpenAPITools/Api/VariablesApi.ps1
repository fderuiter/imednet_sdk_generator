...
function Invoke-ListVariables {
    ...
    Process {
        'Calling method: Invoke-ListVariables' | Write-Debug
        ...
        $LocalVarUri = '/studies/{studyKey}/variables'
        if (!$StudyKey) {
            throw "Error! The required parameter `StudyKey` missing when calling listVariables."
        }
