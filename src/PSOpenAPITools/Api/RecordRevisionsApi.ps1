...
RecordRevisionList
#>
function Invoke-ListRecordRevisions {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-ListRecordRevisions' | Write-Debug
        ...
        $LocalVarUri = '/studies/{studyKey}/recordRevisions'
        if (!$StudyKey) {
            throw "Error! The required parameter `StudyKey` missing when calling listRecordRevisions."
        }
