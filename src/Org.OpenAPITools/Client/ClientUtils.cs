    ...
    public static partial class ClientUtils
    {
        ...
        public static string ApiKeyHeaderToString(ApiKeyHeader value)
        {
            return value switch
            {
                ...
                ApiKeyHeader.X_imn_security_key => "x-imn-security-key",
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is bool boolean)
                return boolean
                    ? "true"
                    : "false";
            if (obj is Sort.DirectionEnum sortDirectionEnum)
                return Sort.DirectionEnumToJsonValue(sortDirectionEnum);
            if (obj is Variable.VariableTypeEnum variableVariableTypeEnum)
                return Variable.VariableTypeEnumToJsonValue(variableVariableTypeEnum);
        ...
        /// </summary>
        public const string BASE_ADDRESS = "https://edc.prod.imednetapi.com/api/v1/edc";
        ...
        /// </summary>
        public const string CONTEXT_PATH = "/api/v1/edc";

        /// <summary>
        /// The host of the API
        /// </summary>
        public const string HOST = "edc.prod.imednetapi.com";
