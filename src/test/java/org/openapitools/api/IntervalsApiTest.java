...
public class IntervalsApiTest {
    ...
    public void setup() {
        ...
        api = JAXRSClientFactory.create("https://edc.prod.imednetapi.com/api/v1/edc", IntervalsApi.class, providers);
    ...
    public void listIntervalsTest() {
        ...
        String sort = null;
        String filter = null;
        //IntervalList response = api.listIntervals(studyKey, page, size, sort, filter);
