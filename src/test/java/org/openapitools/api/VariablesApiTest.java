...
public class VariablesApiTest {
    ...
    public void setup() {
        ...
        api = JAXRSClientFactory.create("https://edc.prod.imednetapi.com/api/v1/edc", VariablesApi.class, providers);
    ...
    public void listVariablesTest() {
        ...
        String sort = null;
        String filter = null;
        //VariableList response = api.listVariables(studyKey, page, size, sort, filter);
