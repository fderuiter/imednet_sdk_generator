...
public class FormsApiTest {
    ...
    public void setup() {
        ...
        api = JAXRSClientFactory.create("https://edc.prod.imednetapi.com/api/v1/edc", FormsApi.class, providers);
    ...
    public void listFormsTest() {
        ...
        String sort = null;
        String filter = null;
        //FormList response = api.listForms(studyKey, page, size, sort, filter);
