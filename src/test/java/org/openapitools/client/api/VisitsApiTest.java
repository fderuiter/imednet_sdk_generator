...
public class VisitsApiTest {
    ...
    private static VisitsApi client;
     ...
     */
    @Test
    public void listVisitsTest() throws Exception {
        //VisitList response = client.listVisits(studyKey, page, size, sort, filter);
