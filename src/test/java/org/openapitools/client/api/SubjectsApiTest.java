...
public class SubjectsApiTest {
    ...
    private static SubjectsApi client;
     ...
     */
    @Test
    public void listSubjectsTest() throws Exception {
        //SubjectList response = client.listSubjects(studyKey, page, size, sort, filter);
