...
public class FormsApiTest {
    ...
    private static FormsApi client;
     ...
     */
    @Test
    public void listFormsTest() throws Exception {
        //FormList response = client.listForms(studyKey, page, size, sort, filter);
