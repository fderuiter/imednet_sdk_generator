...
import org.openapitools.client.apis.VisitsApi
...
class VisitsApiTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of VisitsApi
        //val apiInstance = VisitsApi()

        // to test listVisits
        should("test listVisits") {
            // uncomment below to test listVisits
