...
feature -- API Access
	...
	list_queries (study_key: STRING_32; page: INTEGER_32; size: INTEGER_32; sort: STRING_32; filter: STRING_32): detachable QUERY_LIST
		...
		do
			...
			l_path := "/studies/{studyKey}/queries"
			...
			elseif attached { QUERY_LIST } l_response.data ({ QUERY_LIST }) as l_data then
				Result := l_data
			else
