...
feature -- API Access
	...
	list_subjects (study_key: STRING_32; page: INTEGER_32; size: INTEGER_32; sort: STRING_32; filter: STRING_32): detachable SUBJECT_LIST
		...
		do
			...
			l_path := "/studies/{studyKey}/subjects"
			...
			elseif attached { SUBJECT_LIST } l_response.data ({ SUBJECT_LIST }) as l_data then
				Result := l_data
			else
