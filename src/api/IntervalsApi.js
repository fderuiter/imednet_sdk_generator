...
/**
* Intervals service.
* @module api/IntervalsApi
* @version 1.3.6
*/
export default class IntervalsApi {

    /**
    * Constructs a new IntervalsApi. 
    * @alias module:api/IntervalsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the listIntervals operation.
     * @callback module:api/IntervalsApi~listIntervalsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/IntervalList} data The data returned by the service call.
     ...
     * @param {module:api/IntervalsApi~listIntervalsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/IntervalList}
     */
    listIntervals(studyKey, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'studyKey' is set
      if (studyKey === undefined || studyKey === null) {
        throw new Error("Missing the required parameter 'studyKey' when calling listIntervals");
      }
