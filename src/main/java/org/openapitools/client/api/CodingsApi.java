...
public class CodingsApi {
  ...
  * 
   ...
   * @return CodingList
  */
  public CodingList listCodings (String studyKey, Integer page, Integer size, String sort, String filter) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'studyKey' is set
    if (studyKey == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'studyKey' when calling listCodings",
        new ApiException(400, "Missing the required parameter 'studyKey' when calling listCodings"));
    }

    // create path and map variables
    String path = "/studies/{studyKey}/codings".replaceAll("\\{" + "studyKey" + "\\}", apiInvoker.escapeString(studyKey.toString()));
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (CodingList) ApiInvoker.deserialize(localVarResponse, "", CodingList.class);
      } else {
         return null;
      }
  ...
  */
  public void listCodings (String studyKey, Integer page, Integer size, String sort, String filter, final Response.Listener<CodingList> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/studies/{studyKey}/codings".replaceAll("\\{format\\}","json").replaceAll("\\{" + "studyKey" + "\\}", apiInvoker.escapeString(studyKey.toString()));
      ...
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((CodingList) ApiInvoker.deserialize(localVarResponse,  "", CodingList.class));
