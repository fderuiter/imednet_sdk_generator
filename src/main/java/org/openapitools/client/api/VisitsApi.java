...
public class VisitsApi {
  ...
  * 
   ...
   * @return VisitList
  */
  public VisitList listVisits (String studyKey, Integer page, Integer size, String sort, String filter) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'studyKey' is set
    if (studyKey == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'studyKey' when calling listVisits",
        new ApiException(400, "Missing the required parameter 'studyKey' when calling listVisits"));
    }

    // create path and map variables
    String path = "/studies/{studyKey}/visits".replaceAll("\\{" + "studyKey" + "\\}", apiInvoker.escapeString(studyKey.toString()));
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (VisitList) ApiInvoker.deserialize(localVarResponse, "", VisitList.class);
      } else {
         return null;
      }
  ...
  */
  public void listVisits (String studyKey, Integer page, Integer size, String sort, String filter, final Response.Listener<VisitList> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/studies/{studyKey}/visits".replaceAll("\\{format\\}","json").replaceAll("\\{" + "studyKey" + "\\}", apiInvoker.escapeString(studyKey.toString()));
      ...
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((VisitList) ApiInvoker.deserialize(localVarResponse,  "", VisitList.class));
