...
public interface StudiesApi  {
    ...
    StudyList listStudies(@QueryParam("page") @DefaultValue("0") Integer page, @QueryParam("size") @DefaultValue("25") Integer size, @QueryParam("sort") String sort, @QueryParam("filter") String filter) throws ApiException, ProcessingException;
}
