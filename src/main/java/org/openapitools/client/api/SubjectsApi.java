...
public class SubjectsApi {
  ...
  * 
   ...
   * @return SubjectList
  */
  public SubjectList listSubjects (String studyKey, Integer page, Integer size, String sort, String filter) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'studyKey' is set
    if (studyKey == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'studyKey' when calling listSubjects",
        new ApiException(400, "Missing the required parameter 'studyKey' when calling listSubjects"));
    }

    // create path and map variables
    String path = "/studies/{studyKey}/subjects".replaceAll("\\{" + "studyKey" + "\\}", apiInvoker.escapeString(studyKey.toString()));
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (SubjectList) ApiInvoker.deserialize(localVarResponse, "", SubjectList.class);
      } else {
         return null;
      }
  ...
  */
  public void listSubjects (String studyKey, Integer page, Integer size, String sort, String filter, final Response.Listener<SubjectList> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/studies/{studyKey}/subjects".replaceAll("\\{format\\}","json").replaceAll("\\{" + "studyKey" + "\\}", apiInvoker.escapeString(studyKey.toString()));
      ...
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((SubjectList) ApiInvoker.deserialize(localVarResponse,  "", SubjectList.class));
