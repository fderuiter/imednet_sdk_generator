...
public interface AdministrationApi  {
    ...
    UserList listUsers(@PathParam("studyKey") String studyKey, @QueryParam("page") @DefaultValue("0") Integer page, @QueryParam("size") @DefaultValue("25") Integer size, @QueryParam("sort") String sort, @QueryParam("includeInactive") @DefaultValue("false") Boolean includeInactive) throws ApiException, ProcessingException;
}
