...
public class RecordRevisionsApi {
  ...
  */
  public RecordRevisionList listRecordRevisions (String studyKey, Integer page, Integer size, String sort, String filter) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'studyKey' is set
    if (studyKey == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'studyKey' when calling listRecordRevisions",
        new ApiException(400, "Missing the required parameter 'studyKey' when calling listRecordRevisions"));
    }

    // create path and map variables
    String path = "/studies/{studyKey}/recordRevisions".replaceAll("\\{" + "studyKey" + "\\}", apiInvoker.escapeString(studyKey.toString()));
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (RecordRevisionList) ApiInvoker.deserialize(localVarResponse, "", RecordRevisionList.class);
      } else {
         return null;
      }
  ...
  */
  public void listRecordRevisions (String studyKey, Integer page, Integer size, String sort, String filter, final Response.Listener<RecordRevisionList> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/studies/{studyKey}/recordRevisions".replaceAll("\\{format\\}","json").replaceAll("\\{" + "studyKey" + "\\}", apiInvoker.escapeString(studyKey.toString()));
      ...
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((RecordRevisionList) ApiInvoker.deserialize(localVarResponse,  "", RecordRevisionList.class));
