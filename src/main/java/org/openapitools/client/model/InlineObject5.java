...
public class InlineObject5 {
  ...
  public InlineObject5 metadata(@javax.annotation.Nullable Metadata metadata) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to InlineObject5
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InlineObject5.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InlineObject5.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineObject5` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
