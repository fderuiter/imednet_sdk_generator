...
public class UserList {
  ...
  public UserList metadata(@javax.annotation.Nullable Metadata metadata) {
  ...
  public UserList pagination(@javax.annotation.Nullable Pagination pagination) {
  ...
  public UserList data(@javax.annotation.Nullable List<User> data) {
    this.data = data;
    return this;
  }
