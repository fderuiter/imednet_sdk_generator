...
public class ApiInvoker {
  ...
  */
  ...
  public static void initializeInstance(Cache cache, Network network, int threadPoolSize, ResponseDelivery delivery, int connectionTimeout) {
    ...
    INSTANCE.authentications.put("apiKeyAuth", new ApiKeyAuth("header", "x-api-key"));
    INSTANCE.authentications.put("securityKeyAuth", new ApiKeyAuth("header", "x-imn-security-key"));
