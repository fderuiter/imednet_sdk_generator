 ...
 */
@JsonPropertyOrder({
  UserList.JSON_PROPERTY_METADATA,
  UserList.JSON_PROPERTY_PAGINATION,
  UserList.JSON_PROPERTY_DATA
})
...
public class UserList {
    ...
    private List<@Valid User> data = null;
    ...
    public UserList data(List<@Valid User> data) {
        this.data = data;
        return this;
    }
