 ...
 */
@JsonPropertyOrder({
  SiteList.JSON_PROPERTY_METADATA,
  SiteList.JSON_PROPERTY_PAGINATION,
  SiteList.JSON_PROPERTY_DATA
})
@JsonTypeName("SiteList")
...
public class SiteList {
    ...
    private List<@Valid Site> data = null;
    ...
    public SiteList data(List<@Valid Site> data) {
        this.data = data;
        return this;
    }
    ...
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public List<@Valid Site> getData() {
        return data;
    }

    @JsonProperty(JSON_PROPERTY_DATA)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setData(List<@Valid Site> data) {
        this.data = data;
    }
