 ...
 */
@JsonPropertyOrder({
  FormList.JSON_PROPERTY_METADATA,
  FormList.JSON_PROPERTY_PAGINATION,
  FormList.JSON_PROPERTY_DATA
})
@JsonTypeName("FormList")
...
public class FormList {
    ...
    private List<@Valid Form> data = null;
    ...
    public FormList data(List<@Valid Form> data) {
        this.data = data;
        return this;
    }
    ...
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public List<@Valid Form> getData() {
        return data;
    }

    @JsonProperty(JSON_PROPERTY_DATA)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setData(List<@Valid Form> data) {
        this.data = data;
    }
