 ...
 */
@JsonPropertyOrder({
  QueryList.JSON_PROPERTY_METADATA,
  QueryList.JSON_PROPERTY_PAGINATION,
  QueryList.JSON_PROPERTY_DATA
})
@JsonTypeName("QueryList")
...
public class QueryList {
    ...
    private List<@Valid Query> data = null;
    ...
    public QueryList data(List<@Valid Query> data) {
        this.data = data;
        return this;
    }
    ...
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public List<@Valid Query> getData() {
        return data;
    }

    @JsonProperty(JSON_PROPERTY_DATA)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setData(List<@Valid Query> data) {
        this.data = data;
    }
