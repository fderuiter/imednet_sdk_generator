...
object CodingsApi {
  ...
  def apply(baseUrl: String = "https://edc.prod.imednetapi.com/api/v1/edc") = new CodingsApi(baseUrl)
}

class CodingsApi(baseUrl: String) {

  /**
   * Expected answers:
   *   code 200 : CodingList (Successful response with list of coding entries)
   ...
   */
  def listCodings(studyKey: String, page: Option[Int] = None, size: Option[Int] = None, sort: Option[String] = None, filter: Option[String] = None)(implicit apiKey: ApiKeyValue, apiKey: ApiKeyValue): ApiRequest[CodingList] =
    ApiRequest[CodingList](ApiMethods.GET, baseUrl, "/studies/{studyKey}/codings", "application/json")
      ...
      .withSuccessResponse[CodingList](200)
