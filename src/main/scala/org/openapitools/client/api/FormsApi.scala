...
class FormsApi(baseUrl: String) {
   ...
   */
  def listForms(apiKey: String, apiKey: String)(studyKey: String, page: Option[Int] = None, size: Option[Int] = None, sort: Option[String] = None, filter: Option[String] = None
): Request[Either[ResponseException[String, Exception], FormList], Any] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/studies/${studyKey}/forms?page=${ page }&size=${ size }&sort=${ sort }&filter=${ filter }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
      .header("x-imn-security-key", apiKey)
      .response(asJson[FormList])
