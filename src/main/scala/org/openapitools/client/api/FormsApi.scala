...
class FormsApi(baseUrl: String) {
   ...
   */
  def listForms(apiKey: String, apiKey: String)(studyKey: String, page: Option[Int] = None, size: Option[Int] = None, sort: Option[String] = None, filter: Option[String] = None): Request[Either[ResponseException[String, Exception], FormList]] =
    basicRequest
