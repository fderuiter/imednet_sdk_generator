...
object VisitsApi {
  ...
  def apply(baseUrl: String = "https://edc.prod.imednetapi.com/api/v1/edc") = new VisitsApi(baseUrl)
}

class VisitsApi(baseUrl: String) {

  /**
   * Expected answers:
   *   code 200 : VisitList (Successful response with list of visits)
   ...
   */
  def listVisits(studyKey: String, page: Option[Int] = None, size: Option[Int] = None, sort: Option[String] = None, filter: Option[String] = None)(implicit apiKey: ApiKeyValue, apiKey: ApiKeyValue): ApiRequest[VisitList] =
    ApiRequest[VisitList](ApiMethods.GET, baseUrl, "/studies/{studyKey}/visits", "application/json")
      ...
      .withSuccessResponse[VisitList](200)
