...
class RecordsApi(baseUrl: String) {
   ...
   */
  def createRecords(apiKey: String, apiKey: String)(studyKey: String, componentsSchemasRecordCreateRequestItem: Seq[ComponentsSchemasRecordCreateRequestItem]
): Request[Either[ResponseException[String, Exception], RecordJobStatus], Any] =
    basicRequest
   ...
   */
  def listRecords(apiKey: String, apiKey: String)(studyKey: String, page: Option[Int] = None, size: Option[Int] = None, sort: Option[String] = None, filter: Option[String] = None, recordDataFilter: Option[String] = None
): Request[Either[ResponseException[String, Exception], RecordList], Any] =
    basicRequest
