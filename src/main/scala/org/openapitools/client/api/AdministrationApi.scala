...
class AdministrationApi(baseUrl: String) {
   ...
   */
  def listUsers(apiKey: String, apiKey: String)(studyKey: String, page: Option[Int] = None, size: Option[Int] = None, sort: Option[String] = None, includeInactive: Option[Boolean] = None): Request[Either[ResponseException[String, Exception], UserList]] =
    basicRequest
