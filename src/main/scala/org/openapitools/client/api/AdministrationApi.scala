...
class AdministrationApi(baseUrl: String) {
   ...
   */
  def listUsers(apiKey: String, apiKey: String)(studyKey: String, page: Option[Int] = None, size: Option[Int] = None, sort: Option[String] = None, includeInactive: Option[Boolean] = None
): Request[Either[ResponseException[String, Exception], UserList], Any] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/studies/${studyKey}/users?page=${ page }&size=${ size }&sort=${ sort }&includeInactive=${ includeInactive }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
      .header("x-imn-security-key", apiKey)
      .response(asJson[UserList])
