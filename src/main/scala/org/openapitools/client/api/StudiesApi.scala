...
object StudiesApi {
  ...
  def apply(baseUrl: String = "https://edc.prod.imednetapi.com/api/v1/edc") = new StudiesApi(baseUrl)
}

class StudiesApi(baseUrl: String) {

  /**
   * Expected answers:
   *   code 200 : StudyList (Successful response with list of studies)
   ...
   */
  def listStudies(page: Option[Int] = None, size: Option[Int] = None, sort: Option[String] = None, filter: Option[String] = None)(implicit apiKey: ApiKeyValue, apiKey: ApiKeyValue): ApiRequest[StudyList] =
    ApiRequest[StudyList](ApiMethods.GET, baseUrl, "/studies", "application/json")
      ...
      .withSuccessResponse[StudyList](200)
