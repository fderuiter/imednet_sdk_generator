...
object SubjectsApi {
  ...
  def apply(baseUrl: String = "https://edc.prod.imednetapi.com/api/v1/edc") = new SubjectsApi(baseUrl)
}

class SubjectsApi(baseUrl: String) {

  /**
   * Expected answers:
   *   code 200 : SubjectList (Successful response with list of subjects)
   ...
   */
  def listSubjects(studyKey: String, page: Option[Int] = None, size: Option[Int] = None, sort: Option[String] = None, filter: Option[String] = None)(implicit apiKey: ApiKeyValue, apiKey: ApiKeyValue): ApiRequest[SubjectList] =
    ApiRequest[SubjectList](ApiMethods.GET, baseUrl, "/studies/{studyKey}/subjects", "application/json")
      ...
      .withSuccessResponse[SubjectList](200)
