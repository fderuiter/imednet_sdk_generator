...
trait VisitsApiEndpoints[F[*]] {

  def listVisits(studyKey: String, page: Option[Int] = None, size: Option[Int] = None, sort: Option[String] = None, filter: Option[String] = None)(using auth: _Authorization.ApiKey): F[VisitList]

}

class VisitsApiEndpointsImpl[F[*]: Concurrent](
  override val baseUrl: Uri,
  defaultHeaders: Seq[(String, String)] = Nil,
  httpClient: Http4sClient[F]
) extends BaseClient[F](baseUrl, defaultHeaders, httpClient) with VisitsApiEndpoints[F] {
  
  import JsonSupports.*
  import io.circe.syntax.EncoderOps
  import cats.implicits.toFlatMapOps

  override def listVisits(studyKey: String, page: Option[Int] = None, size: Option[Int] = None, sort: Option[String] = None, filter: Option[String] = None)(using auth: _Authorization.ApiKey): F[VisitList] = {
    ...
    _executeRequest[Unit, VisitList](
      method = "GET",
      path = s"/studies/${studyKey}/visits",
      body = None,
      formParameters = None,
      ...
      auth = Some(auth)) {
        ...
        case r if r.status.code == 200 => parseJson[F, VisitList]("VisitList", r)
