...
trait StudiesApiEndpoints[F[*]] {

  def listStudies(page: Option[Int] = None, size: Option[Int] = None, sort: Option[String] = None, filter: Option[String] = None)(using auth: _Authorization.ApiKey): F[StudyList]

}

class StudiesApiEndpointsImpl[F[*]: Concurrent](
  override val baseUrl: Uri,
  defaultHeaders: Seq[(String, String)] = Nil,
  httpClient: Http4sClient[F]
) extends BaseClient[F](baseUrl, defaultHeaders, httpClient) with StudiesApiEndpoints[F] {
  
  import JsonSupports.*
  import io.circe.syntax.EncoderOps
  import cats.implicits.toFlatMapOps

  override def listStudies(page: Option[Int] = None, size: Option[Int] = None, sort: Option[String] = None, filter: Option[String] = None)(using auth: _Authorization.ApiKey): F[StudyList] = {
    ...
    _executeRequest[Unit, StudyList](
      method = "GET",
      path = s"/studies",
      body = None,
      formParameters = None,
      ...
      auth = Some(auth)) {
        ...
        case r if r.status.code == 200 => parseJson[F, StudyList]("StudyList", r)
