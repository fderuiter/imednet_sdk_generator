...
trait RecordRevisionsApiEndpoints[F[*]] {

  def listRecordRevisions(studyKey: String, page: Option[Int] = None, size: Option[Int] = None, sort: Option[String] = None, filter: Option[String] = None)(using auth: _Authorization.ApiKey): F[RecordRevisionList]

}

class RecordRevisionsApiEndpointsImpl[F[*]: Concurrent](
  override val baseUrl: Uri,
  defaultHeaders: Seq[(String, String)] = Nil,
  httpClient: Http4sClient[F]
) extends BaseClient[F](baseUrl, defaultHeaders, httpClient) with RecordRevisionsApiEndpoints[F] {
  
  import JsonSupports.*
  import io.circe.syntax.EncoderOps
  import cats.implicits.toFlatMapOps

  override def listRecordRevisions(studyKey: String, page: Option[Int] = None, size: Option[Int] = None, sort: Option[String] = None, filter: Option[String] = None)(using auth: _Authorization.ApiKey): F[RecordRevisionList] = {
    ...
    _executeRequest[Unit, RecordRevisionList](
      method = "GET",
      path = s"/studies/${studyKey}/recordRevisions",
      body = None,
      formParameters = None,
      ...
      auth = Some(auth)) {
        ...
        case r if r.status.code == 200 => parseJson[F, RecordRevisionList]("RecordRevisionList", r)
