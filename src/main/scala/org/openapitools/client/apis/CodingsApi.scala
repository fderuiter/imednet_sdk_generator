...
trait CodingsApiEndpoints[F[*]] {

  def listCodings(studyKey: String, page: Option[Int] = None, size: Option[Int] = None, sort: Option[String] = None, filter: Option[String] = None)(using auth: _Authorization.ApiKey): F[CodingList]

}

class CodingsApiEndpointsImpl[F[*]: Concurrent](
  override val baseUrl: Uri,
  defaultHeaders: Seq[(String, String)] = Nil,
  httpClient: Http4sClient[F]
) extends BaseClient[F](baseUrl, defaultHeaders, httpClient) with CodingsApiEndpoints[F] {
  
  import JsonSupports.*
  import io.circe.syntax.EncoderOps
  import cats.implicits.toFlatMapOps

  override def listCodings(studyKey: String, page: Option[Int] = None, size: Option[Int] = None, sort: Option[String] = None, filter: Option[String] = None)(using auth: _Authorization.ApiKey): F[CodingList] = {
    ...
    _executeRequest[Unit, CodingList](
      method = "GET",
      path = s"/studies/${studyKey}/codings",
      body = None,
      formParameters = None,
      ...
      auth = Some(auth)) {
        ...
        case r if r.status.code == 200 => parseJson[F, CodingList]("CodingList", r)
