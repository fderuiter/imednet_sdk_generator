...
case class QueryList(
    ...
    data: Option[Seq[Query]] = None
)
  
object QueryList {
  given encoderQueryList: Encoder[QueryList] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
