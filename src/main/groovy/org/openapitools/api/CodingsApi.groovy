...
class CodingsApi {
    ...
    def listCodings ( String studyKey, Integer page, Integer size, String sort, String filter, Closure onSuccess, Closure onFailure)  {
        String resourcePath = "/studies/${studyKey}/codings"
