...
class SubjectsApi {
    ...
    def listSubjects ( String studyKey, Integer page, Integer size, String sort, String filter, Closure onSuccess, Closure onFailure)  {
        String resourcePath = "/studies/${studyKey}/subjects"
