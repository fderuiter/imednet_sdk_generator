...
FString OpenAPISubjectsApi::ListSubjectsRequest::ComputePath() const
{
	TMap<FString, FStringFormatArg> PathParams = { 
	{ TEXT("studyKey"), FStringFormatArg(ToUrlString(StudyKey)) } };

	FString Path = FString::Format(TEXT("/studies/{studyKey}/subjects"), PathParams);
...
void OpenAPISubjectsApi::ListSubjectsRequest::SetupHttpRequest(const FHttpRequestRef& HttpRequest) const
{
...
void OpenAPISubjectsApi::ListSubjectsResponse::SetHttpResponseCode(EHttpResponseCodes::Type InHttpResponseCode)
{
	Response::SetHttpResponseCode(InHttpResponseCode);
	switch ((int)InHttpResponseCode)
	{
	case 200:
		SetResponseString(TEXT("Successful response with list of subjects"));
		break;
	case 400:
...
bool OpenAPISubjectsApi::ListSubjectsResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
