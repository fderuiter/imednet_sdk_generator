...
FString OpenAPIRecordRevisionsApi::ListRecordRevisionsRequest::ComputePath() const
{
	TMap<FString, FStringFormatArg> PathParams = { 
	{ TEXT("studyKey"), FStringFormatArg(ToUrlString(StudyKey)) } };

	FString Path = FString::Format(TEXT("/studies/{studyKey}/recordRevisions"), PathParams);
...
void OpenAPIRecordRevisionsApi::ListRecordRevisionsRequest::SetupHttpRequest(const FHttpRequestRef& HttpRequest) const
{
...
void OpenAPIRecordRevisionsApi::ListRecordRevisionsResponse::SetHttpResponseCode(EHttpResponseCodes::Type InHttpResponseCode)
{
	Response::SetHttpResponseCode(InHttpResponseCode);
	switch ((int)InHttpResponseCode)
	{
	case 200:
		SetResponseString(TEXT("Successful response with list of record revisions"));
		break;
	case 400:
...
bool OpenAPIRecordRevisionsApi::ListRecordRevisionsResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
