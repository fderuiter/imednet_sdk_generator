...
FString OpenAPIFormsApi::ListFormsRequest::ComputePath() const
{
	TMap<FString, FStringFormatArg> PathParams = { 
	{ TEXT("studyKey"), FStringFormatArg(ToUrlString(StudyKey)) } };

	FString Path = FString::Format(TEXT("/studies/{studyKey}/forms"), PathParams);
...
void OpenAPIFormsApi::ListFormsRequest::SetupHttpRequest(const FHttpRequestRef& HttpRequest) const
{
...
void OpenAPIFormsApi::ListFormsResponse::SetHttpResponseCode(EHttpResponseCodes::Type InHttpResponseCode)
{
	Response::SetHttpResponseCode(InHttpResponseCode);
	switch ((int)InHttpResponseCode)
	{
	case 200:
		SetResponseString(TEXT("Successful response with list of forms"));
		break;
	case 400:
...
bool OpenAPIFormsApi::ListFormsResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
