...
FString OpenAPICodingsApi::ListCodingsRequest::ComputePath() const
{
	TMap<FString, FStringFormatArg> PathParams = { 
	{ TEXT("studyKey"), FStringFormatArg(ToUrlString(StudyKey)) } };

	FString Path = FString::Format(TEXT("/studies/{studyKey}/codings"), PathParams);
...
void OpenAPICodingsApi::ListCodingsRequest::SetupHttpRequest(const FHttpRequestRef& HttpRequest) const
{
...
void OpenAPICodingsApi::ListCodingsResponse::SetHttpResponseCode(EHttpResponseCodes::Type InHttpResponseCode)
{
	Response::SetHttpResponseCode(InHttpResponseCode);
	switch ((int)InHttpResponseCode)
	{
	case 200:
		SetResponseString(TEXT("Successful response with list of coding entries"));
		break;
	case 400:
...
bool OpenAPICodingsApi::ListCodingsResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
