...
FString OpenAPIVariablesApi::ListVariablesRequest::ComputePath() const
{
	TMap<FString, FStringFormatArg> PathParams = { 
	{ TEXT("studyKey"), FStringFormatArg(ToUrlString(StudyKey)) } };

	FString Path = FString::Format(TEXT("/studies/{studyKey}/variables"), PathParams);
...
void OpenAPIVariablesApi::ListVariablesRequest::SetupHttpRequest(const FHttpRequestRef& HttpRequest) const
{
...
void OpenAPIVariablesApi::ListVariablesResponse::SetHttpResponseCode(EHttpResponseCodes::Type InHttpResponseCode)
{
	Response::SetHttpResponseCode(InHttpResponseCode);
	switch ((int)InHttpResponseCode)
	{
	case 200:
		SetResponseString(TEXT("Successful response with list of variables"));
		break;
	case 400:
...
bool OpenAPIVariablesApi::ListVariablesResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
