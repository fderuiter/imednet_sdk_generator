...
FString OpenAPISitesApi::ListSitesRequest::ComputePath() const
{
	TMap<FString, FStringFormatArg> PathParams = { 
	{ TEXT("studyKey"), FStringFormatArg(ToUrlString(StudyKey)) } };

	FString Path = FString::Format(TEXT("/studies/{studyKey}/sites"), PathParams);
...
void OpenAPISitesApi::ListSitesRequest::SetupHttpRequest(const FHttpRequestRef& HttpRequest) const
{
...
void OpenAPISitesApi::ListSitesResponse::SetHttpResponseCode(EHttpResponseCodes::Type InHttpResponseCode)
{
	Response::SetHttpResponseCode(InHttpResponseCode);
	switch ((int)InHttpResponseCode)
	{
	case 200:
		SetResponseString(TEXT("Successful response with list of sites"));
		break;
	case 400:
...
bool OpenAPISitesApi::ListSitesResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
