...
export class StudiesApi {
     ...
     */
    public listStudies(page?: number, size?: number, sort?: string, filter?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.StudyList;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/studies';
        ...
        $.ajax(requestOptions).then(
            (data: models.StudyList, textStatus: string, jqXHR: JQueryXHR) =>
