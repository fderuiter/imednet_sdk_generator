...
export class RecordRevisionsService {
     ...
     * @param {*} [listRecordRevisionsOpts.config] Override http request option.
     */
    public listRecordRevisions(studyKey: string, page?: number, size?: number, sort?: string, filter?: string, listRecordRevisionsOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<RecordRevisionList>>;
    public listRecordRevisions(studyKey: string, page?: number, size?: number, sort?: string, filter?: string, listRecordRevisionsOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<RecordRevisionList>(`${this.basePath}/studies/${encodeURIComponent(String(studyKey))}/recordRevisions`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
                        ...listRecordRevisionsOpts?.config,
                        headers: {...headers, ...listRecordRevisionsOpts?.config?.headers},
                    }
                );
            })
        );
