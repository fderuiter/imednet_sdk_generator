...
export class FormsService {
     ...
     * @param {*} [listFormsOpts.config] Override http request option.
     */
    public listForms(studyKey: string, page?: number, size?: number, sort?: string, filter?: string, listFormsOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<FormList>>;
    public listForms(studyKey: string, page?: number, size?: number, sort?: string, filter?: string, listFormsOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<FormList>(`${this.basePath}/studies/${encodeURIComponent(String(studyKey))}/forms`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
                        ...listFormsOpts?.config,
                        headers: {...headers, ...listFormsOpts?.config?.headers},
                    }
                );
            })
        );
