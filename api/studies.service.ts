...
export class StudiesService {
     ...
     * @param {*} [listStudiesOpts.config] Override http request option.
     */
    public listStudies(page?: number, size?: number, sort?: string, filter?: string, listStudiesOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<StudyList>>;
    public listStudies(page?: number, size?: number, sort?: string, filter?: string, listStudiesOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<StudyList>(`${this.basePath}/studies`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
                        ...listStudiesOpts?.config,
                        headers: {...headers, ...listStudiesOpts?.config?.headers},
                    }
                );
            })
        );
