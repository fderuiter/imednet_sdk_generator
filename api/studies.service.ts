...
export class StudiesService {
     ...
     */
    public listStudies(page?: number, size?: number, sort?: string, filter?: string, observe?: 'body', headers?: Headers): Observable<StudyList>;
    public listStudies(page?: number, size?: number, sort?: string, filter?: string, observe?: 'response', headers?: Headers): Observable<HttpResponse<StudyList>>;
    public listStudies(page?: number, size?: number, sort?: string, filter?: string, observe: any = 'body', headers: Headers = {}): Observable<any> {
        ...
        const response: Observable<HttpResponse<StudyList>> = this.httpClient.get(`${this.basePath}/studies?${queryParameters.join('&')}`, headers);
        if (observe === 'body') {
               return response.pipe(
                   map((httpResponse: HttpResponse) => <StudyList>(httpResponse.response))
               );
        }
        return response;
    }
