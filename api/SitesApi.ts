...
export class SitesApi {
     ...
     */
    public listSites(studyKey: string, page?: number, size?: number, sort?: string, filter?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.SiteList;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/studies/{studyKey}/sites'.replace('{' + 'studyKey' + '}', encodeURIComponent(String(studyKey)));
        ...
        $.ajax(requestOptions).then(
            (data: models.SiteList, textStatus: string, jqXHR: JQueryXHR) =>
