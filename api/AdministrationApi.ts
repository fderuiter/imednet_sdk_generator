...
export class AdministrationApi {
     ...
     */
    public listUsers(studyKey: string, page?: number, size?: number, sort?: string, includeInactive?: boolean, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.UserList;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/studies/{studyKey}/users'.replace('{' + 'studyKey' + '}', encodeURIComponent(String(studyKey)));
        ...
        if (includeInactive !== null && includeInactive !== undefined) {
            queryParameters['includeInactive'] = <string><any>includeInactive;
        }
        ...
        $.ajax(requestOptions).then(
            (data: models.UserList, textStatus: string, jqXHR: JQueryXHR) =>
