...
export class CodingsService {
     ...
     * @param {*} [listCodingsOpts.config] Override http request option.
     */
    public listCodings(studyKey: string, page?: number, size?: number, sort?: string, filter?: string, listCodingsOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<CodingList>>;
    public listCodings(studyKey: string, page?: number, size?: number, sort?: string, filter?: string, listCodingsOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<CodingList>(`${this.basePath}/studies/${encodeURIComponent(String(studyKey))}/codings`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
                        ...listCodingsOpts?.config,
                        headers: {...headers, ...listCodingsOpts?.config?.headers},
                    }
                );
            })
        );
