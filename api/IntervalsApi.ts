...
export class IntervalsApi {
     ...
     */
    public listIntervals(studyKey: string, page?: number, size?: number, sort?: string, filter?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.IntervalList;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/studies/{studyKey}/intervals'.replace('{' + 'studyKey' + '}', encodeURIComponent(String(studyKey)));
        ...
        $.ajax(requestOptions).then(
            (data: models.IntervalList, textStatus: string, jqXHR: JQueryXHR) =>
