...
export class IntervalsService {
     ...
     * @param {*} [listIntervalsOpts.config] Override http request option.
     */
    public listIntervals(studyKey: string, page?: number, size?: number, sort?: string, filter?: string, listIntervalsOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<IntervalList>>;
    public listIntervals(studyKey: string, page?: number, size?: number, sort?: string, filter?: string, listIntervalsOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<IntervalList>(`${this.basePath}/studies/${encodeURIComponent(String(studyKey))}/intervals`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
                        ...listIntervalsOpts?.config,
                        headers: {...headers, ...listIntervalsOpts?.config?.headers},
                    }
                );
            })
        );
