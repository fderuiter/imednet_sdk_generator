...
export class SubjectsService {
     ...
     * @param {*} [listSubjectsOpts.config] Override http request option.
     */
    public listSubjects(studyKey: string, page?: number, size?: number, sort?: string, filter?: string, listSubjectsOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<SubjectList>>;
    public listSubjects(studyKey: string, page?: number, size?: number, sort?: string, filter?: string, listSubjectsOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<SubjectList>(`${this.basePath}/studies/${encodeURIComponent(String(studyKey))}/subjects`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
                        ...listSubjectsOpts?.config,
                        headers: {...headers, ...listSubjectsOpts?.config?.headers},
                    }
                );
            })
        );
