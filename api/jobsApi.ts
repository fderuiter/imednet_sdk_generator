...
export class JobsApi {
     ...
     */
    public async getJobStatus (studyKey: string, batchId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Job;  }> {
        const localVarPath = this.basePath + '/studies/{studyKey}/jobs/{batchId}'
