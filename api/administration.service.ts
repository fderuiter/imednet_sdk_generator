...
export class AdministrationService {
     ...
     */
    public listUsers(studyKey: string, page?: number, size?: number, sort?: string, includeInactive?: boolean, listUsersOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<UserList>>;
    public listUsers(studyKey: string, page?: number, size?: number, sort?: string, includeInactive?: boolean, listUsersOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        if (includeInactive !== undefined && includeInactive !== null) {
            queryParameters.append('includeInactive', <any>includeInactive);
        }
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<UserList>(`${this.basePath}/studies/${encodeURIComponent(String(studyKey))}/users`,
                    {
