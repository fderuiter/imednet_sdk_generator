...
export class SitesService {
     ...
     * @param {*} [listSitesOpts.config] Override http request option.
     */
    public listSites(studyKey: string, page?: number, size?: number, sort?: string, filter?: string, listSitesOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<SiteList>>;
    public listSites(studyKey: string, page?: number, size?: number, sort?: string, filter?: string, listSitesOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<SiteList>(`${this.basePath}/studies/${encodeURIComponent(String(studyKey))}/sites`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
                        ...listSitesOpts?.config,
                        headers: {...headers, ...listSitesOpts?.config?.headers},
                    }
                );
            })
        );
