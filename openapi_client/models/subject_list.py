...
class SubjectList(BaseModel):
    ...
    data: Optional[conlist(Subject)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubjectList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SubjectList:
        """Create an instance of SubjectList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubjectList.parse_obj(obj)

        _obj = SubjectList.parse_obj({
            ...
            "data": [Subject.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
