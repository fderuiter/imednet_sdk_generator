...
class RecordList(BaseModel):
    ...
    data: Optional[conlist(Record)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RecordList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RecordList:
        """Create an instance of RecordList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RecordList.parse_obj(obj)

        _obj = RecordList.parse_obj({
            ...
            "data": [Record.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
