...
class StudyList(BaseModel):
    ...
    data: Optional[conlist(Study)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StudyList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StudyList:
        """Create an instance of StudyList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StudyList.parse_obj(obj)

        _obj = StudyList.parse_obj({
            ...
            "data": [Study.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
