...
class Interval(BaseModel):
    ...
    defined_using_interval: Optional[StrictStr] = Field(default=None, description="Baseline interval used for calculating this interval’s dates", alias="definedUsingInterval")
