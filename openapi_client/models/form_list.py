...
class FormList(BaseModel):
    ...
    data: Optional[conlist(Form)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FormList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FormList:
        """Create an instance of FormList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FormList.parse_obj(obj)

        _obj = FormList.parse_obj({
            ...
            "data": [Form.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
