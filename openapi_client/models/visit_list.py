...
class VisitList(BaseModel):
    ...
    data: Optional[conlist(Visit)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VisitList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VisitList:
        """Create an instance of VisitList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VisitList.parse_obj(obj)

        _obj = VisitList.parse_obj({
            ...
            "data": [Visit.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
