...
AuthSettings = TypedDict(
    "AuthSettings",
    {
        ...
        "securityKeyAuth": APIKeyAuthSetting,
    },
    total=False,
)
...
conf = openapi_client.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://edc.prod.imednetapi.com/api/v1/edc" if host is None else host
        """Default Base url
        """
    ...
    def auth_settings(self)-> AuthSettings:
        ...
        if 'securityKeyAuth' in self.api_key:
            auth['securityKeyAuth'] = {
                'type': 'api_key',
                'in': 'header',
