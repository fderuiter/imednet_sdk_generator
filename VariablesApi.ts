...
/**
 * listVariables - parameters interface
 */
...
export class VariablesApi extends Api {
   ...
   */
  async listVariables(params: IListVariablesParams): Promise<VariableList> {
    // Verify required parameters are set
    this.ensureParamIsSet('listVariables', params, 'studyKey');

    // Create URL to call
    const url = `${this.basePath}/studies/{studyKey}/variables`
