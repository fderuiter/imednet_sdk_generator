...
void main() {
  ...
  group('test Subject', () {
    ...
    test('to test the property `subjectStatus`', () async {
      // TODO
    });
    ...
    test('to test the property `enrollmentStartDate`', () async {
      // TODO
    });
    ...
    // List<Keyword> keywords (default value: const [])
