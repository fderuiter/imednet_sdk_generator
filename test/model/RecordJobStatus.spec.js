...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MednetEdcApi.RecordJobStatus();
  });
  ...
  describe('RecordJobStatus', function() {
    it('should create an instance of RecordJobStatus', function() {
      // uncomment below and update the code to test RecordJobStatus
      //var instance = new MednetEdcApi.RecordJobStatus();
      //expect(instance).to.be.a(MednetEdcApi.RecordJobStatus);
    });
