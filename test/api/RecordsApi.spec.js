...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MednetEdcApi.RecordsApi();
  });
  ...
  describe('RecordsApi', function() {
    describe('createRecords', function() {
      it('should call createRecords successfully', function(done) {
        //uncomment below and update the code to test createRecords
        //instance.createRecords(function(error) {
