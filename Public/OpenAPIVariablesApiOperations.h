...
*/
class OPENAPI_API OpenAPIVariablesApi::ListVariablesRequest : public Request
{
public:
...
class OPENAPI_API OpenAPIVariablesApi::ListVariablesResponse : public Response
{
public:
