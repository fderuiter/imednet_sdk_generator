...
*/
class OPENAPI_API OpenAPIFormsApi::ListFormsRequest : public Request
{
public:
    virtual ~ListFormsRequest() {}
...
class OPENAPI_API OpenAPIFormsApi::ListFormsResponse : public Response
{
public:
    virtual ~ListFormsResponse() {}
	void SetHttpResponseCode(EHttpResponseCodes::Type InHttpResponseCode) final;
	bool FromJson(const TSharedPtr<FJsonValue>& JsonValue) final;

    OpenAPIFormList Content;
};
