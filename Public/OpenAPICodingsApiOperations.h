...
*/
class OPENAPI_API OpenAPICodingsApi::ListCodingsRequest : public Request
{
public:
    virtual ~ListCodingsRequest() {}
...
class OPENAPI_API OpenAPICodingsApi::ListCodingsResponse : public Response
{
public:
    virtual ~ListCodingsResponse() {}
	void SetHttpResponseCode(EHttpResponseCodes::Type InHttpResponseCode) final;
	bool FromJson(const TSharedPtr<FJsonValue>& JsonValue) final;

    OpenAPICodingList Content;
};
