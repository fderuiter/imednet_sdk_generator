...
*/
class OPENAPI_API OpenAPIIntervalsApi::ListIntervalsRequest : public Request
{
public:
    virtual ~ListIntervalsRequest() {}
...
class OPENAPI_API OpenAPIIntervalsApi::ListIntervalsResponse : public Response
{
public:
    virtual ~ListIntervalsResponse() {}
	void SetHttpResponseCode(EHttpResponseCodes::Type InHttpResponseCode) final;
	bool FromJson(const TSharedPtr<FJsonValue>& JsonValue) final;

    OpenAPIIntervalList Content;
};
