...
```typescript
import { createConfiguration, VariablesApi } from '';
import type { VariablesApiListVariablesRequest } from '';

const configuration = createConfiguration();
const apiInstance = new VariablesApi(configuration);

const request: VariablesApiListVariablesRequest = {
...
const data = await apiInstance.listVariables(request);
