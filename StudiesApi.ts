...
/**
 * listStudies - parameters interface
 */
export interface IListStudiesParams {
  page?: number;
  size?: number;
  sort?: string;
  filter?: string;
...
/**
 * StudiesApi - API class
 */
@autoinject()
export class StudiesApi extends Api {

  /**
   * Creates a new StudiesApi class.
   *
   ...
   */
  async listStudies(params: IListStudiesParams): Promise<StudyList> {
    // Verify required parameters are set

    // Create URL to call
    const url = `${this.basePath}/studies`;
