...
# Unit tests for OpenAPIClient::IntervalsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe "IntervalsApi" do
  describe "test an instance of IntervalsApi" do
    it "should create an instance of IntervalsApi" do
      api_instance = OpenAPIClient::IntervalsApi.new
      expect(api_instance).to be_instance_of(OpenAPIClient::IntervalsApi)
    end
  end
  ...
  # @return [IntervalList]
  describe "list_intervals test" do
    skip "should work" do
