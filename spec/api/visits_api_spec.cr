...
# Unit tests for OpenAPIClient::VisitsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe "VisitsApi" do
  describe "test an instance of VisitsApi" do
    it "should create an instance of VisitsApi" do
      api_instance = OpenAPIClient::VisitsApi.new
      expect(api_instance).to be_instance_of(OpenAPIClient::VisitsApi)
    end
  end
