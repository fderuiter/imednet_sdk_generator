...
export class StudiesApi extends BaseAPI {
     ...
     */
    listStudies({ page, size, sort, filter }: ListStudiesRequest): Observable<StudyList>
    listStudies({ page, size, sort, filter }: ListStudiesRequest, opts?: OperationOpts): Observable<AjaxResponse<StudyList>>
    listStudies({ page, size, sort, filter }: ListStudiesRequest, opts?: OperationOpts): Observable<StudyList | AjaxResponse<StudyList>> {
