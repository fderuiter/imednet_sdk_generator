const samples = require('../samples/StudiesApi');
...
module.exports = {
    listStudies: {
        ...
        noun: 'Studies',
        display: {
            label: 'List studies accessible by API key',
            description: '',
            hidden: false,
        },
        operation: {
            ...
            outputFields: [
                ...StudyList.fields('', false),
            ],
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://edc.prod.imednetapi.com/api/v1/edc/studies'),
                    method: 'GET',
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    ...
                    const results = utils.responseOptionsMiddleware(z, bundle, 'listStudies', response.json);
                    return results;
                })
            },
            sample: samples['StudyListSample']
        }
    },
}
