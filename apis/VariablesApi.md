...
------------- | ------------- | -------------
[**list_variables**](#list_variables) | **GET** `/studies/{studyKey}/variables` | List variables (fields) in a study

# **list_variables**   { #list_variables }
<a name="list_variables"></a>

> `list_variables(studyKey: String,page = 0,size = 25,sort = null,filter = null, on_success: Callable, on_failure: Callable)`
...
# Instantiate the api
var api = VariablesApi.new(config)
# You can also provide your own HTTPClient, to re-use it across apis.
#var api = VariablesApi.new(config, client)
...
api.list_variables(
	...
	func(response):  # response is ApiResponse
		prints("Success!", "list_variables", response)
		assert(response.data is VariableList)
