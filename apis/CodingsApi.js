const samples = require('../samples/CodingsApi');
const CodingList = require('../models/CodingList');
...
module.exports = {
    listCodings: {
        ...
        noun: 'Codings',
        display: {
            label: 'List coding activities in a study',
            description: '',
            hidden: false,
        },
        operation: {
            ...
            outputFields: [
                ...CodingList.fields('', false),
            ],
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://edc.prod.imednetapi.com/api/v1/edc/studies/{studyKey}/codings'),
                    method: 'GET',
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    ...
                    const results = utils.responseOptionsMiddleware(z, bundle, 'listCodings', response.json);
                    return results;
                })
            },
            sample: samples['CodingListSample']
        }
    },
}
