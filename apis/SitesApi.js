const samples = require('../samples/SitesApi');
...
module.exports = {
    listSites: {
        ...
        operation: {
            ...
            outputFields: [
                ...SiteList.fields('', false),
            ],
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://edc.prod.imednetapi.com/api/v1/edc/studies/{studyKey}/sites'),
                    method: 'GET',
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    ...
                    const results = utils.responseOptionsMiddleware(z, bundle, 'listSites', response.json);
                    return results;
                })
            },
            sample: samples['SiteListSample']
        }
    },
}
