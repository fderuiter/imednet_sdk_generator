...
------------- | ------------- | -------------
[**list_intervals**](#list_intervals) | **GET** `/studies/{studyKey}/intervals` | List intervals (visit definitions) in a study

# **list_intervals**   { #list_intervals }
<a name="list_intervals"></a>

> `list_intervals(studyKey: String,page = 0,size = 25,sort = null,filter = null, on_success: Callable, on_failure: Callable)`
...
# Instantiate the api
var api = IntervalsApi.new(config)
# You can also provide your own HTTPClient, to re-use it across apis.
#var api = IntervalsApi.new(config, client)
...
api.list_intervals(
	...
	func(response):  # response is ApiResponse
		prints("Success!", "list_intervals", response)
		assert(response.data is IntervalList)
