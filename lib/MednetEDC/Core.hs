...
-- |
data MednetEDCConfig = MednetEDCConfig
...
-- | display the config
instance P.Show MednetEDCConfig where
  show c =
    T.printf
...
-- | constructs a default MednetEDCConfig
--
-- configHost:
--
...
-- @"mednet-edc/0.1.0.0"@
--
newConfig :: IO MednetEDCConfig
newConfig = do
    logCxt <- initLogContext
    return $ MednetEDCConfig
        { configHost = "https://edc.prod.imednetapi.com/api/v1/edc"
        , configUserAgent = "mednet-edc/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => MednetEDCConfig -> auth -> MednetEDCConfig
addAuthMethod config@MednetEDCConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: MednetEDCConfig -> IO MednetEDCConfig
...
withStderrLogging :: MednetEDCConfig -> IO MednetEDCConfig
...
withNoLogging :: MednetEDCConfig -> MednetEDCConfig
...
data MednetEDCRequest req contentType res accept = MednetEDCRequest
  { rMethod  :: NH.Method   -- ^ Method of MednetEDCRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of MednetEDCRequest
  , rParams   :: Params -- ^ params of MednetEDCRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (MednetEDCRequest req contentType res accept) NH.Method
rMethodL f MednetEDCRequest{..} = (\rMethod -> MednetEDCRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (MednetEDCRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f MednetEDCRequest{..} = (\rUrlPath -> MednetEDCRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (MednetEDCRequest req contentType res accept) Params
rParamsL f MednetEDCRequest{..} = (\rParams -> MednetEDCRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (MednetEDCRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f MednetEDCRequest{..} = (\rAuthTypes -> MednetEDCRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => MednetEDCRequest req contentType res accept -> param -> MednetEDCRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: MednetEDCRequest req contentType res accept -> param -> MednetEDCRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: MednetEDCRequest req contentType res accept -> param -> MednetEDCRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** MednetEDCRequest Utils

_mkRequest :: NH.Method -- ^ Method
          -> [BCL.ByteString] -- ^ Endpoint
          -> MednetEDCRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = MednetEDCRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader ::
     MednetEDCRequest req contentType res accept
  -> [NH.Header]
  -> MednetEDCRequest req contentType res accept
...
removeHeader :: MednetEDCRequest req contentType res accept -> [NH.HeaderName] -> MednetEDCRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => MednetEDCRequest req contentType res accept -> MednetEDCRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => MednetEDCRequest req contentType res accept -> MednetEDCRequest req contentType res accept
...
addForm :: MednetEDCRequest req contentType res accept -> WH.Form -> MednetEDCRequest req contentType res accept
addForm req newform =
...
_addMultiFormPart :: MednetEDCRequest req contentType res accept -> NH.Part -> MednetEDCRequest req contentType res accept
...
_setBodyBS :: MednetEDCRequest req contentType res accept -> B.ByteString -> MednetEDCRequest req contentType res accept
_setBodyBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: MednetEDCRequest req contentType res accept -> BL.ByteString -> MednetEDCRequest req contentType res accept
_setBodyLBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => MednetEDCRequest req contentType res accept -> P.Proxy authMethod -> MednetEDCRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> MednetEDCRequest req contentType res accept
    -> IO (MednetEDCRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> MednetEDCConfig
  -> IO (MednetEDCRequest req contentType res accept)
_applyAuthMethods req config@(MednetEDCConfig {configAuthMethods = as}) =
  foldlM go req as
  where
