...
class FormsApi {
  ...
  Future<Response> listFormsWithHttpInfo(String studyKey, { int? page, int? size, String? sort, String? filter, }) async {
    // ignore: prefer_const_declarations
    final path = r'/studies/{studyKey}/forms'
  ...
  Future<FormList?> listForms(String studyKey, { int? page, int? size, String? sort, String? filter, }) async {
    final response = await listFormsWithHttpInfo(studyKey,  page: page, size: size, sort: sort, filter: filter, );
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'FormList',) as FormList;
