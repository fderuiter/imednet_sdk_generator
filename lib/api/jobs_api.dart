...
class JobsApi {
  ...
  Future<Response> getJobStatusWithHttpInfo(String studyKey, String batchId,) async {
    // ignore: prefer_const_declarations
    final path = r'/studies/{studyKey}/jobs/{batchId}'
  ...
  Future<Job?> getJobStatus(String studyKey, String batchId,) async {
    final response = await getJobStatusWithHttpInfo(studyKey, batchId,);
