...
class VariablesApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [VariableList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<VariableList>> listVariables({ 
    ...
    final _path = r'/studies/{studyKey}/variables'.replaceAll('{' r'studyKey' '}', encodeQueryParameter(_serializers, studyKey, const FullType(String)).toString());
