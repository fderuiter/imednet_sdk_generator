...
class SitesApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [SiteList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SiteList>> listSites({ 
    ...
    final _path = r'/studies/{studyKey}/sites'.replaceAll('{' r'studyKey' '}', encodeQueryParameter(_serializers, studyKey, const FullType(String)).toString());
    ...
    SiteList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(SiteList),
      ) as SiteList;
