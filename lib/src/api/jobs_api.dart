...
class JobsApi {
  ...
  /// * [batchId] - Batch ID of the job to retrieve
  ...
  Future<Response<Job>> getJobStatus({ 
    ...
    final _path = r'/studies/{studyKey}/jobs/{batchId}'.replaceAll('{' r'studyKey' '}', encodeQueryParameter(_serializers, studyKey, const FullType(String)).toString()).replaceAll('{' r'batchId' '}', encodeQueryParameter(_serializers, batchId, const FullType(String)).toString());
