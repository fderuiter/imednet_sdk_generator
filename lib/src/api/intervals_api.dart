...
class IntervalsApi {
  ...
  const IntervalsApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [IntervalList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<IntervalList>> listIntervals({ 
    ...
    final _path = r'/studies/{studyKey}/intervals'.replaceAll('{' r'studyKey' '}', encodeQueryParameter(_serializers, studyKey, const FullType(String)).toString());
    ...
    IntervalList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(IntervalList),
      ) as IntervalList;
