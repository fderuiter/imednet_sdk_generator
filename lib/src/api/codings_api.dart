...
class CodingsApi {
  ...
  const CodingsApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [CodingList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CodingList>> listCodings({ 
    ...
    final _path = r'/studies/{studyKey}/codings'.replaceAll('{' r'studyKey' '}', encodeQueryParameter(_serializers, studyKey, const FullType(String)).toString());
    ...
    CodingList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(CodingList),
      ) as CodingList;
