...
#
package WWW::OpenAPIClient::Object::Variable;
...
__PACKAGE__->method_documentation({
    ...
    'revision' => {
        datatype => 'int',
        base_name => 'revision',
        description => 'Number of modifications of the variable (via form metadata revisions)',
        format => '',
        read_only => '',
            },
    'disabled' => {
    ...
    'blinded' => {
        datatype => 'boolean',
        base_name => 'blinded',
        description => 'Whether the variable is flagged as blinded (hidden in certain contexts)',
        format => '',
        read_only => '',
            },
});
