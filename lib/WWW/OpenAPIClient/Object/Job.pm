...
#
package WWW::OpenAPIClient::Object::Job;
...
__PACKAGE__->method_documentation({
    ...
    'batch_id' => {
        datatype => 'string',
        base_name => 'batchId',
        description => 'Batch ID associated with the job (useful for linking with record creation requests)',
        format => '',
        read_only => '',
            },
    'state' => {
