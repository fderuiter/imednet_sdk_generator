#ifndef TINY_CPP_CLIENT_VisitsApi_H_
#define TINY_CPP_CLIENT_VisitsApi_H_
...
class VisitsApi : public Service {
public:
    VisitsApi() = default;

    virtual ~VisitsApi() = default;
...
#endif /* TINY_CPP_CLIENT_VisitsApi_H_ */