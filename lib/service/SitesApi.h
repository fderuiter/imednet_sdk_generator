#ifndef TINY_CPP_CLIENT_SitesApi_H_
#define TINY_CPP_CLIENT_SitesApi_H_
...
class SitesApi : public Service {
public:
    SitesApi() = default;

    virtual ~SitesApi() = default;
...
#endif /* TINY_CPP_CLIENT_SitesApi_H_ */