...
using namespace Tiny;
        ...
        {
            std::string url = basepath + "/studies/{studyKey}/subjects"; //studyKey 
            ...
            SubjectList obj(output_string);


            Response<SubjectList> response(obj, httpCode);
            return response;
        }
