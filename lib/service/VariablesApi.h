#ifndef TINY_CPP_CLIENT_VariablesApi_H_
#define TINY_CPP_CLIENT_VariablesApi_H_
...
class VariablesApi : public Service {
public:
    VariablesApi() = default;

    virtual ~VariablesApi() = default;
...
#endif /* TINY_CPP_CLIENT_VariablesApi_H_ */