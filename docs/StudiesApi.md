...
[**listStudiesWithHttpInfo**](StudiesApi.md#listStudiesWithHttpInfo) | **GET** /studies | List studies accessible by API key



## listStudies

> listStudies(listStudiesRequest): ApiRequest[StudyList]
...
object Example extends App {
    ...
    val apiInstance = StudiesApi("https://edc.prod.imednetapi.com/api/v1/edc")
    ...
    val request = apiInstance.listStudies(page, size, sort, filter)
    ...
    response.onComplete {
        ...
        case Failure(error @ ApiError(code, message, responseContent, cause, headers)) =>
            System.err.println("Exception when calling StudiesApi#listStudies")
...
ApiRequest[[**StudyList**](StudyList.md)]
