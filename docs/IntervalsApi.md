...
```java
// Import classes:
//import org.openapitools.client.api.IntervalsApi;

IntervalsApi apiInstance = new IntervalsApi();
...
try {
    IntervalList result = apiInstance.listIntervals(studyKey, page, size, sort, filter);
