...
------------- | ------------- | -------------
[**list_variables**](VARIABLES_API.md#list_variables) | **Get** /studies/{studyKey}/variables | List variables (fields) in a study


# **list_variables**
> list_variables (study_key: STRING_32 ; page:  detachable INTEGER_32 ; size:  detachable INTEGER_32 ; sort:  detachable STRING_32 ; filter:  detachable STRING_32 ): detachable VARIABLE_LIST
