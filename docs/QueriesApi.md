...
[**listQueriesWithHttpInfo**](QueriesApi.md#listQueriesWithHttpInfo) | **GET** /studies/{studyKey}/queries | List data queries in a study



## listQueries

> listQueries(listQueriesRequest): ApiRequest[QueryList]
...
object Example extends App {
    ...
    val apiInstance = QueriesApi("https://edc.prod.imednetapi.com/api/v1/edc")
    ...
    val request = apiInstance.listQueries(studyKey, page, size, sort, filter)
...
ApiRequest[[**QueryList**](QueryList.md)]
