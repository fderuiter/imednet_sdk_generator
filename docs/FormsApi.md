...
[**listFormsWithHttpInfo**](FormsApi.md#listFormsWithHttpInfo) | **GET** /studies/{studyKey}/forms | List forms in a study



## listForms

> listForms(listFormsRequest): ApiRequest[FormList]
...
object Example extends App {
    ...
    val apiInstance = FormsApi("https://edc.prod.imednetapi.com/api/v1/edc")
    ...
    val request = apiInstance.listForms(studyKey, page, size, sort, filter)
...
ApiRequest[[**FormList**](FormList.md)]
