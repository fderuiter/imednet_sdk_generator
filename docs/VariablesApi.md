# PSOpenAPITools.PSOpenAPITools\Api.VariablesApi

All URIs are relative to *https://edc.prod.imednetapi.com/api/v1/edc*

Method | HTTP request | Description
------------- | ------------- | -------------
[**Invoke-ListVariables**](VariablesApi.md#Invoke-ListVariables) | **GET** /studies/{studyKey}/variables | List variables (fields) in a study


<a id="Invoke-ListVariables"></a>
# **Invoke-ListVariables**
> VariableList Invoke-ListVariables<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-StudyKey] <String><br>
...
# List variables (fields) in a study
try {
    $Result = Invoke-ListVariables -StudyKey $StudyKey -Page $Page -Size $Size -Sort $Sort -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-ListVariables: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
...
[**VariableList**](VariableList.md) (PSCustomObject)
