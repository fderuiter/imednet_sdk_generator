...
------------- | ------------- | -------------
[**list_queries**](QUERIES_API.md#list_queries) | **Get** /studies/{studyKey}/queries | List data queries in a study


# **list_queries**
> list_queries (study_key: STRING_32 ; page:  detachable INTEGER_32 ; size:  detachable INTEGER_32 ; sort:  detachable STRING_32 ; filter:  detachable STRING_32 ): detachable QUERY_LIST
