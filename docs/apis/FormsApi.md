...
To initiate an instance of `FormsApi`, you can use micronaut's `ApplicationContext`:
```java
/* imports
import io.micronaut.runtime.Micronaut;
import io.micronaut.context.ApplicationContext;
import org.openapitools.api.FormsApi;
*/

ApplicationContext context = Micronaut.run(/* ... */);
PetApi apiInstance = context.getBean(FormsApi.class);
```
...
# **listForms**
```java
Mono<FormList> FormsApi.listForms(studyKeypagesizesortfilter)
```
