...
## Creating VariablesApi

To initiate an instance of `VariablesApi`, you can use micronaut's `ApplicationContext`:
```java
/* imports
import io.micronaut.runtime.Micronaut;
import io.micronaut.context.ApplicationContext;
import org.openapitools.api.VariablesApi;
*/

ApplicationContext context = Micronaut.run(/* ... */);
PetApi apiInstance = context.getBean(VariablesApi.class);
```
...
# **listVariables**
```java
Mono<VariableList> VariablesApi.listVariables(studyKeypagesizesortfilter)
```
