...
export class SubjectsApi {
     ...
     */
    public listSubjects(studyKey: string, page?: number, size?: number, sort?: string, filter?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.SubjectList;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/studies/{studyKey}/subjects'.replace('{' + 'studyKey' + '}', encodeURIComponent(String(studyKey)));
        ...
        $.ajax(requestOptions).then(
            (data: models.SubjectList, textStatus: string, jqXHR: JQueryXHR) =>
