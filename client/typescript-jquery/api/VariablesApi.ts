...
export class VariablesApi {
     ...
     */
    public listVariables(studyKey: string, page?: number, size?: number, sort?: string, filter?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.VariableList;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/studies/{studyKey}/variables'.replace('{' + 'studyKey' + '}', encodeURIComponent(String(studyKey)));
