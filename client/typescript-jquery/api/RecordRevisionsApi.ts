...
export class RecordRevisionsApi {
     ...
     */
    public listRecordRevisions(studyKey: string, page?: number, size?: number, sort?: string, filter?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.RecordRevisionList;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/studies/{studyKey}/recordRevisions'.replace('{' + 'studyKey' + '}', encodeURIComponent(String(studyKey)));
        ...
        $.ajax(requestOptions).then(
            (data: models.RecordRevisionList, textStatus: string, jqXHR: JQueryXHR) =>
