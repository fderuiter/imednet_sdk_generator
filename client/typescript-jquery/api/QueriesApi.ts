...
export class QueriesApi {
     ...
     */
    public listQueries(studyKey: string, page?: number, size?: number, sort?: string, filter?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.QueryList;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/studies/{studyKey}/queries'.replace('{' + 'studyKey' + '}', encodeURIComponent(String(studyKey)));
        ...
        $.ajax(requestOptions).then(
            (data: models.QueryList, textStatus: string, jqXHR: JQueryXHR) =>
