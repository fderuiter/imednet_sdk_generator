...
# **listCodings**
```swift
    open class func listCodings(studyKey: String, page: Int? = nil, size: Int? = nil, sort: String? = nil, filter: String? = nil, completion: @escaping (_ data: CodingList?, _ error: Error?) -> Void)
```
...
// List coding activities in a study
CodingsAPI.listCodings(studyKey: studyKey, page: page, size: size, sort: sort, filter: filter) { (response, error) in
