...
public struct ComponentsSchemasRecordCreateRequestItem: Codable, JSONEncodable, Hashable {
    ...
    public init(formKey: String, formId: Int? = nil, siteName: String? = nil, siteId: Int? = nil, subjectKey: String? = nil, subjectId: Int? = nil, subjectOid: String? = nil, intervalName: String? = nil, intervalId: Int? = nil, recordId: Int? = nil, recordOid: String? = nil, data: [String: AnyCodable]) {
