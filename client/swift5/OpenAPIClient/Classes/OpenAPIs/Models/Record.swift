...
public struct Record: Codable, JSONEncodable, Hashable {
    ...
    public var recordData: [String: AnyCodable]?

    public init(studyKey: String? = nil, intervalId: Int? = nil, formId: Int? = nil, formKey: String? = nil, siteId: Int? = nil, recordId: Int? = nil, recordOid: String? = nil, recordType: String? = nil, recordStatus: String? = nil, deleted: Bool? = nil, dateCreated: String? = nil, dateModified: String? = nil, subjectId: Int? = nil, subjectOid: String? = nil, subjectKey: String? = nil, visitId: Int? = nil, parentRecordId: Int? = nil, keywords: [Keyword]? = nil, recordData: [String: AnyCodable]? = nil) {
