...
open class RecordRevisionsAPI {
     ...
     */
    @discardableResult
    open class func listRecordRevisions(studyKey: String, page: Int? = nil, size: Int? = nil, sort: String? = nil, filter: String? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: RecordRevisionList?, _ error: Error?) -> Void)) -> RequestTask {
        return listRecordRevisionsWithRequestBuilder(studyKey: studyKey, page: page, size: size, sort: sort, filter: filter).execute(apiResponseQueue) { result in
            switch result {
     ...
     */
    open class func listRecordRevisionsWithRequestBuilder(studyKey: String, page: Int? = nil, size: Int? = nil, sort: String? = nil, filter: String? = nil) -> RequestBuilder<RecordRevisionList> {
        ...
        let localVariableRequestBuilder: RequestBuilder<RecordRevisionList>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
