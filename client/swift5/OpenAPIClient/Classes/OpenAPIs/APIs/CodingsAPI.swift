...
open class CodingsAPI {
     ...
     */
    @discardableResult
    open class func listCodings(studyKey: String, page: Int? = nil, size: Int? = nil, sort: String? = nil, filter: String? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: CodingList?, _ error: Error?) -> Void)) -> RequestTask {
        return listCodingsWithRequestBuilder(studyKey: studyKey, page: page, size: size, sort: sort, filter: filter).execute(apiResponseQueue) { result in
            switch result {
     ...
     */
    open class func listCodingsWithRequestBuilder(studyKey: String, page: Int? = nil, size: Int? = nil, sort: String? = nil, filter: String? = nil) -> RequestBuilder<CodingList> {
        ...
        let localVariableRequestBuilder: RequestBuilder<CodingList>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
