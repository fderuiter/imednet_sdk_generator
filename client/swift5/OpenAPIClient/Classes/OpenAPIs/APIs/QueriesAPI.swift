...
open class QueriesAPI {
     ...
     */
    @discardableResult
    open class func listQueries(studyKey: String, page: Int? = nil, size: Int? = nil, sort: String? = nil, filter: String? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: QueryList?, _ error: Error?) -> Void)) -> RequestTask {
        return listQueriesWithRequestBuilder(studyKey: studyKey, page: page, size: size, sort: sort, filter: filter).execute(apiResponseQueue) { result in
            switch result {
     ...
     */
    open class func listQueriesWithRequestBuilder(studyKey: String, page: Int? = nil, size: Int? = nil, sort: String? = nil, filter: String? = nil) -> RequestBuilder<QueryList> {
        ...
        let localVariableRequestBuilder: RequestBuilder<QueryList>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
