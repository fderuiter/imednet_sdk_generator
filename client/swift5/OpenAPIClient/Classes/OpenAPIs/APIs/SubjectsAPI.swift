...
open class SubjectsAPI {
     ...
     */
    @discardableResult
    open class func listSubjects(studyKey: String, page: Int? = nil, size: Int? = nil, sort: String? = nil, filter: String? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: SubjectList?, _ error: Error?) -> Void)) -> RequestTask {
        return listSubjectsWithRequestBuilder(studyKey: studyKey, page: page, size: size, sort: sort, filter: filter).execute(apiResponseQueue) { result in
            switch result {
     ...
     */
    open class func listSubjectsWithRequestBuilder(studyKey: String, page: Int? = nil, size: Int? = nil, sort: String? = nil, filter: String? = nil) -> RequestBuilder<SubjectList> {
        var localVariablePath = "/studies/{studyKey}/subjects"
        ...
        let localVariableRequestBuilder: RequestBuilder<SubjectList>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
