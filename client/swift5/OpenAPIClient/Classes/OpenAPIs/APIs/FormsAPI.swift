...
open class FormsAPI {
     ...
     */
    @discardableResult
    open class func listForms(studyKey: String, page: Int? = nil, size: Int? = nil, sort: String? = nil, filter: String? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: FormList?, _ error: Error?) -> Void)) -> RequestTask {
        return listFormsWithRequestBuilder(studyKey: studyKey, page: page, size: size, sort: sort, filter: filter).execute(apiResponseQueue) { result in
            switch result {
     ...
     */
    open class func listFormsWithRequestBuilder(studyKey: String, page: Int? = nil, size: Int? = nil, sort: String? = nil, filter: String? = nil) -> RequestBuilder<FormList> {
        ...
        let localVariableRequestBuilder: RequestBuilder<FormList>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
