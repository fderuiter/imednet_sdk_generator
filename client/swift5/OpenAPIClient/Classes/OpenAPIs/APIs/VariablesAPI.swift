...
open class VariablesAPI {
     ...
     */
    @discardableResult
    open class func listVariables(studyKey: String, page: Int? = nil, size: Int? = nil, sort: String? = nil, filter: String? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: VariableList?, _ error: Error?) -> Void)) -> RequestTask {
        return listVariablesWithRequestBuilder(studyKey: studyKey, page: page, size: size, sort: sort, filter: filter).execute(apiResponseQueue) { result in
            switch result {
     ...
     */
    open class func listVariablesWithRequestBuilder(studyKey: String, page: Int? = nil, size: Int? = nil, sort: String? = nil, filter: String? = nil) -> RequestBuilder<VariableList> {
        ...
        let localVariableRequestBuilder: RequestBuilder<VariableList>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
