...
public class CodingsApiTest {
    ...
    private static CodingsApi client;
     ...
     */
    @Test
    public void listCodingsTest() throws Exception {
        //CodingList response = client.listCodings(studyKey, page, size, sort, filter);
