...
public class RecordRevisionsApiTest {
    ...
    private static RecordRevisionsApi client;
    ...
    public static void setup() throws MalformedURLException {
        client = RestClientBuilder.newBuilder()
                        ...
                        .build(RecordRevisionsApi.class);
    }
     ...
     */
    @Test
    public void listRecordRevisionsTest() throws Exception {
        //RecordRevisionList response = client.listRecordRevisions(studyKey, page, size, sort, filter);
