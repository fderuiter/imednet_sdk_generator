...
public class IntervalsApiTest {
    ...
    private static IntervalsApi client;
     ...
     */
    @Test
    public void listIntervalsTest() throws Exception {
        //IntervalList response = client.listIntervals(studyKey, page, size, sort, filter);
