...
public class VariablesApiTest {
    ...
    private static VariablesApi client;
     ...
     */
    @Test
    public void listVariablesTest() throws Exception {
        //VariableList response = client.listVariables(studyKey, page, size, sort, filter);
