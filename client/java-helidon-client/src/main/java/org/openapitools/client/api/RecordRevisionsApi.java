...
public interface RecordRevisionsApi  {
    ...
    RecordRevisionList listRecordRevisions(@PathParam("studyKey") String studyKey, @QueryParam("page") @DefaultValue("0") Integer page, @QueryParam("size") @DefaultValue("25") Integer size, @QueryParam("sort") String sort, @QueryParam("filter") String filter) throws ApiException, ProcessingException;
}
