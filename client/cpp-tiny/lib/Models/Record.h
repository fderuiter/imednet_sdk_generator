...
#ifndef TINY_CPP_CLIENT_Record_H_
#define TINY_CPP_CLIENT_Record_H_
...
public:
	 ...
	 */
	Map<std::string, std::string> getRecordData();
	 ...
	 */
	void setRecordData(Map <std::string, std::string> recordData);
    ...
    Map<std::string, std::string> recordData;
};
}

#endif /* TINY_CPP_CLIENT_Record_H_ */
