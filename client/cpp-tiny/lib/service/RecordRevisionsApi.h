#ifndef TINY_CPP_CLIENT_RecordRevisionsApi_H_
#define TINY_CPP_CLIENT_RecordRevisionsApi_H_
...
class RecordRevisionsApi : public Service {
public:
    RecordRevisionsApi() = default;

    virtual ~RecordRevisionsApi() = default;
...
#endif /* TINY_CPP_CLIENT_RecordRevisionsApi_H_ */