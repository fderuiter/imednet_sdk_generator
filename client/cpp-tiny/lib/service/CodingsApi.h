#ifndef TINY_CPP_CLIENT_CodingsApi_H_
#define TINY_CPP_CLIENT_CodingsApi_H_
...
class CodingsApi : public Service {
public:
    CodingsApi() = default;

    virtual ~CodingsApi() = default;
...
#endif /* TINY_CPP_CLIENT_CodingsApi_H_ */