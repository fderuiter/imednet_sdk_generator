#ifndef TINY_CPP_CLIENT_QueriesApi_H_
#define TINY_CPP_CLIENT_QueriesApi_H_
...
class QueriesApi : public Service {
public:
    QueriesApi() = default;

    virtual ~QueriesApi() = default;
...
#endif /* TINY_CPP_CLIENT_QueriesApi_H_ */