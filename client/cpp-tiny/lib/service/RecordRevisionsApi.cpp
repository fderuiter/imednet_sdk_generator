...
using namespace Tiny;
        ...
        {
            std::string url = basepath + "/studies/{studyKey}/recordRevisions"; //studyKey 
            ...
            RecordRevisionList obj(output_string);


            Response<RecordRevisionList> response(obj, httpCode);
            return response;
        }
