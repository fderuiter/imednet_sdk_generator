...
#ifndef OAIIntervalList_H
#define OAIIntervalList_H
...
class OAIIntervalList : public OAIObject {
public:
    OAIIntervalList();
    OAIIntervalList(QString json);
    ~OAIIntervalList() override;
    ...
    QList<OAIInterval> getData() const;
    void setData(const QList<OAIInterval> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIIntervalList)

#endif // OAIIntervalList_H
