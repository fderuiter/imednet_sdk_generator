...
FString OpenAPIQueriesApi::ListQueriesRequest::ComputePath() const
{
	TMap<FString, FStringFormatArg> PathParams = { 
	{ TEXT("studyKey"), FStringFormatArg(ToUrlString(StudyKey)) } };

	FString Path = FString::Format(TEXT("/studies/{studyKey}/queries"), PathParams);
...
void OpenAPIQueriesApi::ListQueriesRequest::SetupHttpRequest(const FHttpRequestRef& HttpRequest) const
{
...
void OpenAPIQueriesApi::ListQueriesResponse::SetHttpResponseCode(EHttpResponseCodes::Type InHttpResponseCode)
{
	Response::SetHttpResponseCode(InHttpResponseCode);
	switch ((int)InHttpResponseCode)
	{
	case 200:
		SetResponseString(TEXT("Successful response with list of queries"));
		break;
	case 400:
...
bool OpenAPIQueriesApi::ListQueriesResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
