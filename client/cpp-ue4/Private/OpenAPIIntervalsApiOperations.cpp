...
FString OpenAPIIntervalsApi::ListIntervalsRequest::ComputePath() const
{
	TMap<FString, FStringFormatArg> PathParams = { 
	{ TEXT("studyKey"), FStringFormatArg(ToUrlString(StudyKey)) } };

	FString Path = FString::Format(TEXT("/studies/{studyKey}/intervals"), PathParams);
...
void OpenAPIIntervalsApi::ListIntervalsRequest::SetupHttpRequest(const FHttpRequestRef& HttpRequest) const
{
...
void OpenAPIIntervalsApi::ListIntervalsResponse::SetHttpResponseCode(EHttpResponseCodes::Type InHttpResponseCode)
{
	Response::SetHttpResponseCode(InHttpResponseCode);
	switch ((int)InHttpResponseCode)
	{
	case 200:
		SetResponseString(TEXT("Successful response with list of intervals"));
		break;
	case 400:
...
bool OpenAPIIntervalsApi::ListIntervalsResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
