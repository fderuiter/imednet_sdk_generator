...
FString OpenAPIStudiesApi::ListStudiesRequest::ComputePath() const
{
	FString Path(TEXT("/studies"));
...
void OpenAPIStudiesApi::ListStudiesRequest::SetupHttpRequest(const FHttpRequestRef& HttpRequest) const
{
...
void OpenAPIStudiesApi::ListStudiesResponse::SetHttpResponseCode(EHttpResponseCodes::Type InHttpResponseCode)
{
	Response::SetHttpResponseCode(InHttpResponseCode);
	switch ((int)InHttpResponseCode)
	{
	case 200:
		SetResponseString(TEXT("Successful response with list of studies"));
		break;
	case 400:
...
bool OpenAPIStudiesApi::ListStudiesResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
