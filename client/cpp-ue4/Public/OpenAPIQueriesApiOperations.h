...
*/
class OPENAPI_API OpenAPIQueriesApi::ListQueriesRequest : public Request
{
public:
    virtual ~ListQueriesRequest() {}
...
class OPENAPI_API OpenAPIQueriesApi::ListQueriesResponse : public Response
{
public:
    virtual ~ListQueriesResponse() {}
	void SetHttpResponseCode(EHttpResponseCodes::Type InHttpResponseCode) final;
	bool FromJson(const TSharedPtr<FJsonValue>& JsonValue) final;

    OpenAPIQueryList Content;
};
