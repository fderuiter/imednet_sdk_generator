...
*/
class OPENAPI_API OpenAPISubjectsApi::ListSubjectsRequest : public Request
{
public:
    virtual ~ListSubjectsRequest() {}
...
class OPENAPI_API OpenAPISubjectsApi::ListSubjectsResponse : public Response
{
public:
    virtual ~ListSubjectsResponse() {}
	void SetHttpResponseCode(EHttpResponseCodes::Type InHttpResponseCode) final;
	bool FromJson(const TSharedPtr<FJsonValue>& JsonValue) final;

    OpenAPISubjectList Content;
};
