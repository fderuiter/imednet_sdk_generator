...
public class RecordRevisionsApiTest {
    ...
    private final RecordRevisionsApi api = new RecordRevisionsApi();
     ...
     */
    @Test
    public void listRecordRevisionsTest() throws ApiException {
        String studyKey = null;
        Integer page = null;
        Integer size = null;
        String sort = null;
        String filter = null;
        RecordRevisionList response = api.listRecordRevisions(studyKey, page, size, sort, filter);
