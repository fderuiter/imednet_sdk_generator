...
public class CodingsApiTest {
    ...
    private final CodingsApi api = new CodingsApi();
     ...
     */
    @Test
    public void listCodingsTest() throws ApiException {
        String studyKey = null;
        Integer page = null;
        Integer size = null;
        String sort = null;
        String filter = null;
        CodingList response = api.listCodings(studyKey, page, size, sort, filter);
