...
public class ApiClient {
    ...
    protected String basePath = "https://edc.prod.imednetapi.com/api/v1/edc";
    ...
    public ApiClient() {
        ...
        authentications.put("securityKeyAuth", new ApiKeyAuth("header", "x-imn-security-key"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://edc.prod.imednetapi.com/api/v1/edc
