...
import org.openapitools.client.apis.IntervalsApi
...
class IntervalsApiTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of IntervalsApi
        //val apiInstance = IntervalsApi()

        // to test listIntervals
        should("test listIntervals") {
            // uncomment below to test listIntervals
