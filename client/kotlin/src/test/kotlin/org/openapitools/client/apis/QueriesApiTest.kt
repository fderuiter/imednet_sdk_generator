...
import org.openapitools.client.apis.QueriesApi
...
class QueriesApiTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of QueriesApi
        //val apiInstance = QueriesApi()

        // to test listQueries
        should("test listQueries") {
            // uncomment below to test listQueries
