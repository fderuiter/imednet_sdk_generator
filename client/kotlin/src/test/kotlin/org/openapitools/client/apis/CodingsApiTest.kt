...
import org.openapitools.client.apis.CodingsApi
...
class CodingsApiTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of CodingsApi
        //val apiInstance = CodingsApi()

        // to test listCodings
        should("test listCodings") {
            // uncomment below to test listCodings
