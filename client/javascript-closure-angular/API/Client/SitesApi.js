/**
 * @fileoverview AUTOMATICALLY GENERATED service for API.Client.SitesApi.
 ...
 */
goog.provide('API.Client.SitesApi');

goog.require('API.Client.SiteList');
 ...
 * @struct
 */
API.Client.SitesApi = function($http, $httpParamSerializer, $injector) {
  /** @private {!string} */
  this.basePath_ = $injector.has('SitesApiBasePath') ?
                   /** @type {!string} */ ($injector.get('SitesApiBasePath')) :
                   'https://edc.prod.imednetapi.com/api/v1/edc';

  /** @private {!Object<string, string>} */
  this.defaultHeaders_ = $injector.has('SitesApiDefaultHeaders') ?
                   /** @type {!Object<string, string>} */ (
                       $injector.get('SitesApiDefaultHeaders')) :
                   {};
...
API.Client.SitesApi.$inject = ['$http', '$httpParamSerializer', '$injector'];
 ...
 * @return {!angular.$q.Promise<!API.Client.SiteList>}
 */
API.Client.SitesApi.prototype.listSites = function(studyKey, opt_page, opt_size, opt_sort, opt_filter, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/studies/{studyKey}/sites'
  ...
  if (!studyKey) {
    throw new Error('Missing required parameter studyKey when calling listSites');
  }
