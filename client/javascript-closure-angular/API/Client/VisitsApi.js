/**
 * @fileoverview AUTOMATICALLY GENERATED service for API.Client.VisitsApi.
 ...
 */
goog.provide('API.Client.VisitsApi');

goog.require('API.Client.VisitList');
 ...
 * @struct
 */
API.Client.VisitsApi = function($http, $httpParamSerializer, $injector) {
  /** @private {!string} */
  this.basePath_ = $injector.has('VisitsApiBasePath') ?
                   /** @type {!string} */ ($injector.get('VisitsApiBasePath')) :
                   'https://edc.prod.imednetapi.com/api/v1/edc';

  /** @private {!Object<string, string>} */
  this.defaultHeaders_ = $injector.has('VisitsApiDefaultHeaders') ?
                   /** @type {!Object<string, string>} */ (
                       $injector.get('VisitsApiDefaultHeaders')) :
                   {};
...
API.Client.VisitsApi.$inject = ['$http', '$httpParamSerializer', '$injector'];
 ...
 * @return {!angular.$q.Promise<!API.Client.VisitList>}
 */
API.Client.VisitsApi.prototype.listVisits = function(studyKey, opt_page, opt_size, opt_sort, opt_filter, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/studies/{studyKey}/visits'
  ...
  if (!studyKey) {
    throw new Error('Missing required parameter studyKey when calling listVisits');
  }
