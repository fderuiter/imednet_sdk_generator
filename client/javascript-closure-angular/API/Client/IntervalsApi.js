/**
 * @fileoverview AUTOMATICALLY GENERATED service for API.Client.IntervalsApi.
 ...
 */
goog.provide('API.Client.IntervalsApi');

goog.require('API.Client.IntervalList');
 ...
 * @struct
 */
API.Client.IntervalsApi = function($http, $httpParamSerializer, $injector) {
  /** @private {!string} */
  this.basePath_ = $injector.has('IntervalsApiBasePath') ?
                   /** @type {!string} */ ($injector.get('IntervalsApiBasePath')) :
                   'https://edc.prod.imednetapi.com/api/v1/edc';

  /** @private {!Object<string, string>} */
  this.defaultHeaders_ = $injector.has('IntervalsApiDefaultHeaders') ?
                   /** @type {!Object<string, string>} */ (
                       $injector.get('IntervalsApiDefaultHeaders')) :
                   {};
...
API.Client.IntervalsApi.$inject = ['$http', '$httpParamSerializer', '$injector'];
 ...
 * @return {!angular.$q.Promise<!API.Client.IntervalList>}
 */
API.Client.IntervalsApi.prototype.listIntervals = function(studyKey, opt_page, opt_size, opt_sort, opt_filter, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/studies/{studyKey}/intervals'
  ...
  if (!studyKey) {
    throw new Error('Missing required parameter studyKey when calling listIntervals');
  }
