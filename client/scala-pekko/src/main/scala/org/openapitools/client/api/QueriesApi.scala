...
object QueriesApi {
  ...
  def apply(baseUrl: String = "https://edc.prod.imednetapi.com/api/v1/edc") = new QueriesApi(baseUrl)
}

class QueriesApi(baseUrl: String) {

  /**
   * Expected answers:
   *   code 200 : QueryList (Successful response with list of queries)
   ...
   */
  def listQueries(studyKey: String, page: Option[Int] = None, size: Option[Int] = None, sort: Option[String] = None, filter: Option[String] = None)(implicit apiKey: ApiKeyValue, apiKey: ApiKeyValue): ApiRequest[QueryList] =
    ApiRequest[QueryList](ApiMethods.GET, baseUrl, "/studies/{studyKey}/queries", "application/json")
      ...
      .withSuccessResponse[QueryList](200)
