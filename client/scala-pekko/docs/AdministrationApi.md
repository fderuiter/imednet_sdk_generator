...
[**listUsersWithHttpInfo**](AdministrationApi.md#listUsersWithHttpInfo) | **GET** /studies/{studyKey}/users | List users and their roles in a study



## listUsers

> listUsers(listUsersRequest): ApiRequest[UserList]
 ...
 **includeInactive** | **Boolean**| For user listing, whether to include inactive users | [optional]

### Return type

ApiRequest[[**UserList**](UserList.md)]
