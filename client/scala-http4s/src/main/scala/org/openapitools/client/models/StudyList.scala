...
case class StudyList(
    ...
    data: Option[Seq[Study]] = None
)
  
object StudyList {
  given encoderStudyList: Encoder[StudyList] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
