...
case class FormList(
    ...
    data: Option[Seq[Form]] = None
)
  
object FormList {
  given encoderFormList: Encoder[FormList] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
