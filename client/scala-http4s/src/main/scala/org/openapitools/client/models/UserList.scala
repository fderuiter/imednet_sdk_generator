...
case class UserList(
    ...
    data: Option[Seq[User]] = None
)
  
object UserList {
  given encoderUserList: Encoder[UserList] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
