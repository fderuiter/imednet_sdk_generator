...
export class StudiesApi extends runtime.BaseAPI {
     ...
     */
    async listStudiesRaw(requestParameters: ListStudiesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<StudyList>> {
     ...
     * List studies accessible by API key
     */
    async listStudies(requestParameters: ListStudiesRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<StudyList> {
