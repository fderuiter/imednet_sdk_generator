...
class SitesApi {
    ...
    def listSites ( String studyKey, Integer page, Integer size, String sort, String filter, Closure onSuccess, Closure onFailure)  {
        String resourcePath = "/studies/${studyKey}/sites"
