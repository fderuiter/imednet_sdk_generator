...
export enum SubjectsApiApiKeys {
    apiKeyAuth,
    securityKeyAuth,
}
...
export class SubjectsApi {
    ...
    public setApiKey(key: SubjectsApiApiKeys, value: string) {
        (this.authentications as any)[SubjectsApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async listSubjects (studyKey: string, page?: number, size?: number, sort?: string, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SubjectList;  }> {
        const localVarPath = this.basePath + '/studies/{studyKey}/subjects'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: SubjectList;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "SubjectList");
