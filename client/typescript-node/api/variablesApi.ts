...
export class VariablesApi {
     ...
     */
    public async listVariables (studyKey: string, page?: number, size?: number, sort?: string, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: VariableList;  }> {
        const localVarPath = this.basePath + '/studies/{studyKey}/variables'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: VariableList;  }>((resolve, reject) => {
