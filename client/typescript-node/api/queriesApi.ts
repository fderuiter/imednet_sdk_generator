...
export class QueriesApi {
     ...
     */
    public async listQueries (studyKey: string, page?: number, size?: number, sort?: string, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: QueryList;  }> {
        const localVarPath = this.basePath + '/studies/{studyKey}/queries'
