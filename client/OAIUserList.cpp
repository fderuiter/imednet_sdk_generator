...
OAIMetadata OAIUserList::getMetadata() const {
    return m_metadata;
}
void OAIUserList::setMetadata(const OAIMetadata &metadata) {
    m_metadata = metadata;
    m_metadata_isSet = true;
}

bool OAIUserList::is_metadata_Set() const{
    return m_metadata_isSet;
}

bool OAIUserList::is_metadata_Valid() const{
    return m_metadata_isValid;
}

OAIPagination OAIUserList::getPagination() const {
    return m_pagination;
}
void OAIUserList::setPagination(const OAIPagination &pagination) {
    m_pagination = pagination;
    m_pagination_isSet = true;
}

bool OAIUserList::is_pagination_Set() const{
    return m_pagination_isSet;
}

bool OAIUserList::is_pagination_Valid() const{
    return m_pagination_isValid;
}

QList<OAIUser> OAIUserList::getData() const {
    return m_data;
}
void OAIUserList::setData(const QList<OAIUser> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIUserList::is_data_Set() const{
    return m_data_isSet;
}

bool OAIUserList::is_data_Valid() const{
