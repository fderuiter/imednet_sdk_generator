...
```typescript
import { createConfiguration, FormsApi } from '';
import type { FormsApiListFormsRequest } from '';

const configuration = createConfiguration();
const apiInstance = new FormsApi(configuration);

const request: FormsApiListFormsRequest = {
...
const data = await apiInstance.listForms(request);
