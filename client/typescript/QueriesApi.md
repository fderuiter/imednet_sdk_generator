...
```typescript
import { createConfiguration, QueriesApi } from '';
import type { QueriesApiListQueriesRequest } from '';

const configuration = createConfiguration();
const apiInstance = new QueriesApi(configuration);

const request: QueriesApiListQueriesRequest = {
...
const data = await apiInstance.listQueries(request);
