...
export class JobsApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async getJobStatus(studyKey: string, batchId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'studyKey' is not null or undefined
        if (studyKey === null || studyKey === undefined) {
            throw new RequiredError("JobsApi", "getJobStatus", "studyKey");
        }


        // verify required parameter 'batchId' is not null or undefined
        if (batchId === null || batchId === undefined) {
            throw new RequiredError("JobsApi", "getJobStatus", "batchId");
        }
...
export class JobsApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to getJobStatus
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getJobStatusWithHttpInfo(response: ResponseContext): Promise<HttpInfo<Job >> {
