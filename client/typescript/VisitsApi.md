...
```typescript
import { createConfiguration, VisitsApi } from '';
import type { VisitsApiListVisitsRequest } from '';

const configuration = createConfiguration();
const apiInstance = new VisitsApi(configuration);

const request: VisitsApiListVisitsRequest = {
...
const data = await apiInstance.listVisits(request);
