...
|------------- | ------------- | -------------|
|[**listIntervals**](#listintervals) | **GET** /studies/{studyKey}/intervals | List intervals (visit definitions) in a study|
...
const { status, data } = await apiInstance.listIntervals(
    studyKey,
    page,
    size,
    sort,
