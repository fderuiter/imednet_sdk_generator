...
#
package WWW::OpenAPIClient::IntervalsApi;
...
# @param string $filter Optional filter criteria to apply, in the format &#x60;attribute&#x3D;&#x3D;value&#x60; with support for &gt;, &gt;&#x3D;, &lt;, &lt;&#x3D;, !&#x3D;. Multiple criteria can be combined with &#x60;;&#x60; (AND) or &#x60;,&#x60; (OR). (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'list_intervals' } = {
...
sub list_intervals {
    ...
    unless (exists $args{'study_key'}) {
      croak("Missing the required parameter 'study_key' when calling list_intervals");
    }

    # parse inputs
    my $_resource_path = '/studies/{studyKey}/intervals';
    ...
    my $_response_object = $self->{api_client}->deserialize('IntervalList', $response);
