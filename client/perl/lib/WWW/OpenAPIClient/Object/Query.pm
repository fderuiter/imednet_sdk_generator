...
#
package WWW::OpenAPIClient::Object::Query;
...
__PACKAGE__->method_documentation({
    ...
    'type' => {
        datatype => 'string',
        base_name => 'type',
        description => 'System text identifier for the query type/location (subject, record, question)',
        format => '',
        read_only => '',
            },
    'description' => {
    ...
    'query_comments' => {
        datatype => 'ARRAY[QueryComment]',
        base_name => 'queryComments',
