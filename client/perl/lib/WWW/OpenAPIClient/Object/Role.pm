...
#
package WWW::OpenAPIClient::Object::Role;
...
__PACKAGE__->method_documentation({
    'date_created' => {
        ...
        description => 'Timestamp when the role assignment was created (as [year, month, day, hour, minute, second, nanosecond])',
        format => '',
        read_only => '',
            },
    'date_modified' => {
...
__PACKAGE__->openapi_types( {
    'date_created' => 'ARRAY[int]',
    'date_modified' => 'ARRAY[int]',
    'role_id' => 'string',
    'community_id' => 'int',
    'name' => 'string',
    'description' => 'string',
