...
class StudiesApi(baseUrl: String) {
   ...
   */
  def listStudies(apiKey: String, apiKey: String)(page: Option[Int] = None, size: Option[Int] = None, sort: Option[String] = None, filter: Option[String] = None): Request[Either[ResponseException[String, Exception], StudyList]] =
    basicRequest
