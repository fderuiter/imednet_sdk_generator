# openapi_client.RecordRevisionsApi
...
> RecordRevisionList list_record_revisions(study_key, page=page, size=size, sort=sort, filter=filter)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.RecordRevisionsApi(api_client)
    ...
    try:
        # List record revisions (audit trail entries) in a study
        api_response = api_instance.list_record_revisions(study_key, page=page, size=size, sort=sort, filter=filter)
        print("The response of RecordRevisionsApi->list_record_revisions:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RecordRevisionsApi->list_record_revisions: %s\n" % e)
```
