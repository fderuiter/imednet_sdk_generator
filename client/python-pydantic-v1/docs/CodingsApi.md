...
# **list_codings**
> CodingList list_codings(study_key, page=page, size=size, sort=sort, filter=filter)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.CodingsApi(api_client)
    ...
    try:
        # List coding activities in a study
        api_response = api_instance.list_codings(study_key, page=page, size=size, sort=sort, filter=filter)
        print("The response of CodingsApi->list_codings:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CodingsApi->list_codings: %s\n" % e)
```
