...
class SiteList(BaseModel):
    ...
    data: Optional[conlist(Site)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SiteList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SiteList:
        """Create an instance of SiteList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SiteList.parse_obj(obj)

        _obj = SiteList.parse_obj({
            ...
            "data": [Site.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
