...
class IntervalList(BaseModel):
    ...
    data: Optional[conlist(Interval)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IntervalList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IntervalList:
        """Create an instance of IntervalList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IntervalList.parse_obj(obj)

        _obj = IntervalList.parse_obj({
            ...
            "data": [Interval.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
