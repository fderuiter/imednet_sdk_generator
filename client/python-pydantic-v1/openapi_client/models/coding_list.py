...
class CodingList(BaseModel):
    """
    CodingList
    """
    metadata: Optional[Metadata] = None
    pagination: Optional[Pagination] = None
    data: Optional[conlist(Coding)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CodingList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CodingList:
        """Create an instance of CodingList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CodingList.parse_obj(obj)

        _obj = CodingList.parse_obj({
            ...
            "data": [Coding.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
