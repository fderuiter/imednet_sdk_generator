...
class QueryList(BaseModel):
    ...
    data: Optional[conlist(Query)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QueryList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> QueryList:
        """Create an instance of QueryList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return QueryList.parse_obj(obj)

        _obj = QueryList.parse_obj({
            ...
            "data": [Query.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
