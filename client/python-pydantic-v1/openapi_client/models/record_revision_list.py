...
class RecordRevisionList(BaseModel):
    """
    RecordRevisionList
    """
    metadata: Optional[Metadata] = None
    pagination: Optional[Pagination] = None
    data: Optional[conlist(RecordRevision)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RecordRevisionList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RecordRevisionList:
        """Create an instance of RecordRevisionList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RecordRevisionList.parse_obj(obj)

        _obj = RecordRevisionList.parse_obj({
            ...
            "data": [RecordRevision.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
