...
[**listCodingsWithHttpInfo**](CodingsApi.md#listCodingsWithHttpInfo) | **GET** /studies/{studyKey}/codings | List coding activities in a study



## listCodings

> listCodings(listCodingsRequest): ApiRequest[CodingList]
...
object Example extends App {
    ...
    val apiInstance = CodingsApi("https://edc.prod.imednetapi.com/api/v1/edc")
    ...
    val request = apiInstance.listCodings(studyKey, page, size, sort, filter)
...
ApiRequest[[**CodingList**](CodingList.md)]
