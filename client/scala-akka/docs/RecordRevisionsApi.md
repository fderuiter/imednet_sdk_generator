...
[**listRecordRevisionsWithHttpInfo**](RecordRevisionsApi.md#listRecordRevisionsWithHttpInfo) | **GET** /studies/{studyKey}/recordRevisions | List record revisions (audit trail entries) in a study



## listRecordRevisions

> listRecordRevisions(listRecordRevisionsRequest): ApiRequest[RecordRevisionList]
...
object Example extends App {
    ...
    val apiInstance = RecordRevisionsApi("https://edc.prod.imednetapi.com/api/v1/edc")
    ...
    val request = apiInstance.listRecordRevisions(studyKey, page, size, sort, filter)
...
ApiRequest[[**RecordRevisionList**](RecordRevisionList.md)]
