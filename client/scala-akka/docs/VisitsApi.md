...
[**listVisitsWithHttpInfo**](VisitsApi.md#listVisitsWithHttpInfo) | **GET** /studies/{studyKey}/visits | List visits (subject visit instances) in a study



## listVisits

> listVisits(listVisitsRequest): ApiRequest[VisitList]
...
object Example extends App {
    ...
    val apiInstance = VisitsApi("https://edc.prod.imednetapi.com/api/v1/edc")
    ...
    val request = apiInstance.listVisits(studyKey, page, size, sort, filter)
...
ApiRequest[[**VisitList**](VisitList.md)]
