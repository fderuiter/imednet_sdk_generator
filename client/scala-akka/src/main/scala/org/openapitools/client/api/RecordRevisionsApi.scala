...
class RecordRevisionsApi(baseUrl: String) {
   ...
   */
  def listRecordRevisions(studyKey: String, page: Option[Int] = None, size: Option[Int] = None, sort: Option[String] = None, filter: Option[String] = None)(implicit apiKey: ApiKeyValue, apiKey: ApiKeyValue): ApiRequest[RecordRevisionList] =
    ApiRequest[RecordRevisionList](ApiMethods.GET, baseUrl, "/studies/{studyKey}/recordRevisions", "application/json")
      ...
      .withSuccessResponse[RecordRevisionList](200)
