...
object FormsApi {
  ...
  def apply(baseUrl: String = "https://edc.prod.imednetapi.com/api/v1/edc") = new FormsApi(baseUrl)
}

class FormsApi(baseUrl: String) {

  /**
   * Expected answers:
   *   code 200 : FormList (Successful response with list of forms)
   ...
   */
  def listForms(studyKey: String, page: Option[Int] = None, size: Option[Int] = None, sort: Option[String] = None, filter: Option[String] = None)(implicit apiKey: ApiKeyValue, apiKey: ApiKeyValue): ApiRequest[FormList] =
    ApiRequest[FormList](ApiMethods.GET, baseUrl, "/studies/{studyKey}/forms", "application/json")
      ...
      .withSuccessResponse[FormList](200)
