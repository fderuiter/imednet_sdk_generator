...
class RecordsApi(baseUrl: String) {
   ...
   */
  def createRecords(studyKey: String, componentsSchemasRecordCreateRequestItem: Seq[ComponentsSchemasRecordCreateRequestItem])(implicit apiKey: ApiKeyValue, apiKey: ApiKeyValue): ApiRequest[RecordJobStatus] =
    ApiRequest[RecordJobStatus](ApiMethods.POST, baseUrl, "/studies/{studyKey}/records", "application/json")
      .withApiKey(apiKey, "x-api-key", HEADER)
      .withApiKey(apiKey, "x-imn-security-key", HEADER)
      .withBody(componentsSchemasRecordCreateRequestItem)
      .withPathParam("studyKey", studyKey)
      .withSuccessResponse[RecordJobStatus](202)
      ...
      .withErrorResponse[InlineObject4](429)
   ...
   */
  def listRecords(studyKey: String, page: Option[Int] = None, size: Option[Int] = None, sort: Option[String] = None, filter: Option[String] = None, recordDataFilter: Option[String] = None)(implicit apiKey: ApiKeyValue, apiKey: ApiKeyValue): ApiRequest[RecordList] =
    ApiRequest[RecordList](ApiMethods.GET, baseUrl, "/studies/{studyKey}/records", "application/json")
      .withApiKey(apiKey, "x-api-key", HEADER)
      .withApiKey(apiKey, "x-imn-security-key", HEADER)
      ...
      .withQueryParam("recordDataFilter", recordDataFilter)
      .withPathParam("studyKey", studyKey)
      .withSuccessResponse[RecordList](200)
      .withErrorResponse[InlineObject](400)
      .withErrorResponse[InlineObject1](401)
      .withErrorResponse[InlineObject2](403)
      .withErrorResponse[InlineObject3](404)
