...
object SitesApi {
  ...
  def apply(baseUrl: String = "https://edc.prod.imednetapi.com/api/v1/edc") = new SitesApi(baseUrl)
}

class SitesApi(baseUrl: String) {

  /**
   * Expected answers:
   *   code 200 : SiteList (Successful response with list of sites)
   ...
   */
  def listSites(studyKey: String, page: Option[Int] = None, size: Option[Int] = None, sort: Option[String] = None, filter: Option[String] = None)(implicit apiKey: ApiKeyValue, apiKey: ApiKeyValue): ApiRequest[SiteList] =
    ApiRequest[SiteList](ApiMethods.GET, baseUrl, "/studies/{studyKey}/sites", "application/json")
      ...
      .withSuccessResponse[SiteList](200)
