...
#include "CppRestOpenAPIClient/model/QueryList.h"
...
void QueryList::validate()
{
    // TODO: implement validation
}

web::json::value QueryList::toJson() const
{
...
bool QueryList::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<Query>> refVal_setData;
...
void QueryList::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool QueryList::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<Metadata> QueryList::getMetadata() const
{
    return m_Metadata;
}


void QueryList::setMetadata(const std::shared_ptr<Metadata>& value)
{
    m_Metadata = value;
    m_MetadataIsSet = true;
}

bool QueryList::metadataIsSet() const
{
    return m_MetadataIsSet;
}

void QueryList::unsetMetadata()
{
    m_MetadataIsSet = false;
}
std::shared_ptr<Pagination> QueryList::getPagination() const
{
    return m_Pagination;
}


void QueryList::setPagination(const std::shared_ptr<Pagination>& value)
{
    m_Pagination = value;
    m_PaginationIsSet = true;
}

bool QueryList::paginationIsSet() const
{
    return m_PaginationIsSet;
}

void QueryList::unsetPagination()
{
    m_PaginationIsSet = false;
}
std::vector<std::shared_ptr<Query>> QueryList::getData() const
{
    return m_Data;
}


void QueryList::setData(const std::vector<std::shared_ptr<Query>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool QueryList::dataIsSet() const
{
    return m_DataIsSet;
}

void QueryList::unsetData()
{
    m_DataIsSet = false;
}
