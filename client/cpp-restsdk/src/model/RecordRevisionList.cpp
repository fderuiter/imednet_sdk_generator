...
#include "CppRestOpenAPIClient/model/RecordRevisionList.h"
...
void RecordRevisionList::validate()
{
    // TODO: implement validation
}

web::json::value RecordRevisionList::toJson() const
{
...
bool RecordRevisionList::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<RecordRevision>> refVal_setData;
...
void RecordRevisionList::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool RecordRevisionList::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<Metadata> RecordRevisionList::getMetadata() const
{
    return m_Metadata;
}


void RecordRevisionList::setMetadata(const std::shared_ptr<Metadata>& value)
{
    m_Metadata = value;
    m_MetadataIsSet = true;
}

bool RecordRevisionList::metadataIsSet() const
{
    return m_MetadataIsSet;
}

void RecordRevisionList::unsetMetadata()
{
    m_MetadataIsSet = false;
}
std::shared_ptr<Pagination> RecordRevisionList::getPagination() const
{
    return m_Pagination;
}


void RecordRevisionList::setPagination(const std::shared_ptr<Pagination>& value)
{
    m_Pagination = value;
    m_PaginationIsSet = true;
}

bool RecordRevisionList::paginationIsSet() const
{
    return m_PaginationIsSet;
}

void RecordRevisionList::unsetPagination()
{
    m_PaginationIsSet = false;
}
std::vector<std::shared_ptr<RecordRevision>> RecordRevisionList::getData() const
{
    return m_Data;
}


void RecordRevisionList::setData(const std::vector<std::shared_ptr<RecordRevision>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool RecordRevisionList::dataIsSet() const
{
    return m_DataIsSet;
}

void RecordRevisionList::unsetData()
{
    m_DataIsSet = false;
}
