...
#include "CppRestOpenAPIClient/model/VisitList.h"
...
void VisitList::validate()
{
    // TODO: implement validation
}

web::json::value VisitList::toJson() const
{
...
bool VisitList::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<Visit>> refVal_setData;
...
void VisitList::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool VisitList::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<Metadata> VisitList::getMetadata() const
{
    return m_Metadata;
}


void VisitList::setMetadata(const std::shared_ptr<Metadata>& value)
{
    m_Metadata = value;
    m_MetadataIsSet = true;
}

bool VisitList::metadataIsSet() const
{
    return m_MetadataIsSet;
}

void VisitList::unsetMetadata()
{
    m_MetadataIsSet = false;
}
std::shared_ptr<Pagination> VisitList::getPagination() const
{
    return m_Pagination;
}


void VisitList::setPagination(const std::shared_ptr<Pagination>& value)
{
    m_Pagination = value;
    m_PaginationIsSet = true;
}

bool VisitList::paginationIsSet() const
{
    return m_PaginationIsSet;
}

void VisitList::unsetPagination()
{
    m_PaginationIsSet = false;
}
std::vector<std::shared_ptr<Visit>> VisitList::getData() const
{
    return m_Data;
}


void VisitList::setData(const std::vector<std::shared_ptr<Visit>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool VisitList::dataIsSet() const
{
    return m_DataIsSet;
}

void VisitList::unsetData()
{
    m_DataIsSet = false;
}
