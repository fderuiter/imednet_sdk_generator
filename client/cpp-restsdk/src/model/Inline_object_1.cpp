...
std::shared_ptr<Metadata> Inline_object_1::getMetadata() const
{
    return m_Metadata;
}


void Inline_object_1::setMetadata(const std::shared_ptr<Metadata>& value)
{
    m_Metadata = value;
    m_MetadataIsSet = true;
}

bool Inline_object_1::metadataIsSet() const
{
    return m_MetadataIsSet;
}

void Inline_object_1::unsetMetadata()
{
    m_MetadataIsSet = false;
}
