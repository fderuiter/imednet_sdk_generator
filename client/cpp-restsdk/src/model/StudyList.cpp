...
#include "CppRestOpenAPIClient/model/StudyList.h"
...
void StudyList::validate()
{
    // TODO: implement validation
}

web::json::value StudyList::toJson() const
{
...
bool StudyList::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<Study>> refVal_setData;
...
void StudyList::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool StudyList::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<Metadata> StudyList::getMetadata() const
{
    return m_Metadata;
}


void StudyList::setMetadata(const std::shared_ptr<Metadata>& value)
{
    m_Metadata = value;
    m_MetadataIsSet = true;
}

bool StudyList::metadataIsSet() const
{
    return m_MetadataIsSet;
}

void StudyList::unsetMetadata()
{
    m_MetadataIsSet = false;
}
std::shared_ptr<Pagination> StudyList::getPagination() const
{
    return m_Pagination;
}


void StudyList::setPagination(const std::shared_ptr<Pagination>& value)
{
    m_Pagination = value;
    m_PaginationIsSet = true;
}

bool StudyList::paginationIsSet() const
{
    return m_PaginationIsSet;
}

void StudyList::unsetPagination()
{
    m_PaginationIsSet = false;
}
std::vector<std::shared_ptr<Study>> StudyList::getData() const
{
    return m_Data;
}


void StudyList::setData(const std::vector<std::shared_ptr<Study>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool StudyList::dataIsSet() const
{
    return m_DataIsSet;
}

void StudyList::unsetData()
{
    m_DataIsSet = false;
}
