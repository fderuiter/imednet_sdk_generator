...
web::json::value Inline_object_5::toJson() const
{
...
bool Inline_object_5::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Inline_object_5::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Inline_object_5::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<Metadata> Inline_object_5::getMetadata() const
{
    return m_Metadata;
}


void Inline_object_5::setMetadata(const std::shared_ptr<Metadata>& value)
{
    m_Metadata = value;
    m_MetadataIsSet = true;
}

bool Inline_object_5::metadataIsSet() const
{
    return m_MetadataIsSet;
}

void Inline_object_5::unsetMetadata()
{
    m_MetadataIsSet = false;
}
