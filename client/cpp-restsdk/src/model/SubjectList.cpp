...
#include "CppRestOpenAPIClient/model/SubjectList.h"
...
bool SubjectList::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<Subject>> refVal_setData;
...
std::shared_ptr<Metadata> SubjectList::getMetadata() const
{
    return m_Metadata;
}


void SubjectList::setMetadata(const std::shared_ptr<Metadata>& value)
{
    m_Metadata = value;
    m_MetadataIsSet = true;
}

bool SubjectList::metadataIsSet() const
{
    return m_MetadataIsSet;
}

void SubjectList::unsetMetadata()
{
    m_MetadataIsSet = false;
}
std::shared_ptr<Pagination> SubjectList::getPagination() const
{
    return m_Pagination;
}


void SubjectList::setPagination(const std::shared_ptr<Pagination>& value)
{
    m_Pagination = value;
    m_PaginationIsSet = true;
}

bool SubjectList::paginationIsSet() const
{
    return m_PaginationIsSet;
}

void SubjectList::unsetPagination()
{
    m_PaginationIsSet = false;
}
std::vector<std::shared_ptr<Subject>> SubjectList::getData() const
{
    return m_Data;
}


void SubjectList::setData(const std::vector<std::shared_ptr<Subject>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}
