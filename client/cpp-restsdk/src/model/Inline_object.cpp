...
std::shared_ptr<Metadata> Inline_object::getMetadata() const
{
    return m_Metadata;
}


void Inline_object::setMetadata(const std::shared_ptr<Metadata>& value)
{
    m_Metadata = value;
    m_MetadataIsSet = true;
}

bool Inline_object::metadataIsSet() const
{
    return m_MetadataIsSet;
}

void Inline_object::unsetMetadata()
{
    m_MetadataIsSet = false;
}
