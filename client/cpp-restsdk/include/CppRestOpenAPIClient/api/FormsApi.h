...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_FormsApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_FormsApi_H_
...
public:
    ...
    pplx::task<std::shared_ptr<FormList>> listForms(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_FormsApi_H_ */
