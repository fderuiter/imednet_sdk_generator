...
/*
 * RecordRevisionsApi.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_API_RecordRevisionsApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_RecordRevisionsApi_H_
...
public:
    ...
    explicit RecordRevisionsApi( std::shared_ptr<const ApiClient> apiClient );

    virtual ~RecordRevisionsApi();
    ...
    pplx::task<std::shared_ptr<RecordRevisionList>> listRecordRevisions(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_RecordRevisionsApi_H_ */
