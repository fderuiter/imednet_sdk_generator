...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_StudiesApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_StudiesApi_H_
...
public:
    ...
    explicit StudiesApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    pplx::task<std::shared_ptr<StudyList>> listStudies(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_StudiesApi_H_ */
