...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_SitesApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_SitesApi_H_
...
public:
    ...
    pplx::task<std::shared_ptr<SiteList>> listSites(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_SitesApi_H_ */
