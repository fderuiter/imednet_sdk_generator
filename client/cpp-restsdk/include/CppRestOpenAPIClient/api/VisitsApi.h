...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_VisitsApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_VisitsApi_H_
...
public:
    ...
    explicit VisitsApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    pplx::task<std::shared_ptr<VisitList>> listVisits(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_VisitsApi_H_ */
