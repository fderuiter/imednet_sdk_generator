...
export class QueriesService {
     ...
     * @param {*} [listQueriesOpts.config] Override http request option.
     */
    public listQueries(studyKey: string, page?: number, size?: number, sort?: string, filter?: string, listQueriesOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<QueryList>>;
    public listQueries(studyKey: string, page?: number, size?: number, sort?: string, filter?: string, listQueriesOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<QueryList>(`${this.basePath}/studies/${encodeURIComponent(String(studyKey))}/queries`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
                        ...listQueriesOpts?.config,
                        headers: {...headers, ...listQueriesOpts?.config?.headers},
                    }
                );
            })
        );
