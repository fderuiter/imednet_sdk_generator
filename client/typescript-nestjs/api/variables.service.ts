...
export class VariablesService {
     ...
     * @param {*} [listVariablesOpts.config] Override http request option.
     */
    public listVariables(studyKey: string, page?: number, size?: number, sort?: string, filter?: string, listVariablesOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<VariableList>>;
    public listVariables(studyKey: string, page?: number, size?: number, sort?: string, filter?: string, listVariablesOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<VariableList>(`${this.basePath}/studies/${encodeURIComponent(String(studyKey))}/variables`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
                        ...listVariablesOpts?.config,
                        headers: {...headers, ...listVariablesOpts?.config?.headers},
                    }
                );
            })
        );
