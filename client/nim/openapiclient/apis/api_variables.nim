...
import ../models/model_variable_list
...
proc listVariables*(httpClient: HttpClient, studyKey: string, page: int, size: int, sort: string, filter: string): (Option[VariableList], Response) =
  ...
  let response = httpClient.get(basepath & fmt"/studies/{studyKey}/variables" & "?" & url_encoded_query_params)
  constructResult[VariableList](response)
