...
import ../models/model_study_list
...
proc listStudies*(httpClient: HttpClient, page: int, size: int, sort: string, filter: string): (Option[StudyList], Response) =
  ...
  let response = httpClient.get(basepath & "/studies" & "?" & url_encoded_query_params)
  constructResult[StudyList](response)
