...
------------- | ------------- | -------------
[**list_subjects**](#list_subjects) | **GET** `/studies/{studyKey}/subjects` | List subjects in a study

# **list_subjects**   { #list_subjects }
<a name="list_subjects"></a>

> `list_subjects(studyKey: String,page = 0,size = 25,sort = null,filter = null, on_success: Callable, on_failure: Callable)`
...
# Instantiate the api
var api = SubjectsApi.new(config)
# You can also provide your own HTTPClient, to re-use it across apis.
#var api = SubjectsApi.new(config, client)
...
api.list_subjects(
	...
	func(response):  # response is ApiResponse
		prints("Success!", "list_subjects", response)
		assert(response.data is SubjectList)
