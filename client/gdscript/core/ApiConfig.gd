...
const BEE_DEFAULT_HOST := "edc.prod.imednetapi.com"
...
# Authentication method `apiKeyAuth`.
# Api Key Authentication `x-api-key`
func set_security_apiKeyAuth(value: String):
	self.headers_base["x-api-key"] = value


# Authentication method `securityKeyAuth`.
# Api Key Authentication `x-imn-security-key`
func set_security_securityKeyAuth(value: String):
	self.headers_base["x-imn-security-key"] = value
