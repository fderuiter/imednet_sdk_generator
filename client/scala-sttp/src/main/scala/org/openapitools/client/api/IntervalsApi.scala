...
class IntervalsApi(baseUrl: String) {
   ...
   */
  def listIntervals(apiKey: String, apiKey: String)(studyKey: String, page: Option[Int] = None, size: Option[Int] = None, sort: Option[String] = None, filter: Option[String] = None
): Request[Either[ResponseException[String, Exception], IntervalList], Any] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/studies/${studyKey}/intervals?page=${ page }&size=${ size }&sort=${ sort }&filter=${ filter }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
      .header("x-imn-security-key", apiKey)
      .response(asJson[IntervalList])
