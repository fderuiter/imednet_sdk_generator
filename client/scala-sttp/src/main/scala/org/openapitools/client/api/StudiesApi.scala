...
class StudiesApi(baseUrl: String) {
   ...
   */
  def listStudies(apiKey: String, apiKey: String)(page: Option[Int] = None, size: Option[Int] = None, sort: Option[String] = None, filter: Option[String] = None
): Request[Either[ResponseException[String, Exception], StudyList], Any] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/studies?page=${ page }&size=${ size }&sort=${ sort }&filter=${ filter }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
      .header("x-imn-security-key", apiKey)
      .response(asJson[StudyList])
