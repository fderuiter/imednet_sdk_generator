...
------------- | ------------- | -------------
[**listCodings**](OAICodingsApi.md#listcodings) | **GET** /studies/{studyKey}/codings | List coding activities in a study
...
OAICodingsApi*apiInstance = [[OAICodingsApi alloc] init];

// List coding activities in a study
[apiInstance listCodingsWithStudyKey:studyKey
              page:page
              size:size
              sort:sort
              filter:filter
          completionHandler: ^(OAICodingList* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling OAICodingsApi->listCodings: %@", error);
                        }
                    }];
```
...
[**OAICodingList***](OAICodingList.md)
