...
@interface OAIStudiesApi: NSObject <OAIApi>

extern NSString* kOAIStudiesApiErrorDomain;
extern NSInteger kOAIStudiesApiMissingParamErrorCode;
...
/// 
///  code:200 message:"Successful response with list of studies",
