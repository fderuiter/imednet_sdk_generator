...
@interface OAIQueriesApi: NSObject <OAIApi>

extern NSString* kOAIQueriesApiErrorDomain;
extern NSInteger kOAIQueriesApiMissingParamErrorCode;
...
/// 
///  code:200 message:"Successful response with list of queries",
