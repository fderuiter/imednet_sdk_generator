...
@interface OAIVisitsApi: NSObject <OAIApi>

extern NSString* kOAIVisitsApiErrorDomain;
extern NSInteger kOAIVisitsApiMissingParamErrorCode;
...
/// 
///  code:200 message:"Successful response with list of visits",
