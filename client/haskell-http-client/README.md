## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `Mednet EDC API`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the Mednet EDC API API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | MednetEDC                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | mednet-edc                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | MednetEDCConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | MednetEDCRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| MednetEDC.Client    | use the "dispatch" functions to send requests       |
| MednetEDC.Core      | core functions, config and request types            |
| MednetEDC.API       | construct api requests                              |
| MednetEDC.Model     | describes api models                                |
| MednetEDC.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| MednetEDC.ModelLens | lenses for model fields                             |
| MednetEDC.Logging   | logging functions and utils                         |
