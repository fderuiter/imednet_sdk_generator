...
module MednetEDC.API.Codings where
...
listCodings
  ...
  -> MednetEDCRequest ListCodings MimeNoContent CodingList MimeJSON
listCodings (StudyKey studyKey) =
  _mkRequest "GET" ["/studies/",toPath studyKey,"/codings"]
...
instance HasOptionalParam ListCodings Sort2 where
...
instance HasOptionalParam ListCodings Filter where
  applyOptionalParam req (Filter xs) =
    req `addQuery` toQuery ("filter", Just xs)
-- | @application/json@
instance Produces ListCodings MimeJSON
