...
export default class FormsApi {
    ...
    */
     ...
     * @callback module:api/FormsApi~listFormsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/FormList} data The data returned by the service call.
     ...
     * @param {module:api/FormsApi~listFormsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/FormList}
     */
    listForms(studyKey, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'studyKey' is set
      if (studyKey === undefined || studyKey === null) {
        throw new Error("Missing the required parameter 'studyKey' when calling listForms");
      }
