...
export default class VariablesApi {
    ...
    */
     ...
     * @callback module:api/VariablesApi~listVariablesCallback
     ...
     * @param {module:api/VariablesApi~listVariablesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/VariableList}
     */
    listVariables(studyKey, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'studyKey' is set
      if (studyKey === undefined || studyKey === null) {
        throw new Error("Missing the required parameter 'studyKey' when calling listVariables");
      }
