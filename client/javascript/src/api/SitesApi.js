...
export default class SitesApi {
    ...
    */
     ...
     * @param {module:model/SiteList} data The data returned by the service call.
     ...
     * data is of type: {@link module:model/SiteList}
     */
    listSites(studyKey, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'studyKey' is set
      if (studyKey === undefined || studyKey === null) {
        throw new Error("Missing the required parameter 'studyKey' when calling listSites");
      }
