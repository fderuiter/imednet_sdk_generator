...
function Invoke-ListSubjects {
    ...
    Process {
        'Calling method: Invoke-ListSubjects' | Write-Debug
        ...
        $LocalVarUri = '/studies/{studyKey}/subjects'
        if (!$StudyKey) {
            throw "Error! The required parameter `StudyKey` missing when calling listSubjects."
        }
