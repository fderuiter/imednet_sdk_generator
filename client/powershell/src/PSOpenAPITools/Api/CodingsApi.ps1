...
function Invoke-ListCodings {
    ...
    Process {
        'Calling method: Invoke-ListCodings' | Write-Debug
        ...
        $LocalVarUri = '/studies/{studyKey}/codings'
        if (!$StudyKey) {
            throw "Error! The required parameter `StudyKey` missing when calling listCodings."
        }
