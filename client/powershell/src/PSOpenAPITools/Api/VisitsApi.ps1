...
function Invoke-ListVisits {
    ...
    Process {
        'Calling method: Invoke-ListVisits' | Write-Debug
        ...
        $LocalVarUri = '/studies/{studyKey}/visits'
        if (!$StudyKey) {
            throw "Error! The required parameter `StudyKey` missing when calling listVisits."
        }
