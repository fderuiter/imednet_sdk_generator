...
function Invoke-ListQueries {
    ...
    Process {
        'Calling method: Invoke-ListQueries' | Write-Debug
        ...
        $LocalVarUri = '/studies/{studyKey}/queries'
        if (!$StudyKey) {
            throw "Error! The required parameter `StudyKey` missing when calling listQueries."
        }
