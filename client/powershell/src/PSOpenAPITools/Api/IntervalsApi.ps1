...
function Invoke-ListIntervals {
    ...
    Process {
        'Calling method: Invoke-ListIntervals' | Write-Debug
        ...
        $LocalVarUri = '/studies/{studyKey}/intervals'
        if (!$StudyKey) {
            throw "Error! The required parameter `StudyKey` missing when calling listIntervals."
        }
