# PSOpenAPITools.PSOpenAPITools\Api.StudiesApi

All URIs are relative to *https://edc.prod.imednetapi.com/api/v1/edc*

Method | HTTP request | Description
------------- | ------------- | -------------
[**Invoke-ListStudies**](StudiesApi.md#Invoke-ListStudies) | **GET** /studies | List studies accessible by API key


<a id="Invoke-ListStudies"></a>
# **Invoke-ListStudies**
> StudyList Invoke-ListStudies<br>
...
# List studies accessible by API key
try {
    $Result = Invoke-ListStudies -Page $Page -Size $Size -Sort $Sort -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-ListStudies: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
...
[**StudyList**](StudyList.md) (PSCustomObject)
