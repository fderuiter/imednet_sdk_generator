# PSOpenAPITools.PSOpenAPITools\Api.VisitsApi

All URIs are relative to *https://edc.prod.imednetapi.com/api/v1/edc*

Method | HTTP request | Description
------------- | ------------- | -------------
[**Invoke-ListVisits**](VisitsApi.md#Invoke-ListVisits) | **GET** /studies/{studyKey}/visits | List visits (subject visit instances) in a study


<a id="Invoke-ListVisits"></a>
# **Invoke-ListVisits**
> VisitList Invoke-ListVisits<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-StudyKey] <String><br>
...
# List visits (subject visit instances) in a study
try {
    $Result = Invoke-ListVisits -StudyKey $StudyKey -Page $Page -Size $Size -Sort $Sort -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-ListVisits: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
...
[**VisitList**](VisitList.md) (PSCustomObject)
