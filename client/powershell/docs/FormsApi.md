# PSOpenAPITools.PSOpenAPITools\Api.FormsApi

All URIs are relative to *https://edc.prod.imednetapi.com/api/v1/edc*

Method | HTTP request | Description
------------- | ------------- | -------------
[**Invoke-ListForms**](FormsApi.md#Invoke-ListForms) | **GET** /studies/{studyKey}/forms | List forms in a study


<a id="Invoke-ListForms"></a>
# **Invoke-ListForms**
> FormList Invoke-ListForms<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-StudyKey] <String><br>
...
# List forms in a study
try {
    $Result = Invoke-ListForms -StudyKey $StudyKey -Page $Page -Size $Size -Sort $Sort -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-ListForms: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
...
[**FormList**](FormList.md) (PSCustomObject)
