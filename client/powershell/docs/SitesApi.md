# PSOpenAPITools.PSOpenAPITools\Api.SitesApi

All URIs are relative to *https://edc.prod.imednetapi.com/api/v1/edc*

Method | HTTP request | Description
------------- | ------------- | -------------
[**Invoke-ListSites**](SitesApi.md#Invoke-ListSites) | **GET** /studies/{studyKey}/sites | List sites for a study


<a id="Invoke-ListSites"></a>
# **Invoke-ListSites**
> SiteList Invoke-ListSites<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-StudyKey] <String><br>
...
# List sites for a study
try {
    $Result = Invoke-ListSites -StudyKey $StudyKey -Page $Page -Size $Size -Sort $Sort -Filter $Filter
} catch {
    Write-Host ("Exception occurred when calling Invoke-ListSites: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
...
[**SiteList**](SiteList.md) (PSCustomObject)
