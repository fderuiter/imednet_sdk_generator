...
public class SubjectsApiTest {
    ...
    public void setup() {
        ...
        api = JAXRSClientFactory.create("https://edc.prod.imednetapi.com/api/v1/edc", SubjectsApi.class, providers);
    ...
    public void listSubjectsTest() {
        ...
        String sort = null;
        String filter = null;
        //SubjectList response = api.listSubjects(studyKey, page, size, sort, filter);
