...
public class QueriesApiTest {
    ...
    public void setup() {
        ...
        api = JAXRSClientFactory.create("https://edc.prod.imednetapi.com/api/v1/edc", QueriesApi.class, providers);
    ...
    public void listQueriesTest() {
        ...
        String sort = null;
        String filter = null;
        //QueryList response = api.listQueries(studyKey, page, size, sort, filter);
