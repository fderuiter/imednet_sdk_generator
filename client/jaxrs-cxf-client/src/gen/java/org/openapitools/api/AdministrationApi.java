...
public interface AdministrationApi  {
    ...
    @ApiOperation(value = "List users and their roles in a study", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful response with list of users", response = UserList.class),
    ...
    public UserList listUsers(@PathParam("studyKey") String studyKey, @QueryParam("page") @DefaultValue("0")Integer page, @QueryParam("size") @DefaultValue("25")Integer size, @QueryParam("sort") String sort, @QueryParam("includeInactive") @DefaultValue("false")Boolean includeInactive);
}
