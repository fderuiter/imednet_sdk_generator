...
public interface IntervalsApi  {
    ...
    @ApiOperation(value = "List intervals (visit definitions) in a study", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful response with list of intervals", response = IntervalList.class),
    ...
    public IntervalList listIntervals(@PathParam("studyKey") String studyKey, @QueryParam("page") @DefaultValue("0")Integer page, @QueryParam("size") @DefaultValue("25")Integer size, @QueryParam("sort") String sort, @QueryParam("filter") String filter);
}
