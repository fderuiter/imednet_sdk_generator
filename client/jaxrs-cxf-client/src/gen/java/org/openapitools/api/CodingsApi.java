 ...
 *
 */
@Path("/studies/{studyKey}/codings")
@Api(value = "/", description = "")
public interface CodingsApi  {
    ...
    @ApiOperation(value = "List coding activities in a study", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful response with list of coding entries", response = CodingList.class),
    ...
    public CodingList listCodings(@PathParam("studyKey") String studyKey, @QueryParam("page") @DefaultValue("0")Integer page, @QueryParam("size") @DefaultValue("25")Integer size, @QueryParam("sort") String sort, @QueryParam("filter") String filter);
}
