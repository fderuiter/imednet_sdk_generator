 ...
 */
@JsonPropertyOrder({
  SubjectList.JSON_PROPERTY_METADATA,
  SubjectList.JSON_PROPERTY_PAGINATION,
  SubjectList.JSON_PROPERTY_DATA
})
...
public class SubjectList {
    ...
    private List<@Valid Subject> data = null;
    ...
    public SubjectList data(List<@Valid Subject> data) {
        this.data = data;
        return this;
    }
    ...
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public List<@Valid Subject> getData() {
        return data;
    }

    @JsonProperty(JSON_PROPERTY_DATA)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setData(List<@Valid Subject> data) {
        this.data = data;
    }
