 ...
 */
@JsonPropertyOrder({
  RecordList.JSON_PROPERTY_METADATA,
  RecordList.JSON_PROPERTY_PAGINATION,
  RecordList.JSON_PROPERTY_DATA
})
...
public class RecordList {
    ...
    private List<@Valid Record> data = null;
    ...
    public RecordList data(List<@Valid Record> data) {
        this.data = data;
        return this;
    }
    ...
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public List<@Valid Record> getData() {
        return data;
    }

    @JsonProperty(JSON_PROPERTY_DATA)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setData(List<@Valid Record> data) {
        this.data = data;
    }
