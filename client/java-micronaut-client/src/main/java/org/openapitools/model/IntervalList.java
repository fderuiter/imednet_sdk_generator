 ...
 */
@JsonPropertyOrder({
  IntervalList.JSON_PROPERTY_METADATA,
  IntervalList.JSON_PROPERTY_PAGINATION,
  IntervalList.JSON_PROPERTY_DATA
})
@JsonTypeName("IntervalList")
...
public class IntervalList {
    ...
    private List<@Valid Interval> data = null;
    ...
    public IntervalList data(List<@Valid Interval> data) {
        this.data = data;
        return this;
    }
    ...
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public List<@Valid Interval> getData() {
        return data;
    }

    @JsonProperty(JSON_PROPERTY_DATA)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setData(List<@Valid Interval> data) {
        this.data = data;
    }
