...
* @version 1.3.6
*/
export default class AdministrationApi extends ApiClient {
    ...
    */
     ...
     * @param {Boolean} opts.includeInactive For user listing, whether to include inactive users (default to false)
     * @param requestInit Dynamic configuration. @see {@link https://github.com/apollographql/apollo-server/pull/1277}
     * @return {Promise<module:model/UserList>}
     */
    async listUsers(studyKey, opts, requestInit) {
      opts = opts || {};
      let postBody = null;
