...
module OpenAPIClient
  class Site
    ...
    @[JSON::Field(key: "siteEnrollmentStatus", type: String?, nillable: true, emit_null: false)]
    property site_enrollment_status : String?
    ...
    def initialize(@study_key : String?, @site_id : Int32?, @site_name : String?, @site_enrollment_status : String?, @date_created : String?, @date_modified : String?)
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
          ...
          site_enrollment_status == other.site_enrollment_status &&
