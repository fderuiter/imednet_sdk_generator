...
module OpenAPIClient
  class Visit
    ...
    @[JSON::Field(key: "startDate", type: String?, nillable: true, emit_null: false)]
    property start_date : String?

    # End date of the visit window (in YYYY-MM-DD format)
    @[JSON::Field(key: "endDate", type: String?, nillable: true, emit_null: false)]
    property end_date : String?

    # Due date of the visit (in YYYY-MM-DD format), if applicable
    @[JSON::Field(key: "dueDate", type: String?, nillable: true, emit_null: false)]
    property due_date : String?

    # Actual date the visit took place (in YYYY-MM-DD format)
    @[JSON::Field(key: "visitDate", type: String?, nillable: true, emit_null: false)]
    property visit_date : String?

    # Name of the form used to capture the actual visit date
    @[JSON::Field(key: "visitDateForm", type: String?, nillable: true, emit_null: false)]
    property visit_date_form : String?

    # Variable name of the field capturing the actual visit date
    @[JSON::Field(key: "visitDateQuestion", type: String?, nillable: true, emit_null: false)]
    property visit_date_question : String?
    ...
    def initialize(@study_key : String?, @visit_id : Int32?, @interval_id : Int32?, @interval_name : String?, @subject_id : Int32?, @subject_key : String?, @start_date : String?, @end_date : String?, @due_date : String?, @visit_date : String?, @visit_date_form : String?, @visit_date_question : String?, @deleted : Bool?, @date_created : String?, @date_modified : String?)
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
          ...
          visit_date_form == other.visit_date_form &&
          visit_date_question == other.visit_date_question &&
