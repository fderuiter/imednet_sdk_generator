...
module OpenAPIClient
  class Subject
    ...
    @[JSON::Field(key: "subjectStatus", type: String?, nillable: true, emit_null: false)]
    property subject_status : String?
    ...
    @[JSON::Field(key: "enrollmentStartDate", type: String?, nillable: true, emit_null: false)]
    property enrollment_start_date : String?
    ...
    def initialize(@study_key : String?, @subject_id : Int32?, @subject_oid : String?, @subject_key : String?, @subject_status : String?, @site_id : Int32?, @site_name : String?, @deleted : Bool?, @enrollment_start_date : String?, @date_created : String?, @date_modified : String?, @keywords : Array(Keyword)?)
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
          ...
          subject_status == other.subject_status &&
          site_id == other.site_id &&
          site_name == other.site_name &&
          deleted == other.deleted &&
          enrollment_start_date == other.enrollment_start_date &&
