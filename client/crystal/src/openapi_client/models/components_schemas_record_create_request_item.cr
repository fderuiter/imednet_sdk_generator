...
module OpenAPIClient
  class ComponentsSchemasRecordCreateRequestItem
    ...
    @[JSON::Field(key: "formKey", type: String, nillable: false, emit_null: false)]
    property form_key : String

    # Key-value pairs of field names and values for the record data
    @[JSON::Field(key: "data", type: Hash(String, Object), nillable: false, emit_null: false)]
    property data : Hash(String, Object)
    ...
    def initialize(@form_key : String, @data : Hash(String, Object), @form_id : Int32?, @site_name : String?, @site_id : Int32?, @subject_key : String?, @subject_id : Int32?, @subject_oid : String?, @interval_name : String?, @interval_id : Int32?, @record_id : Int32?, @record_oid : String?)
    end
