...
# Unit tests for OpenAPIClient::FormsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe "FormsApi" do
  describe "test an instance of FormsApi" do
    it "should create an instance of FormsApi" do
      api_instance = OpenAPIClient::FormsApi.new
      expect(api_instance).to be_instance_of(OpenAPIClient::FormsApi)
    end
  end

  # unit tests for list_forms
