...
# Unit tests for OpenAPIClient::VariablesApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe "VariablesApi" do
  describe "test an instance of VariablesApi" do
    it "should create an instance of VariablesApi" do
      ...
      expect(api_instance).to be_instance_of(OpenAPIClient::VariablesApi)
    end
  end
  ...
  # @return [VariableList]
  describe "list_variables test" do
    skip "should work" do
