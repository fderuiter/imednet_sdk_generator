...
# Unit tests for OpenAPIClient::CodingsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe "CodingsApi" do
  describe "test an instance of CodingsApi" do
    it "should create an instance of CodingsApi" do
      api_instance = OpenAPIClient::CodingsApi.new
      expect(api_instance).to be_instance_of(OpenAPIClient::CodingsApi)
    end
  end
