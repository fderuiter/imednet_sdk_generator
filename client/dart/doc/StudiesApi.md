...
try {
    final result = api_instance.listStudies(page, size, sort, filter);
    print(result);
} catch (e) {
    print('Exception when calling StudiesApi->listStudies: $e\n');
}
```
