...
try {
    final result = api_instance.listCodings(studyKey, page, size, sort, filter);
    print(result);
} catch (e) {
    print('Exception when calling CodingsApi->listCodings: $e\n');
}
```
