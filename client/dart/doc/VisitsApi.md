...
try {
    final result = api_instance.listVisits(studyKey, page, size, sort, filter);
    print(result);
} catch (e) {
    print('Exception when calling VisitsApi->listVisits: $e\n');
}
```
