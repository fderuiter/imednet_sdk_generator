...
class Site {
  ...
  bool operator ==(Object other) => identical(this, other) || other is Site &&
    ...
    other.siteEnrollmentStatus == siteEnrollmentStatus &&
  ...
  int get hashCode =>
    ...
    (siteEnrollmentStatus == null ? 0 : siteEnrollmentStatus!.hashCode) +
    (dateCreated == null ? 0 : dateCreated!.hashCode) +
    (dateModified == null ? 0 : dateModified!.hashCode);

  @override
  String toString() => 'Site[studyKey=$studyKey, siteId=$siteId, siteName=$siteName, siteEnrollmentStatus=$siteEnrollmentStatus, dateCreated=$dateCreated, dateModified=$dateModified]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.siteEnrollmentStatus != null) {
      json[r'siteEnrollmentStatus'] = this.siteEnrollmentStatus;
    } else {
      json[r'siteEnrollmentStatus'] = null;
    }
  ...
  static Site? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Site(
        ...
        siteEnrollmentStatus: mapValueOfType<String>(json, r'siteEnrollmentStatus'),
