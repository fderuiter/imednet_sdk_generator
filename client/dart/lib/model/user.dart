...
class User {
  ...
  bool operator ==(Object other) => identical(this, other) || other is User &&
    ...
    other.email == email &&
    other.userActiveInStudy == userActiveInStudy &&
  ...
  int get hashCode =>
    ...
    (userActiveInStudy == null ? 0 : userActiveInStudy!.hashCode) +
    (roles.hashCode);

  @override
  String toString() => 'User[userId=$userId, login=$login, firstName=$firstName, lastName=$lastName, email=$email, userActiveInStudy=$userActiveInStudy, roles=$roles]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.userActiveInStudy != null) {
      json[r'userActiveInStudy'] = this.userActiveInStudy;
    } else {
      json[r'userActiveInStudy'] = null;
    }
  ...
  static User? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return User(
        ...
        userActiveInStudy: mapValueOfType<bool>(json, r'userActiveInStudy'),
