...
class SitesApi {
  ...
  Future<Response> listSitesWithHttpInfo(String studyKey, { int? page, int? size, String? sort, String? filter, }) async {
    // ignore: prefer_const_declarations
    final path = r'/studies/{studyKey}/sites'
  ...
  Future<SiteList?> listSites(String studyKey, { int? page, int? size, String? sort, String? filter, }) async {
    final response = await listSitesWithHttpInfo(studyKey,  page: page, size: size, sort: sort, filter: filter, );
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'SiteList',) as SiteList;
