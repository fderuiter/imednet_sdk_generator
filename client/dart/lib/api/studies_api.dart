...
class StudiesApi {
  ...
  Future<Response> listStudiesWithHttpInfo({ int? page, int? size, String? sort, String? filter, }) async {
    // ignore: prefer_const_declarations
    final path = r'/studies';
  ...
  Future<StudyList?> listStudies({ int? page, int? size, String? sort, String? filter, }) async {
    final response = await listStudiesWithHttpInfo( page: page, size: size, sort: sort, filter: filter, );
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'StudyList',) as StudyList;
