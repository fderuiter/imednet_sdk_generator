...
class AdministrationApi {
  ...
  Future<Response> listUsersWithHttpInfo(String studyKey, { int? page, int? size, String? sort, bool? includeInactive, }) async {
    // ignore: prefer_const_declarations
    final path = r'/studies/{studyKey}/users'
  ...
  Future<UserList?> listUsers(String studyKey, { int? page, int? size, String? sort, bool? includeInactive, }) async {
    final response = await listUsersWithHttpInfo(studyKey,  page: page, size: size, sort: sort, includeInactive: includeInactive, );
