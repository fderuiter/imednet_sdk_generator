...
class SubjectsApi {
  SubjectsApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<Response> listSubjectsWithHttpInfo(String studyKey, { int? page, int? size, String? sort, String? filter, }) async {
    // ignore: prefer_const_declarations
    final path = r'/studies/{studyKey}/subjects'
  ...
  Future<SubjectList?> listSubjects(String studyKey, { int? page, int? size, String? sort, String? filter, }) async {
    final response = await listSubjectsWithHttpInfo(studyKey,  page: page, size: size, sort: sort, filter: filter, );
