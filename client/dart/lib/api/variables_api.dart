...
class VariablesApi {
  ...
  Future<Response> listVariablesWithHttpInfo(String studyKey, { int? page, int? size, String? sort, String? filter, }) async {
    // ignore: prefer_const_declarations
    final path = r'/studies/{studyKey}/variables'
  ...
  Future<VariableList?> listVariables(String studyKey, { int? page, int? size, String? sort, String? filter, }) async {
    final response = await listVariablesWithHttpInfo(studyKey,  page: page, size: size, sort: sort, filter: filter, );
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'VariableList',) as VariableList;
