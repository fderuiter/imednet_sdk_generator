...
class CodingsApi {
  CodingsApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<Response> listCodingsWithHttpInfo(String studyKey, { int? page, int? size, String? sort, String? filter, }) async {
    // ignore: prefer_const_declarations
    final path = r'/studies/{studyKey}/codings'
  ...
  Future<CodingList?> listCodings(String studyKey, { int? page, int? size, String? sort, String? filter, }) async {
    final response = await listCodingsWithHttpInfo(studyKey,  page: page, size: size, sort: sort, filter: filter, );
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'CodingList',) as CodingList;
