...
open class IntervalsAPI {
    ...
    open class func listIntervals(studyKey: String, page: Int? = nil, size: Int? = nil, sort: String? = nil, filter: String? = nil, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> IntervalList {
        return try await listIntervalsWithRequestBuilder(studyKey: studyKey, page: page, size: size, sort: sort, filter: filter, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func listIntervalsWithRequestBuilder(studyKey: String, page: Int? = nil, size: Int? = nil, sort: String? = nil, filter: String? = nil, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) -> RequestBuilder<IntervalList> {
        ...
        let localVariableRequestBuilder: RequestBuilder<IntervalList>.Type = apiConfiguration.requestBuilderFactory.getBuilder()
