...
open class RecordRevisionsAPI {
    ...
    /**
     ...
     - returns: RecordRevisionList
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func listRecordRevisions(studyKey: String, page: Int? = nil, size: Int? = nil, sort: String? = nil, filter: String? = nil, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> RecordRevisionList {
        return try await listRecordRevisionsWithRequestBuilder(studyKey: studyKey, page: page, size: size, sort: sort, filter: filter, apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - parameter filter: (query) Optional filter criteria to apply, in the format &#x60;attribute&#x3D;&#x3D;value&#x60; with support for &gt;, &gt;&#x3D;, &lt;, &lt;&#x3D;, !&#x3D;. Multiple criteria can be combined with &#x60;;&#x60; (AND) or &#x60;,&#x60; (OR). (optional)
     - parameter apiConfiguration: The configuration for the http request.
     - returns: RequestBuilder<RecordRevisionList> 
     */
    open class func listRecordRevisionsWithRequestBuilder(studyKey: String, page: Int? = nil, size: Int? = nil, sort: String? = nil, filter: String? = nil, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) -> RequestBuilder<RecordRevisionList> {
        var localVariablePath = "/studies/{studyKey}/recordRevisions"
        ...
        let localVariableRequestBuilder: RequestBuilder<RecordRevisionList>.Type = apiConfiguration.requestBuilderFactory.getBuilder()
