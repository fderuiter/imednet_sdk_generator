...
open class VariablesAPI {
    ...
    open class func listVariables(studyKey: String, page: Int? = nil, size: Int? = nil, sort: String? = nil, filter: String? = nil, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> VariableList {
        return try await listVariablesWithRequestBuilder(studyKey: studyKey, page: page, size: size, sort: sort, filter: filter, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func listVariablesWithRequestBuilder(studyKey: String, page: Int? = nil, size: Int? = nil, sort: String? = nil, filter: String? = nil, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) -> RequestBuilder<VariableList> {
        var localVariablePath = "/studies/{studyKey}/variables"
        ...
        let localVariableRequestBuilder: RequestBuilder<VariableList>.Type = apiConfiguration.requestBuilderFactory.getBuilder()
