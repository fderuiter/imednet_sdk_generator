...
public struct Record: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public var recordData: [String: JSONValue]?

    public init(studyKey: String? = nil, intervalId: Int? = nil, formId: Int? = nil, formKey: String? = nil, siteId: Int? = nil, recordId: Int? = nil, recordOid: String? = nil, recordType: String? = nil, recordStatus: String? = nil, deleted: Bool? = nil, dateCreated: String? = nil, dateModified: String? = nil, subjectId: Int? = nil, subjectOid: String? = nil, subjectKey: String? = nil, visitId: Int? = nil, parentRecordId: Int? = nil, keywords: [Keyword]? = nil, recordData: [String: JSONValue]? = nil) {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(recordData, forKey: .recordData)
    }
}
