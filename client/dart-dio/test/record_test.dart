...
void main() {
  ...
  group(Record, () {
    ...
    // String recordType
    test('to test the property `recordType`', () async {
      // TODO
    });

    // Current status of the record (e.g., Record Incomplete, Record Complete)
    // String recordStatus
    test('to test the property `recordStatus`', () async {
      // TODO
    });
    ...
    // int parentRecordId
    test('to test the property `parentRecordId`', () async {
      // TODO
    });

    // List of keywords associated with the record
    // BuiltList<Keyword> keywords
    ...
    // BuiltMap<String, JsonObject> recordData
    test('to test the property `recordData`', () async {
      // TODO
    });
