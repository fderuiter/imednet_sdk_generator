...
class StudiesApi {
  ...
  const StudiesApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [StudyList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<StudyList>> listStudies({ 
    int? page = 0,
    int? size = 25,
    String? sort,
    String? filter,
    ...
    StudyList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(StudyList),
      ) as StudyList;
