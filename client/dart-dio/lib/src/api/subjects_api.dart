...
class SubjectsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [SubjectList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SubjectList>> listSubjects({ 
    ...
    final _path = r'/studies/{studyKey}/subjects'.replaceAll('{' r'studyKey' '}', encodeQueryParameter(_serializers, studyKey, const FullType(String)).toString());
    ...
    SubjectList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(SubjectList),
      ) as SubjectList;
