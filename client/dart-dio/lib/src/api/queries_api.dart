...
class QueriesApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [QueryList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<QueryList>> listQueries({ 
    ...
    final _path = r'/studies/{studyKey}/queries'.replaceAll('{' r'studyKey' '}', encodeQueryParameter(_serializers, studyKey, const FullType(String)).toString());
    ...
    QueryList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(QueryList),
      ) as QueryList;
