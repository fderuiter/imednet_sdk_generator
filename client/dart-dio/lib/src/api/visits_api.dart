...
class VisitsApi {
  ...
  const VisitsApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [VisitList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<VisitList>> listVisits({ 
    ...
    final _path = r'/studies/{studyKey}/visits'.replaceAll('{' r'studyKey' '}', encodeQueryParameter(_serializers, studyKey, const FullType(String)).toString());
    ...
    VisitList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(VisitList),
      ) as VisitList;
