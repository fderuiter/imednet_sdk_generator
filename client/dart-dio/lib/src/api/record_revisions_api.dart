...
class RecordRevisionsApi {
  ...
  const RecordRevisionsApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [RecordRevisionList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<RecordRevisionList>> listRecordRevisions({ 
    ...
    final _path = r'/studies/{studyKey}/recordRevisions'.replaceAll('{' r'studyKey' '}', encodeQueryParameter(_serializers, studyKey, const FullType(String)).toString());
    ...
    RecordRevisionList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RecordRevisionList),
    ...
    return Response<RecordRevisionList>(
      data: _responseData,
