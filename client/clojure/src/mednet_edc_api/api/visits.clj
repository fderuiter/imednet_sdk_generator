...
(defn-spec list-visits visit-list-spec
  "List visits (subject visit instances) in a study"
  ([studyKey string?, ] (list-visits studyKey nil))
  ([studyKey string?, optional-params any?]
   (let [res (:data (list-visits-with-http-info studyKey optional-params))]
     (if (:decode-models *api-context*)
        (st/decode visit-list-spec res st/string-transformer)
        res))))
