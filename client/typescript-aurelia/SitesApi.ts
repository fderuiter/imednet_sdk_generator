...
/**
 * listSites - parameters interface
 */
export interface IListSitesParams {
  studyKey: string;
  page?: number;
  size?: number;
  sort?: string;
...
export class SitesApi extends Api {
   ...
   */
  async listSites(params: IListSitesParams): Promise<SiteList> {
    // Verify required parameters are set
    this.ensureParamIsSet('listSites', params, 'studyKey');

    // Create URL to call
    const url = `${this.basePath}/studies/{studyKey}/sites`
