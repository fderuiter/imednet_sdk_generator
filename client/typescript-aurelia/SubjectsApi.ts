...
/**
 * listSubjects - parameters interface
 */
export interface IListSubjectsParams {
  studyKey: string;
  page?: number;
  size?: number;
  sort?: string;
...
/**
 * SubjectsApi - API class
 */
@autoinject()
export class SubjectsApi extends Api {

  /**
   * Creates a new SubjectsApi class.
   *
   ...
   */
  async listSubjects(params: IListSubjectsParams): Promise<SubjectList> {
    // Verify required parameters are set
    this.ensureParamIsSet('listSubjects', params, 'studyKey');

    // Create URL to call
    const url = `${this.basePath}/studies/{studyKey}/subjects`
