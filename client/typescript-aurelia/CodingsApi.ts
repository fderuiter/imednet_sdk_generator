...
/**
 * listCodings - parameters interface
 */
export interface IListCodingsParams {
  studyKey: string;
  page?: number;
  size?: number;
  sort?: string;
...
/**
 * CodingsApi - API class
 */
@autoinject()
export class CodingsApi extends Api {

  /**
   * Creates a new CodingsApi class.
   *
   ...
   */
  async listCodings(params: IListCodingsParams): Promise<CodingList> {
    // Verify required parameters are set
    this.ensureParamIsSet('listCodings', params, 'studyKey');

    // Create URL to call
    const url = `${this.basePath}/studies/{studyKey}/codings`
