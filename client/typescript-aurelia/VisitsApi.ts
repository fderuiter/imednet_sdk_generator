...
/**
 * listVisits - parameters interface
 */
export interface IListVisitsParams {
  studyKey: string;
  page?: number;
  size?: number;
  sort?: string;
 ...
 */
@autoinject()
export class VisitsApi extends Api {

  /**
   * Creates a new VisitsApi class.
   *
   ...
   */
  async listVisits(params: IListVisitsParams): Promise<VisitList> {
    // Verify required parameters are set
    this.ensureParamIsSet('listVisits', params, 'studyKey');

    // Create URL to call
    const url = `${this.basePath}/studies/{studyKey}/visits`
