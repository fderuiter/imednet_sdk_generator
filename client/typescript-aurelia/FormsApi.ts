...
/**
 * listForms - parameters interface
 */
export interface IListFormsParams {
  studyKey: string;
  page?: number;
  size?: number;
  sort?: string;
...
export class FormsApi extends Api {
   ...
   */
  async listForms(params: IListFormsParams): Promise<FormList> {
    // Verify required parameters are set
    this.ensureParamIsSet('listForms', params, 'studyKey');

    // Create URL to call
    const url = `${this.basePath}/studies/{studyKey}/forms`
