...
/**
 * listRecordRevisions - parameters interface
 */
export interface IListRecordRevisionsParams {
  studyKey: string;
  page?: number;
  size?: number;
  sort?: string;
...
/**
 * RecordRevisionsApi - API class
 */
@autoinject()
export class RecordRevisionsApi extends Api {

  /**
   * Creates a new RecordRevisionsApi class.
   *
   ...
   */
  async listRecordRevisions(params: IListRecordRevisionsParams): Promise<RecordRevisionList> {
    // Verify required parameters are set
    this.ensureParamIsSet('listRecordRevisions', params, 'studyKey');

    // Create URL to call
    const url = `${this.basePath}/studies/{studyKey}/recordRevisions`
