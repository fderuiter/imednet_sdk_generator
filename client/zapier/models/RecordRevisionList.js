...
const RecordRevision = require('../models/RecordRevision');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            ...Pagination.fields(`${keyPrefix}pagination`, isInput),
            {
                ...
                children: RecordRevision.fields(`${keyPrefix}data${!isInput ? '[]' : ''}`, isInput, true), 
            },
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'data': utils.childMapping(bundle.inputData?.[`${keyPrefix}data`], `${keyPrefix}data`, RecordRevision),
        }
    },
}
