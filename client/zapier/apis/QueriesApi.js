const samples = require('../samples/QueriesApi');
...
module.exports = {
    listQueries: {
        ...
        noun: 'Queries',
        display: {
            label: 'List data queries in a study',
            description: '',
            hidden: false,
        },
        operation: {
            ...
            outputFields: [
                ...QueryList.fields('', false),
            ],
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://edc.prod.imednetapi.com/api/v1/edc/studies/{studyKey}/queries'),
                    method: 'GET',
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    ...
                    const results = utils.responseOptionsMiddleware(z, bundle, 'listQueries', response.json);
                    return results;
                })
            },
            sample: samples['QueryListSample']
        }
    },
}
