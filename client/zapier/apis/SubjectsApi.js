const samples = require('../samples/SubjectsApi');
...
module.exports = {
    listSubjects: {
        ...
        noun: 'Subjects',
        display: {
            label: 'List subjects in a study',
            description: '',
            hidden: false,
        },
        operation: {
            ...
            outputFields: [
                ...SubjectList.fields('', false),
            ],
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://edc.prod.imednetapi.com/api/v1/edc/studies/{studyKey}/subjects'),
                    method: 'GET',
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    ...
                    const results = utils.responseOptionsMiddleware(z, bundle, 'listSubjects', response.json);
                    return results;
                })
            },
            sample: samples['SubjectListSample']
        }
    },
}
