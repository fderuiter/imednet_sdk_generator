const samples = require('../samples/VisitsApi');
const VisitList = require('../models/VisitList');
...
module.exports = {
    listVisits: {
        ...
        noun: 'Visits',
        display: {
            label: 'List visits (subject visit instances) in a study',
            description: '',
            hidden: false,
        },
        operation: {
            ...
            outputFields: [
                ...VisitList.fields('', false),
            ],
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://edc.prod.imednetapi.com/api/v1/edc/studies/{studyKey}/visits'),
                    method: 'GET',
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    ...
                    const results = utils.responseOptionsMiddleware(z, bundle, 'listVisits', response.json);
                    return results;
                })
            },
            sample: samples['VisitListSample']
        }
    },
}
