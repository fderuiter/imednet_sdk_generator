const samples = require('../samples/IntervalsApi');
const IntervalList = require('../models/IntervalList');
...
module.exports = {
    listIntervals: {
        ...
        noun: 'Intervals',
        display: {
            label: 'List intervals (visit definitions) in a study',
            description: '',
            hidden: false,
        },
        operation: {
            ...
            outputFields: [
                ...IntervalList.fields('', false),
            ],
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://edc.prod.imednetapi.com/api/v1/edc/studies/{studyKey}/intervals'),
                    method: 'GET',
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    ...
                    const results = utils.responseOptionsMiddleware(z, bundle, 'listIntervals', response.json);
                    return results;
                })
            },
            sample: samples['IntervalListSample']
        }
    },
}
