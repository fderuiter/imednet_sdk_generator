...
void OAIVariablesApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("listVariables", defaultConf);
    _serverIndices.insert("listVariables", 0);
}
...
void OAIVariablesApi::listVariables(const QString &study_key, const ::OpenAPI::OptionalParam<qint32> &page, const ::OpenAPI::OptionalParam<qint32> &size, const ::OpenAPI::OptionalParam<QString> &sort, const ::OpenAPI::OptionalParam<QString> &filter) {
    QString fullPath = QString(_serverConfigs["listVariables"][_serverIndices.value("listVariables")].URL()+"/studies/{studyKey}/variables");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVariablesApi::listVariablesCallback);
...
void OAIVariablesApi::listVariablesCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIVariableList output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT listVariablesSignal(output);
        Q_EMIT listVariablesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT listVariablesSignalE(output, error_type, error_str);
        Q_EMIT listVariablesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT listVariablesSignalError(output, error_type, error_str);
        Q_EMIT listVariablesSignalErrorFull(worker, error_type, error_str);
    }
}
