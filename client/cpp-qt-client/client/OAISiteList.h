...
#ifndef OAISiteList_H
#define OAISiteList_H
...
class OAISiteList : public OAIObject {
public:
    OAISiteList();
    OAISiteList(QString json);
    ~OAISiteList() override;
    ...
    QList<OAISite> getData() const;
    void setData(const QList<OAISite> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAISiteList)
