...
void OAIAdministrationApi::listUsers(const QString &study_key, const ::OpenAPI::OptionalParam<qint32> &page, const ::OpenAPI::OptionalParam<qint32> &size, const ::OpenAPI::OptionalParam<QString> &sort, const ::OpenAPI::OptionalParam<bool> &include_inactive) {
    QString fullPath = QString(_serverConfigs["listUsers"][_serverIndices.value("listUsers")].URL()+"/studies/{studyKey}/users");
    ...
    if (include_inactive.hasValue())
    {
        ...
        fullPath.append(QUrl::toPercentEncoding("includeInactive")).append(querySuffix).append(QUrl::toPercentEncoding(::OpenAPI::toStringValue(include_inactive.stringValue())));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAdministrationApi::listUsersCallback);
...
void OAIAdministrationApi::listUsersCallback(OAIHttpRequestWorker *worker) {
