...
OAIMetadata OAIInline_object_3::getMetadata() const {
    return m_metadata;
}
void OAIInline_object_3::setMetadata(const OAIMetadata &metadata) {
    m_metadata = metadata;
    m_metadata_isSet = true;
}

bool OAIInline_object_3::is_metadata_Set() const{
    return m_metadata_isSet;
}

bool OAIInline_object_3::is_metadata_Valid() const{
