...
#ifndef OAICodingList_H
#define OAICodingList_H
...
class OAICodingList : public OAIObject {
public:
    OAICodingList();
    OAICodingList(QString json);
    ~OAICodingList() override;
    ...
    QList<OAICoding> getData() const;
    void setData(const QList<OAICoding> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAICodingList)

#endif // OAICodingList_H
