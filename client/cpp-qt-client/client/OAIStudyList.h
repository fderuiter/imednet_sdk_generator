...
#ifndef OAIStudyList_H
#define OAIStudyList_H
...
class OAIStudyList : public OAIObject {
public:
    OAIStudyList();
    OAIStudyList(QString json);
    ~OAIStudyList() override;
    ...
    QList<OAIStudy> getData() const;
    void setData(const QList<OAIStudy> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIStudyList)

#endif // OAIStudyList_H
