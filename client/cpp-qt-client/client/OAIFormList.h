...
#ifndef OAIFormList_H
#define OAIFormList_H
...
class OAIFormList : public OAIObject {
public:
    OAIFormList();
    OAIFormList(QString json);
    ~OAIFormList() override;
    ...
    QList<OAIForm> getData() const;
    void setData(const QList<OAIForm> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormList)
