...
public:
    ...
    */
    virtual void listUsers(const QString &study_key, const ::OpenAPI::OptionalParam<qint32> &page = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &size = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &sort = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &include_inactive = ::OpenAPI::OptionalParam<bool>());
...
Q_SIGNALS:
    ...
    void listUsersSignal(OAIUserList summary);


    void listUsersSignalFull(OAIHttpRequestWorker *worker, OAIUserList summary);

    Q_DECL_DEPRECATED_X("Use listUsersSignalError() instead")
    void listUsersSignalE(OAIUserList summary, QNetworkReply::NetworkError error_type, QString error_str);
    void listUsersSignalError(OAIUserList summary, QNetworkReply::NetworkError error_type, const QString &error_str);
