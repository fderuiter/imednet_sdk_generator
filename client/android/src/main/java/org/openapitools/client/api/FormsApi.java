...
public class FormsApi {
  ...
  * 
   ...
   * @return FormList
  */
  public FormList listForms (String studyKey, Integer page, Integer size, String sort, String filter) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'studyKey' is set
    if (studyKey == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'studyKey' when calling listForms",
        new ApiException(400, "Missing the required parameter 'studyKey' when calling listForms"));
    }

    // create path and map variables
    String path = "/studies/{studyKey}/forms".replaceAll("\\{" + "studyKey" + "\\}", apiInvoker.escapeString(studyKey.toString()));
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (FormList) ApiInvoker.deserialize(localVarResponse, "", FormList.class);
      } else {
         return null;
      }
  ...
  */
  public void listForms (String studyKey, Integer page, Integer size, String sort, String filter, final Response.Listener<FormList> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/studies/{studyKey}/forms".replaceAll("\\{format\\}","json").replaceAll("\\{" + "studyKey" + "\\}", apiInvoker.escapeString(studyKey.toString()));
      ...
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((FormList) ApiInvoker.deserialize(localVarResponse,  "", FormList.class));
