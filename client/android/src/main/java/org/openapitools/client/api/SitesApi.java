...
public class SitesApi {
  ...
  * 
   ...
   * @return SiteList
  */
  public SiteList listSites (String studyKey, Integer page, Integer size, String sort, String filter) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'studyKey' is set
    if (studyKey == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'studyKey' when calling listSites",
        new ApiException(400, "Missing the required parameter 'studyKey' when calling listSites"));
    }

    // create path and map variables
    String path = "/studies/{studyKey}/sites".replaceAll("\\{" + "studyKey" + "\\}", apiInvoker.escapeString(studyKey.toString()));
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (SiteList) ApiInvoker.deserialize(localVarResponse, "", SiteList.class);
      } else {
         return null;
      }
  ...
  */
  public void listSites (String studyKey, Integer page, Integer size, String sort, String filter, final Response.Listener<SiteList> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/studies/{studyKey}/sites".replaceAll("\\{format\\}","json").replaceAll("\\{" + "studyKey" + "\\}", apiInvoker.escapeString(studyKey.toString()));
      ...
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((SiteList) ApiInvoker.deserialize(localVarResponse,  "", SiteList.class));
