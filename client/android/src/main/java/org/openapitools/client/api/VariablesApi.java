...
public class VariablesApi {
  ...
  * 
   ...
   * @return VariableList
  */
  public VariableList listVariables (String studyKey, Integer page, Integer size, String sort, String filter) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'studyKey' is set
    if (studyKey == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'studyKey' when calling listVariables",
        new ApiException(400, "Missing the required parameter 'studyKey' when calling listVariables"));
    }

    // create path and map variables
    String path = "/studies/{studyKey}/variables".replaceAll("\\{" + "studyKey" + "\\}", apiInvoker.escapeString(studyKey.toString()));
  ...
  */
  public void listVariables (String studyKey, Integer page, Integer size, String sort, String filter, final Response.Listener<VariableList> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/studies/{studyKey}/variables".replaceAll("\\{format\\}","json").replaceAll("\\{" + "studyKey" + "\\}", apiInvoker.escapeString(studyKey.toString()));
