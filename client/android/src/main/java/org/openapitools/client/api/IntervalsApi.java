...
public class IntervalsApi {
  ...
  * 
   ...
   * @return IntervalList
  */
  public IntervalList listIntervals (String studyKey, Integer page, Integer size, String sort, String filter) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'studyKey' is set
    if (studyKey == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'studyKey' when calling listIntervals",
        new ApiException(400, "Missing the required parameter 'studyKey' when calling listIntervals"));
    }

    // create path and map variables
    String path = "/studies/{studyKey}/intervals".replaceAll("\\{" + "studyKey" + "\\}", apiInvoker.escapeString(studyKey.toString()));
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (IntervalList) ApiInvoker.deserialize(localVarResponse, "", IntervalList.class);
      } else {
         return null;
      }
  ...
  */
  public void listIntervals (String studyKey, Integer page, Integer size, String sort, String filter, final Response.Listener<IntervalList> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/studies/{studyKey}/intervals".replaceAll("\\{format\\}","json").replaceAll("\\{" + "studyKey" + "\\}", apiInvoker.escapeString(studyKey.toString()));
      ...
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((IntervalList) ApiInvoker.deserialize(localVarResponse,  "", IntervalList.class));
