...
public class QueriesApi {
  ...
  * 
   ...
   * @return QueryList
  */
  public QueryList listQueries (String studyKey, Integer page, Integer size, String sort, String filter) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'studyKey' is set
    if (studyKey == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'studyKey' when calling listQueries",
        new ApiException(400, "Missing the required parameter 'studyKey' when calling listQueries"));
    }

    // create path and map variables
    String path = "/studies/{studyKey}/queries".replaceAll("\\{" + "studyKey" + "\\}", apiInvoker.escapeString(studyKey.toString()));
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (QueryList) ApiInvoker.deserialize(localVarResponse, "", QueryList.class);
      } else {
         return null;
      }
  ...
  */
  public void listQueries (String studyKey, Integer page, Integer size, String sort, String filter, final Response.Listener<QueryList> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/studies/{studyKey}/queries".replaceAll("\\{format\\}","json").replaceAll("\\{" + "studyKey" + "\\}", apiInvoker.escapeString(studyKey.toString()));
      ...
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((QueryList) ApiInvoker.deserialize(localVarResponse,  "", QueryList.class));
