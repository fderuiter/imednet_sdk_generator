...
class Visit implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Visit';
    ...
    */
     ...
     * @return $this
     */
    public function setVisitId(?int $visit_id): static
    {
        if (is_null($visit_id)) {
     ...
     * @return string|null
     */
    public function getVisitDateForm(): ?string
    {
     ...
     * @return $this
     */
    public function setVisitDateForm(?string $visit_date_form): static
    {
     ...
     * @return string|null
     */
    public function getVisitDateQuestion(): ?string
    {
     ...
     * @return $this
     */
    public function setVisitDateQuestion(?string $visit_date_question): static
    {
