...
defmodule MednetEDCAPI.Connection do
  ...
  @doc """
  Configure a MednetEDCAPI client.

  ### Parameters

  - `options`: an optional keyword list of MednetEDCAPI.Connection.options.
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:mednet_edcapi, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - MednetEDCAPI 1.0.0 - elixir"
        )
      )
