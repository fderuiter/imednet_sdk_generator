...
------------- | ------------- | -------------
[**list_studies**](STUDIES_API.md#list_studies) | **Get** /studies | List studies accessible by API key


# **list_studies**
> list_studies (page:  detachable INTEGER_32 ; size:  detachable INTEGER_32 ; sort:  detachable STRING_32 ; filter:  detachable STRING_32 ): detachable STUDY_LIST
