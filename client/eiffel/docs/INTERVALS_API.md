...
------------- | ------------- | -------------
[**list_intervals**](INTERVALS_API.md#list_intervals) | **Get** /studies/{studyKey}/intervals | List intervals (visit definitions) in a study


# **list_intervals**
> list_intervals (study_key: STRING_32 ; page:  detachable INTEGER_32 ; size:  detachable INTEGER_32 ; sort:  detachable STRING_32 ; filter:  detachable STRING_32 ): detachable INTERVAL_LIST
