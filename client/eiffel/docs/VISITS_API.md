...
------------- | ------------- | -------------
[**list_visits**](VISITS_API.md#list_visits) | **Get** /studies/{studyKey}/visits | List visits (subject visit instances) in a study


# **list_visits**
> list_visits (study_key: STRING_32 ; page:  detachable INTEGER_32 ; size:  detachable INTEGER_32 ; sort:  detachable STRING_32 ; filter:  detachable STRING_32 ): detachable VISIT_LIST
