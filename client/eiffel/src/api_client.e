...
feature {NONE} -- Initialization
	...
	make
		do
			...
			authentications.force (create {API_KEY_AUTH}.make ("header", "x-imn-security-key"), "securityKeyAuth")
			is_api_key_configured := True 
		end

feature -- Access

	default_base_path: STRING = "https://edc.prod.imednetapi.com/api/v1/edc"
			-- default base path.
