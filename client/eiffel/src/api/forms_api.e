...
feature -- API Access
	...
	list_forms (study_key: STRING_32; page: INTEGER_32; size: INTEGER_32; sort: STRING_32; filter: STRING_32): detachable FORM_LIST
		...
		do
			...
			elseif attached { FORM_LIST } l_response.data ({ FORM_LIST }) as l_data then
				Result := l_data
			else
