...
feature -- API Access
	...
	list_codings (study_key: STRING_32; page: INTEGER_32; size: INTEGER_32; sort: STRING_32; filter: STRING_32): detachable CODING_LIST
		...
		do
			...
			l_path := "/studies/{studyKey}/codings"
			...
			elseif attached { CODING_LIST } l_response.data ({ CODING_LIST }) as l_data then
				Result := l_data
			else
