...
feature -- API Access
	...
	list_studies (page: INTEGER_32; size: INTEGER_32; sort: STRING_32; filter: STRING_32): detachable STUDY_LIST
		...
		do
			...
			elseif attached { STUDY_LIST } l_response.data ({ STUDY_LIST }) as l_data then
				Result := l_data
			else
