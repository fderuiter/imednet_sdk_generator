...
feature -- API Access
	...
	list_visits (study_key: STRING_32; page: INTEGER_32; size: INTEGER_32; sort: STRING_32; filter: STRING_32): detachable VISIT_LIST
		...
		do
			...
			l_path := "/studies/{studyKey}/visits"
			...
			elseif attached { VISIT_LIST } l_response.data ({ VISIT_LIST }) as l_data then
				Result := l_data
			else
