...
feature -- API Access
	...
	list_intervals (study_key: STRING_32; page: INTEGER_32; size: INTEGER_32; sort: STRING_32; filter: STRING_32): detachable INTERVAL_LIST
		...
		do
			...
			l_path := "/studies/{studyKey}/intervals"
			...
			elseif attached { INTERVAL_LIST } l_response.data ({ INTERVAL_LIST }) as l_data then
				Result := l_data
			else
