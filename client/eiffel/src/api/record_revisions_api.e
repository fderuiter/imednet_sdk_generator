...
feature -- API Access
	...
	list_record_revisions (study_key: STRING_32; page: INTEGER_32; size: INTEGER_32; sort: STRING_32; filter: STRING_32): detachable RECORD_REVISION_LIST
		...
		do
			...
			l_path := "/studies/{studyKey}/recordRevisions"
			...
			elseif attached { RECORD_REVISION_LIST } l_response.data ({ RECORD_REVISION_LIST }) as l_data then
				Result := l_data
			else
