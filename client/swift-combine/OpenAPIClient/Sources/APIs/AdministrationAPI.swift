...
open class AdministrationAPI {
    ...
    public enum ListUsersError: Error, CustomStringConvertible {
        ...
        public var description: String {
            ...
            case .code400Error(let object):
                return "ListUsersError: Bad request (malformed or invalid input): \(object)"
            case .code401Error(let object):
                return "ListUsersError: Authentication failed or was not provided: \(object)"
            case .code403Error(let object):
                return "ListUsersError: Authenticated but not allowed to access the resource: \(object)"
            case .code404Error(let object):
                return "ListUsersError: The requested resource was not found: \(object)"
            case .code500Error(let object):
                return "ListUsersError: Internal server error (unexpected condition encountered): \(object)"
            }
        }
    }
    ...
    /// - returns: AnyPublisher<UserList, Error> 
    open func listUsers(studyKey: String, page: Int? = nil, size: Int? = nil, sort: String? = nil, includeInactive: Bool? = nil) -> AnyPublisher<UserList, Error> {
        Deferred {
            Result<URLRequest, Error> {
                guard let baseURL = self.transport.baseURL ?? self.baseURL else {
                    throw OpenAPITransportError.badURLError()
                }
                var localVarPath = "/studies/{studyKey}/users"
            ...
            return self.transport.send(request: request)
                .mapError { transportError -> Error in 
                    ...
                    if transportError.statusCode == 401 {
                        do {
                            ...
                            return ListUsersError.code401Error(error)
                        } catch {
                            return error
                        }
                    }
                    if transportError.statusCode == 403 {
                        do {
                            ...
                            return ListUsersError.code403Error(error)
                        } catch {
                            return error
                        }
                    }
                    if transportError.statusCode == 404 {
                        do {
                            ...
                            return ListUsersError.code404Error(error)
                        } catch {
                            return error
                        }
                    }
                    if transportError.statusCode == 500 {
                        do {
                            ...
                            return ListUsersError.code500Error(error)
                        } catch {
                            return error
                        }
                    }
                ...
                .tryMap { response in
                    try self.decoder.decode(UserList.self, from: response.data)
                }
                .eraseToAnyPublisher()
        }.eraseToAnyPublisher()
    }
