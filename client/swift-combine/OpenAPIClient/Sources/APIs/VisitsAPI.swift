...
open class VisitsAPI {
    ...
    public enum ListVisitsError: Error, CustomStringConvertible {
        ...
        public var description: String {
            ...
            case .code400Error(let object):
                return "ListVisitsError: Bad request (malformed or invalid input): \(object)"
            case .code401Error(let object):
                return "ListVisitsError: Authentication failed or was not provided: \(object)"
            case .code403Error(let object):
                return "ListVisitsError: Authenticated but not allowed to access the resource: \(object)"
            case .code404Error(let object):
                return "ListVisitsError: The requested resource was not found: \(object)"
            case .code500Error(let object):
                return "ListVisitsError: Internal server error (unexpected condition encountered): \(object)"
            }
        }
    }
    ...
    /// - returns: AnyPublisher<VisitList, Error> 
    open func listVisits(studyKey: String, page: Int? = nil, size: Int? = nil, sort: String? = nil, filter: String? = nil) -> AnyPublisher<VisitList, Error> {
        Deferred {
            Result<URLRequest, Error> {
                guard let baseURL = self.transport.baseURL ?? self.baseURL else {
                    throw OpenAPITransportError.badURLError()
                }
                var localVarPath = "/studies/{studyKey}/visits"
            ...
            return self.transport.send(request: request)
                .mapError { transportError -> Error in 
                    ...
                    if transportError.statusCode == 401 {
                        do {
                            ...
                            return ListVisitsError.code401Error(error)
                        } catch {
                            return error
                        }
                    }
                    if transportError.statusCode == 403 {
                        do {
                            ...
                            return ListVisitsError.code403Error(error)
                        } catch {
                            return error
                        }
                    }
                    if transportError.statusCode == 404 {
                        do {
                            ...
                            return ListVisitsError.code404Error(error)
                        } catch {
                            return error
                        }
                    }
                    if transportError.statusCode == 500 {
                        do {
                            ...
                            return ListVisitsError.code500Error(error)
                        } catch {
                            return error
                        }
                    }
                ...
                .tryMap { response in
                    try self.decoder.decode(VisitList.self, from: response.data)
                }
                .eraseToAnyPublisher()
        }.eraseToAnyPublisher()
    }
