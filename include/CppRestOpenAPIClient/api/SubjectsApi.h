...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_SubjectsApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_SubjectsApi_H_
...
public:
    ...
    explicit SubjectsApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    pplx::task<std::shared_ptr<SubjectList>> listSubjects(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_SubjectsApi_H_ */
