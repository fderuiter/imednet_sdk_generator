...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_QueriesApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_QueriesApi_H_
...
public:
    ...
    explicit QueriesApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    pplx::task<std::shared_ptr<QueryList>> listQueries(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_QueriesApi_H_ */
