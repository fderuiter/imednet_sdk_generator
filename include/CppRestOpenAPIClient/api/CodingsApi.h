...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_CodingsApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_CodingsApi_H_
...
public:
    ...
    explicit CodingsApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    pplx::task<std::shared_ptr<CodingList>> listCodings(
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_CodingsApi_H_ */
