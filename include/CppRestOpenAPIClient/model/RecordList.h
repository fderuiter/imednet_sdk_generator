...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_RecordList_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_RecordList_H_
...
public:
    ...
    std::vector<std::shared_ptr<Record>> getData() const;
    bool dataIsSet() const;
    void unsetData();
    void setData(const std::vector<std::shared_ptr<Record>>& value);
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_RecordList_H_ */
