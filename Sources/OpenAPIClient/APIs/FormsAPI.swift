...
open class FormsAPI {
    ...
    open class func listForms(studyKey: String, page: Int? = nil, size: Int? = nil, sort: String? = nil, filter: String? = nil, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> FormList {
        return try await listFormsWithRequestBuilder(studyKey: studyKey, page: page, size: size, sort: sort, filter: filter, apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - parameter filter: (query) Optional filter criteria to apply, in the format &#x60;attribute&#x3D;&#x3D;value&#x60; with support for &gt;, &gt;&#x3D;, &lt;, &lt;&#x3D;, !&#x3D;. Multiple criteria can be combined with &#x60;;&#x60; (AND) or &#x60;,&#x60; (OR). (optional)
     - parameter apiConfiguration: The configuration for the http request.
     - returns: RequestBuilder<FormList> 
     */
    open class func listFormsWithRequestBuilder(studyKey: String, page: Int? = nil, size: Int? = nil, sort: String? = nil, filter: String? = nil, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) -> RequestBuilder<FormList> {
        var localVariablePath = "/studies/{studyKey}/forms"
        ...
        let localVariableRequestBuilder: RequestBuilder<FormList>.Type = apiConfiguration.requestBuilderFactory.getBuilder()
