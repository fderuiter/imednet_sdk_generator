...
open class VisitsAPI {
    ...
    open class func listVisits(studyKey: String, page: Int? = nil, size: Int? = nil, sort: String? = nil, filter: String? = nil, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> VisitList {
        return try await listVisitsWithRequestBuilder(studyKey: studyKey, page: page, size: size, sort: sort, filter: filter, apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - parameter filter: (query) Optional filter criteria to apply, in the format &#x60;attribute&#x3D;&#x3D;value&#x60; with support for &gt;, &gt;&#x3D;, &lt;, &lt;&#x3D;, !&#x3D;. Multiple criteria can be combined with &#x60;;&#x60; (AND) or &#x60;,&#x60; (OR). (optional)
     - parameter apiConfiguration: The configuration for the http request.
     - returns: RequestBuilder<VisitList> 
     */
    open class func listVisitsWithRequestBuilder(studyKey: String, page: Int? = nil, size: Int? = nil, sort: String? = nil, filter: String? = nil, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) -> RequestBuilder<VisitList> {
        var localVariablePath = "/studies/{studyKey}/visits"
        ...
        let localVariableRequestBuilder: RequestBuilder<VisitList>.Type = apiConfiguration.requestBuilderFactory.getBuilder()
