...
open class SubjectsAPI {
    ...
    open class func listSubjects(studyKey: String, page: Int? = nil, size: Int? = nil, sort: String? = nil, filter: String? = nil, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> SubjectList {
        return try await listSubjectsWithRequestBuilder(studyKey: studyKey, page: page, size: size, sort: sort, filter: filter, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func listSubjectsWithRequestBuilder(studyKey: String, page: Int? = nil, size: Int? = nil, sort: String? = nil, filter: String? = nil, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) -> RequestBuilder<SubjectList> {
