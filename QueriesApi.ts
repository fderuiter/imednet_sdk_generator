...
/**
 * listQueries - parameters interface
 */
export interface IListQueriesParams {
  studyKey: string;
  page?: number;
  size?: number;
  sort?: string;
...
/**
 * QueriesApi - API class
 */
@autoinject()
export class QueriesApi extends Api {

  /**
   * Creates a new QueriesApi class.
   *
   ...
   */
  async listQueries(params: IListQueriesParams): Promise<QueryList> {
    // Verify required parameters are set
    this.ensureParamIsSet('listQueries', params, 'studyKey');

    // Create URL to call
    const url = `${this.basePath}/studies/{studyKey}/queries`
