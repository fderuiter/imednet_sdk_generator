...
open class VisitsAPI {
     ...
     */
    @discardableResult
    open class func listVisits(studyKey: String, page: Int? = nil, size: Int? = nil, sort: String? = nil, filter: String? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: VisitList?, _ error: Error?) -> Void)) -> RequestTask {
        return listVisitsWithRequestBuilder(studyKey: studyKey, page: page, size: size, sort: sort, filter: filter).execute(apiResponseQueue) { result in
            switch result {
     ...
     */
    open class func listVisitsWithRequestBuilder(studyKey: String, page: Int? = nil, size: Int? = nil, sort: String? = nil, filter: String? = nil) -> RequestBuilder<VisitList> {
        ...
        let localVariableRequestBuilder: RequestBuilder<VisitList>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
