...
open class SitesAPI {
     ...
     */
    @discardableResult
    open class func listSites(studyKey: String, page: Int? = nil, size: Int? = nil, sort: String? = nil, filter: String? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: SiteList?, _ error: Error?) -> Void)) -> RequestTask {
        return listSitesWithRequestBuilder(studyKey: studyKey, page: page, size: size, sort: sort, filter: filter).execute(apiResponseQueue) { result in
            switch result {
     ...
     */
    open class func listSitesWithRequestBuilder(studyKey: String, page: Int? = nil, size: Int? = nil, sort: String? = nil, filter: String? = nil) -> RequestBuilder<SiteList> {
        ...
        let localVariableRequestBuilder: RequestBuilder<SiteList>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
