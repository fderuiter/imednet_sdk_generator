...
@interface OAIFormsApi: NSObject <OAIApi>

extern NSString* kOAIFormsApiErrorDomain;
extern NSInteger kOAIFormsApiMissingParamErrorCode;
...
/// 
///  code:200 message:"Successful response with list of forms",
