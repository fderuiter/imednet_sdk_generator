...
@interface OAISitesApi: NSObject <OAIApi>

extern NSString* kOAISitesApiErrorDomain;
extern NSInteger kOAISitesApiMissingParamErrorCode;
...
/// 
///  code:200 message:"Successful response with list of sites",
