...
@interface OAICodingsApi: NSObject <OAIApi>

extern NSString* kOAICodingsApiErrorDomain;
extern NSInteger kOAICodingsApiMissingParamErrorCode;
...
/// 
///  code:200 message:"Successful response with list of coding entries",
