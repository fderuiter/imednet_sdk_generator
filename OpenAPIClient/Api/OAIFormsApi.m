#import "OAIFormsApi.h"
#import "OAIQueryParamCollection.h"
#import "OAIApiClient.h"
#import "OAIFormList.h"
...
@interface OAIFormsApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAIFormsApi

NSString* kOAIFormsApiErrorDomain = @"OAIFormsApiErrorDomain";
NSInteger kOAIFormsApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) listFormsWithStudyKey: (NSString*) studyKey
    ...
    if (studyKey == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kOAIFormsApiErrorDomain code:kOAIFormsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/studies/{studyKey}/forms"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"OAIFormList*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIFormList*)data, error);
                                }
                            }];
}
