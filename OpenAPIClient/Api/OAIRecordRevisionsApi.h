...
@interface OAIRecordRevisionsApi: NSObject <OAIApi>

extern NSString* kOAIRecordRevisionsApiErrorDomain;
extern NSInteger kOAIRecordRevisionsApiMissingParamErrorCode;
...
/// 
///  code:200 message:"Successful response with list of record revisions",
