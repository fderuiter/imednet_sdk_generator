...
open class RecordRevisionsAPI {
    ...
    public enum ListRecordRevisionsError: Error, CustomStringConvertible {
        ...
        public var description: String {
            ...
            case .code400Error(let object):
                return "ListRecordRevisionsError: Bad request (malformed or invalid input): \(object)"
            case .code401Error(let object):
                return "ListRecordRevisionsError: Authentication failed or was not provided: \(object)"
            case .code403Error(let object):
                return "ListRecordRevisionsError: Authenticated but not allowed to access the resource: \(object)"
            case .code404Error(let object):
                return "ListRecordRevisionsError: The requested resource was not found: \(object)"
            case .code500Error(let object):
                return "ListRecordRevisionsError: Internal server error (unexpected condition encountered): \(object)"
            }
        }
    }
    ...
    /// - returns: AnyPublisher<RecordRevisionList, Error> 
    open func listRecordRevisions(studyKey: String, page: Int? = nil, size: Int? = nil, sort: String? = nil, filter: String? = nil) -> AnyPublisher<RecordRevisionList, Error> {
        Deferred {
            Result<URLRequest, Error> {
                guard let baseURL = self.transport.baseURL ?? self.baseURL else {
                    throw OpenAPITransportError.badURLError()
                }
                var localVarPath = "/studies/{studyKey}/recordRevisions"
        ...
        }.flatMap { request -> AnyPublisher<RecordRevisionList, Error> in 
            return self.transport.send(request: request)
                .mapError { transportError -> Error in 
                    if transportError.statusCode == 400 {
                        do {
                            let error = try self.decoder.decode(InlineObject.self, from: transportError.data)
                            return ListRecordRevisionsError.code400Error(error)
                        } catch {
                            return error
                        }
                    }
                    if transportError.statusCode == 401 {
                        do {
                            ...
                            return ListRecordRevisionsError.code401Error(error)
                        } catch {
                            return error
                        }
                    }
                    if transportError.statusCode == 403 {
                        do {
                            ...
                            return ListRecordRevisionsError.code403Error(error)
                        } catch {
                            return error
                        }
                    }
                    if transportError.statusCode == 404 {
                        do {
                            ...
                            return ListRecordRevisionsError.code404Error(error)
                        } catch {
                            return error
                        }
                    }
                    if transportError.statusCode == 500 {
                        do {
                            ...
                            return ListRecordRevisionsError.code500Error(error)
                        } catch {
                            return error
                        }
                    }
                ...
                .tryMap { response in
                    try self.decoder.decode(RecordRevisionList.self, from: response.data)
                }
                .eraseToAnyPublisher()
        }.eraseToAnyPublisher()
    }
