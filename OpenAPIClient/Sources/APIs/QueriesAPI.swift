...
open class QueriesAPI {
    ...
    public enum ListQueriesError: Error, CustomStringConvertible {
        ...
        public var description: String {
            ...
            case .code400Error(let object):
                return "ListQueriesError: Bad request (malformed or invalid input): \(object)"
            case .code401Error(let object):
                return "ListQueriesError: Authentication failed or was not provided: \(object)"
            case .code403Error(let object):
                return "ListQueriesError: Authenticated but not allowed to access the resource: \(object)"
            case .code404Error(let object):
                return "ListQueriesError: The requested resource was not found: \(object)"
            case .code500Error(let object):
                return "ListQueriesError: Internal server error (unexpected condition encountered): \(object)"
            }
        }
    }
    ...
    /// - returns: AnyPublisher<QueryList, Error> 
    open func listQueries(studyKey: String, page: Int? = nil, size: Int? = nil, sort: String? = nil, filter: String? = nil) -> AnyPublisher<QueryList, Error> {
        Deferred {
            Result<URLRequest, Error> {
                guard let baseURL = self.transport.baseURL ?? self.baseURL else {
                    throw OpenAPITransportError.badURLError()
                }
                var localVarPath = "/studies/{studyKey}/queries"
            ...
            return self.transport.send(request: request)
                .mapError { transportError -> Error in 
                    ...
                    if transportError.statusCode == 401 {
                        do {
                            ...
                            return ListQueriesError.code401Error(error)
                        } catch {
                            return error
                        }
                    }
                    if transportError.statusCode == 403 {
                        do {
                            ...
                            return ListQueriesError.code403Error(error)
                        } catch {
                            return error
                        }
                    }
                    if transportError.statusCode == 404 {
                        do {
                            ...
                            return ListQueriesError.code404Error(error)
                        } catch {
                            return error
                        }
                    }
                    if transportError.statusCode == 500 {
                        do {
                            ...
                            return ListQueriesError.code500Error(error)
                        } catch {
                            return error
                        }
                    }
                ...
                .tryMap { response in
                    try self.decoder.decode(QueryList.self, from: response.data)
                }
                .eraseToAnyPublisher()
        }.eraseToAnyPublisher()
    }
