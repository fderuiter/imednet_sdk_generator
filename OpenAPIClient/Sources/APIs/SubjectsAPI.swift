...
open class SubjectsAPI {
    ...
    public enum ListSubjectsError: Error, CustomStringConvertible {
        ...
        public var description: String {
            ...
            case .code400Error(let object):
                return "ListSubjectsError: Bad request (malformed or invalid input): \(object)"
            case .code401Error(let object):
                return "ListSubjectsError: Authentication failed or was not provided: \(object)"
            case .code403Error(let object):
                return "ListSubjectsError: Authenticated but not allowed to access the resource: \(object)"
            case .code404Error(let object):
                return "ListSubjectsError: The requested resource was not found: \(object)"
            case .code500Error(let object):
                return "ListSubjectsError: Internal server error (unexpected condition encountered): \(object)"
            }
        }
    }
    ...
    /// - returns: AnyPublisher<SubjectList, Error> 
    open func listSubjects(studyKey: String, page: Int? = nil, size: Int? = nil, sort: String? = nil, filter: String? = nil) -> AnyPublisher<SubjectList, Error> {
        Deferred {
            Result<URLRequest, Error> {
                guard let baseURL = self.transport.baseURL ?? self.baseURL else {
                    throw OpenAPITransportError.badURLError()
                }
                var localVarPath = "/studies/{studyKey}/subjects"
            ...
            return self.transport.send(request: request)
                .mapError { transportError -> Error in 
                    ...
                    if transportError.statusCode == 401 {
                        do {
                            ...
                            return ListSubjectsError.code401Error(error)
                        } catch {
                            return error
                        }
                    }
                    if transportError.statusCode == 403 {
                        do {
                            ...
                            return ListSubjectsError.code403Error(error)
                        } catch {
                            return error
                        }
                    }
                    if transportError.statusCode == 404 {
                        do {
                            ...
                            return ListSubjectsError.code404Error(error)
                        } catch {
                            return error
                        }
                    }
                    if transportError.statusCode == 500 {
                        do {
                            ...
                            return ListSubjectsError.code500Error(error)
                        } catch {
                            return error
                        }
                    }
                ...
                .tryMap { response in
                    try self.decoder.decode(SubjectList.self, from: response.data)
                }
                .eraseToAnyPublisher()
        }.eraseToAnyPublisher()
    }
