...
open class VariablesAPI {
    ...
    public enum ListVariablesError: Error, CustomStringConvertible {
        ...
        public var description: String {
            ...
            case .code400Error(let object):
                return "ListVariablesError: Bad request (malformed or invalid input): \(object)"
            case .code401Error(let object):
                return "ListVariablesError: Authentication failed or was not provided: \(object)"
            case .code403Error(let object):
                return "ListVariablesError: Authenticated but not allowed to access the resource: \(object)"
            case .code404Error(let object):
                return "ListVariablesError: The requested resource was not found: \(object)"
            case .code500Error(let object):
                return "ListVariablesError: Internal server error (unexpected condition encountered): \(object)"
            }
        }
    }
    ...
    /// - returns: AnyPublisher<VariableList, Error> 
    open func listVariables(studyKey: String, page: Int? = nil, size: Int? = nil, sort: String? = nil, filter: String? = nil) -> AnyPublisher<VariableList, Error> {
        Deferred {
            Result<URLRequest, Error> {
                guard let baseURL = self.transport.baseURL ?? self.baseURL else {
                    throw OpenAPITransportError.badURLError()
                }
                var localVarPath = "/studies/{studyKey}/variables"
            ...
            return self.transport.send(request: request)
                .mapError { transportError -> Error in 
                    ...
                    if transportError.statusCode == 401 {
                        do {
                            ...
                            return ListVariablesError.code401Error(error)
                        } catch {
                            return error
                        }
                    }
                    if transportError.statusCode == 403 {
                        do {
                            ...
                            return ListVariablesError.code403Error(error)
                        } catch {
                            return error
                        }
                    }
                    if transportError.statusCode == 404 {
                        do {
                            ...
                            return ListVariablesError.code404Error(error)
                        } catch {
                            return error
                        }
                    }
                    if transportError.statusCode == 500 {
                        do {
                            ...
                            return ListVariablesError.code500Error(error)
                        } catch {
                            return error
                        }
                    }
                ...
                .tryMap { response in
                    try self.decoder.decode(VariableList.self, from: response.data)
                }
                .eraseToAnyPublisher()
        }.eraseToAnyPublisher()
    }
