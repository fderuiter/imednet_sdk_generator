...
import ../models/model_coding_list
...
proc listCodings*(httpClient: HttpClient, studyKey: string, page: int, size: int, sort: string, filter: string): (Option[CodingList], Response) =
  ...
  let response = httpClient.get(basepath & fmt"/studies/{studyKey}/codings" & "?" & url_encoded_query_params)
  constructResult[CodingList](response)
