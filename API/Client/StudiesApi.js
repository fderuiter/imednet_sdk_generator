...
goog.require('API.Client.StudyList');
 ...
 * @return {!angular.$q.Promise<!API.Client.StudyList>}
 */
API.Client.StudiesApi.prototype.listStudies = function(opt_page, opt_size, opt_sort, opt_filter, opt_extraHttpRequestParams) {
  /** @const {string} */
