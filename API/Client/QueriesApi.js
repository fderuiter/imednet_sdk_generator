/**
 * @fileoverview AUTOMATICALLY GENERATED service for API.Client.QueriesApi.
 ...
 */
goog.provide('API.Client.QueriesApi');

goog.require('API.Client.QueryList');
 ...
 * @struct
 */
API.Client.QueriesApi = function($http, $httpParamSerializer, $injector) {
  /** @private {!string} */
  this.basePath_ = $injector.has('QueriesApiBasePath') ?
                   /** @type {!string} */ ($injector.get('QueriesApiBasePath')) :
                   'https://edc.prod.imednetapi.com/api/v1/edc';

  /** @private {!Object<string, string>} */
  this.defaultHeaders_ = $injector.has('QueriesApiDefaultHeaders') ?
                   /** @type {!Object<string, string>} */ (
                       $injector.get('QueriesApiDefaultHeaders')) :
                   {};
...
API.Client.QueriesApi.$inject = ['$http', '$httpParamSerializer', '$injector'];
 ...
 * @return {!angular.$q.Promise<!API.Client.QueryList>}
 */
API.Client.QueriesApi.prototype.listQueries = function(studyKey, opt_page, opt_size, opt_sort, opt_filter, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/studies/{studyKey}/queries'
  ...
  if (!studyKey) {
    throw new Error('Missing required parameter studyKey when calling listQueries');
  }
