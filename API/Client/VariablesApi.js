 ...
 */
API.Client.VariablesApi.prototype.listVariables = function(studyKey, opt_page, opt_size, opt_sort, opt_filter, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/studies/{studyKey}/variables'
  ...
  if (!studyKey) {
    throw new Error('Missing required parameter studyKey when calling listVariables');
  }
