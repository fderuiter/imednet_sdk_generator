/**
 * @fileoverview AUTOMATICALLY GENERATED service for API.Client.RecordRevisionsApi.
 ...
 */
goog.provide('API.Client.RecordRevisionsApi');

goog.require('API.Client.RecordRevisionList');
 ...
 * @struct
 */
API.Client.RecordRevisionsApi = function($http, $httpParamSerializer, $injector) {
  /** @private {!string} */
  this.basePath_ = $injector.has('RecordRevisionsApiBasePath') ?
                   /** @type {!string} */ ($injector.get('RecordRevisionsApiBasePath')) :
                   'https://edc.prod.imednetapi.com/api/v1/edc';

  /** @private {!Object<string, string>} */
  this.defaultHeaders_ = $injector.has('RecordRevisionsApiDefaultHeaders') ?
                   /** @type {!Object<string, string>} */ (
                       $injector.get('RecordRevisionsApiDefaultHeaders')) :
                   {};
...
API.Client.RecordRevisionsApi.$inject = ['$http', '$httpParamSerializer', '$injector'];
 ...
 * @return {!angular.$q.Promise<!API.Client.RecordRevisionList>}
 */
API.Client.RecordRevisionsApi.prototype.listRecordRevisions = function(studyKey, opt_page, opt_size, opt_sort, opt_filter, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/studies/{studyKey}/recordRevisions'
  ...
  if (!studyKey) {
    throw new Error('Missing required parameter studyKey when calling listRecordRevisions');
  }
