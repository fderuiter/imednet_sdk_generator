/**
 * @fileoverview AUTOMATICALLY GENERATED service for API.Client.FormsApi.
 ...
 */
goog.provide('API.Client.FormsApi');

goog.require('API.Client.FormList');
 ...
 * @struct
 */
API.Client.FormsApi = function($http, $httpParamSerializer, $injector) {
  /** @private {!string} */
  this.basePath_ = $injector.has('FormsApiBasePath') ?
                   /** @type {!string} */ ($injector.get('FormsApiBasePath')) :
                   'https://edc.prod.imednetapi.com/api/v1/edc';

  /** @private {!Object<string, string>} */
  this.defaultHeaders_ = $injector.has('FormsApiDefaultHeaders') ?
                   /** @type {!Object<string, string>} */ (
                       $injector.get('FormsApiDefaultHeaders')) :
                   {};
...
API.Client.FormsApi.$inject = ['$http', '$httpParamSerializer', '$injector'];
 ...
 * @return {!angular.$q.Promise<!API.Client.FormList>}
 */
API.Client.FormsApi.prototype.listForms = function(studyKey, opt_page, opt_size, opt_sort, opt_filter, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/studies/{studyKey}/forms'
  ...
  if (!studyKey) {
    throw new Error('Missing required parameter studyKey when calling listForms');
  }
